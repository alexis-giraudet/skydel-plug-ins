...
{
///
/// Add a new data set for the specified constellation. This could come from a Rinex, SEM or YUMA file for GPS. Only
...
/// default value will be the name of the imported file.
///
...
public:
  ...
  AddDataSet() : CommandBase(CmdName, TargetId) {}

  AddDataSet(const std::string& system,
  ...
  static AddDataSetPtr create(const std::string& system,
                              const std::string& path,
                              const std::optional<int>& rollover = {},
                              const std::optional<std::string>& dataSetName = {})
  {
  ...
  static AddDataSetPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<AddDataSet>(ptr); }
