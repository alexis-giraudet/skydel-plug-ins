...
public:
  ...
  AddSVGainPatternOffset() : CommandBase(CmdName, TargetId) {}

  AddSVGainPatternOffset(const Sdx::GNSSBand& band,
  ...
  static AddSVGainPatternOffsetPtr create(const Sdx::GNSSBand& band,
                                          const std::string& system,
                                          double offset,
                                          const std::optional<std::string>& antennaName = {})
  {
