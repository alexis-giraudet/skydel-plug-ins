...
public:
  ...
  Arm() : CommandBase(CmdName, TargetId) {}

  static ArmPtr create() { return std::make_shared<Arm>(); }

  static ArmPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<Arm>(ptr); }
