...
/// "NAVICL5", "NAVICS", "PULSARXL", "PULSARX1" Gain             int             The gain associated to this output
/// (dB). This value has to be between the radio minimum value and 115. A negative value means to use the radio default
/// value. GaussianNoise    bool            If true, add Gaussian noise to ensure realistic signal to noise ratio. When
/// combining multiple outputs, only one should have Gaussian noise enabled. Id               string          Target
...
{
public:
  inline static const char* const CmdName = "ChangeModulationTargetSignals";
  ...
  ChangeModulationTargetSignals() : CommandBase(CmdName, TargetId) {}

  ChangeModulationTargetSignals(int output,
                                int minRate,
                                int maxRate,
  ...
  static ChangeModulationTargetSignalsPtr create(int output,
                                                 int minRate,
                                                 int maxRate,
                                                 const std::string& band,
                                                 const std::string& signal,
                                                 ...
                                                 const std::optional<double>& centralFrequency = {})
  {
    return std::make_shared<ChangeModulationTargetSignals>(output,
                                                           minRate,
                                                           maxRate,
                                                           band,
                                                           signal,
...
REGISTER_COMMAND_TO_FACTORY(ChangeModulationTargetSignals);
} // namespace Cmd
} // namespace Sdx
