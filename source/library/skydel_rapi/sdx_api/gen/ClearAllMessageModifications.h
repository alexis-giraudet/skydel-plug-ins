...
{
///
/// Please note the command ClearAllMessageModifications is deprecated since 21.3. You may use
...
public:
  ...
  ClearAllMessageModifications() : CommandBase(CmdName, TargetId) {}

  ClearAllMessageModifications(const std::string& signal) : CommandBase(CmdName, TargetId) { setSignal(signal); }
