...
public:
  ...
  ClearAllMessageModificationsForSignal() : CommandBase(CmdName, TargetId) {}

  ClearAllMessageModificationsForSignal(const std::string& signal) : CommandBase(CmdName, TargetId)
  {
