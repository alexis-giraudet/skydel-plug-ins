...
public:
  ...
  ClearSpoofTxGpuIdx() : CommandBase(CmdName, TargetId) {}

  ClearSpoofTxGpuIdx(int signalId, const std::string& id) : CommandBase(CmdName, TargetId)
  {
  ...
  virtual bool isValid() const override
  {
    ...
    return m_values.IsObject() && parse_json<int>::is_valid(m_values["SignalId"]) &&
