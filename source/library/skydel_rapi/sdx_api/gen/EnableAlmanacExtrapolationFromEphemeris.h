...
public:
  ...
  EnableAlmanacExtrapolationFromEphemeris() : CommandBase(CmdName, TargetId) {}

  EnableAlmanacExtrapolationFromEphemeris(bool enabled) : CommandBase(CmdName, TargetId) { setEnabled(enabled); }
