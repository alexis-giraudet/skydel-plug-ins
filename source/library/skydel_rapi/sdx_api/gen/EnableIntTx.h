...
public:
  ...
  EnableIntTx() : CommandBase(CmdName, TargetId) {}

  EnableIntTx(bool enabled, const std::string& id) : CommandBase(CmdName, TargetId)
  {
  ...
  static EnableIntTxPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<EnableIntTx>(ptr); }
