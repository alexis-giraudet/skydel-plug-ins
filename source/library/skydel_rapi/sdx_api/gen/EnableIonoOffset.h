...
public:
  ...
  EnableIonoOffset() : CommandBase(CmdName, TargetId) {}

  EnableIonoOffset(bool isEnabled) : CommandBase(CmdName, TargetId) { setIsEnabled(isEnabled); }

  static EnableIonoOffsetPtr create(bool isEnabled) { return std::make_shared<EnableIonoOffset>(isEnabled); }
