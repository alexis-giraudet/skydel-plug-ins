...
public:
  ...
  EnableLogNmea() : CommandBase(CmdName, TargetId) {}

  EnableLogNmea(bool enabled, const std::optional<bool>& serialPortEnabled = {}) : CommandBase(CmdName, TargetId)
  {
  ...
  static EnableLogNmeaPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<EnableLogNmea>(ptr); }
  ...
  {
    m_values.AddMember("SerialPortEnabled",
                       parse_json<std::optional<bool>>::format(serialPortEnabled, m_values.GetAllocator()),
