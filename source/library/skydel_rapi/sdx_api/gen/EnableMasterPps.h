...
public:
  ...
  EnableMasterPps() : CommandBase(CmdName, TargetId) {}

  EnableMasterPps(bool enabled) : CommandBase(CmdName, TargetId) { setEnabled(enabled); }

  static EnableMasterPpsPtr create(bool enabled) { return std::make_shared<EnableMasterPps>(enabled); }

  static EnableMasterPpsPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<EnableMasterPps>(ptr); }
