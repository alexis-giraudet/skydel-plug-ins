...
public:
  ...
  EnablePYCodeForEachSV() : CommandBase(CmdName, TargetId) {}

  EnablePYCodeForEachSV(const std::string& signal, const std::vector<bool>& enabled) : CommandBase(CmdName, TargetId)
  {
