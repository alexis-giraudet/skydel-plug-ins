...
public:
  ...
  EnableRFOutputForEachSV() : CommandBase(CmdName, TargetId) {}

  EnableRFOutputForEachSV(const std::string& system, const std::vector<bool>& enabled) : CommandBase(CmdName, TargetId)
  {
