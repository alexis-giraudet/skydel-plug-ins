...
public:
  ...
  EnableSV() : CommandBase(CmdName, TargetId) {}

  EnableSV(const std::string& system, int svId, bool enabled) : CommandBase(CmdName, TargetId)
  {
  ...
  static EnableSVPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<EnableSV>(ptr); }
