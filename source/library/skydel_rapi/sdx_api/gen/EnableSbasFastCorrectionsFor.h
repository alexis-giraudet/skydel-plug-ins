...
public:
  ...
  EnableSbasFastCorrectionsFor() : CommandBase(CmdName, TargetId) {}

  EnableSbasFastCorrectionsFor(const std::string& system,
                               bool isEnabled,
  ...
  static EnableSbasFastCorrectionsForPtr create(const std::string& system,
                                                bool isEnabled,
                                                const std::optional<std::string>& errorType = {})
  {
