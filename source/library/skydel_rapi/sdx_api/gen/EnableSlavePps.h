...
public:
  ...
  EnableSlavePps() : CommandBase(CmdName, TargetId) {}

  EnableSlavePps(bool enabled) : CommandBase(CmdName, TargetId) { setEnabled(enabled); }

  static EnableSlavePpsPtr create(bool enabled) { return std::make_shared<EnableSlavePps>(enabled); }

  static EnableSlavePpsPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<EnableSlavePps>(ptr); }
