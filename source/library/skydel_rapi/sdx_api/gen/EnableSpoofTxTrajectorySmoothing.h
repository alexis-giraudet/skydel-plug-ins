...
public:
  ...
  EnableSpoofTxTrajectorySmoothing() : CommandBase(CmdName, TargetId) {}

  EnableSpoofTxTrajectorySmoothing(bool enabled, const std::string& id) : CommandBase(CmdName, TargetId)
  {
