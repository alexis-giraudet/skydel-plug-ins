...
public:
  ...
  EndIntTxTrackDefinitionResult() : CommandResult(CmdName, TargetId) {}

  EndIntTxTrackDefinitionResult(int count, const std::string& id) : CommandResult(CmdName, TargetId)
  {
