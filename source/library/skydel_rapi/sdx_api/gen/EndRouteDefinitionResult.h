...
public:
  ...
  EndRouteDefinitionResult() : CommandResult(CmdName, TargetId) {}

  EndRouteDefinitionResult(int count) : CommandResult(CmdName, TargetId) { setCount(count); }

  EndRouteDefinitionResult(CommandBasePtr relatedCommand, int count) : CommandResult(CmdName, TargetId, relatedCommand)
  {

    setCount(count);
  }

  static EndRouteDefinitionResultPtr create(int count) { return std::make_shared<EndRouteDefinitionResult>(count); }
