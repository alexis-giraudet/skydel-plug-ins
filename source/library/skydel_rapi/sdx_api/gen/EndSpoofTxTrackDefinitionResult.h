...
public:
  ...
  EndSpoofTxTrackDefinitionResult() : CommandResult(CmdName, TargetId) {}

  EndSpoofTxTrackDefinitionResult(int count, const std::string& id) : CommandResult(CmdName, TargetId)
  {
  ...
  virtual bool isValid() const override
  {
    ...
    return m_values.IsObject() && parse_json<int>::is_valid(m_values["Count"]) &&
