...
public:
  ...
  ExportWFAntenna() : CommandBase(CmdName, TargetId) {}

  ExportWFAntenna(const std::string& filePath, bool overwriteFile) : CommandBase(CmdName, TargetId)
  {
  ...
  static ExportWFAntennaPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<ExportWFAntenna>(ptr); }
