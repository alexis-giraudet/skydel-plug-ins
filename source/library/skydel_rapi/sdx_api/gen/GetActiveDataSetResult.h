...
public:
  ...
  GetActiveDataSetResult() : CommandResult(CmdName, TargetId) {}

  GetActiveDataSetResult(const std::string& system, const std::string& dataSetName) : CommandResult(CmdName, TargetId)
  {
  ...
  static GetActiveDataSetResultPtr create(CommandBasePtr relatedCommand,
