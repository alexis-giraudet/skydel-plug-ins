...
public:
  ...
  GetAllIntTxID() : CommandBase(CmdName, TargetId) {}

  static GetAllIntTxIDPtr create() { return std::make_shared<GetAllIntTxID>(); }

  static GetAllIntTxIDPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetAllIntTxID>(ptr); }
