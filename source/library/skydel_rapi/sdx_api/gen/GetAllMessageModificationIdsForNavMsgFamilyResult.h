...
typedef std::shared_ptr<GetAllMessageModificationIdsForNavMsgFamilyResult>
  GetAllMessageModificationIdsForNavMsgFamilyResultPtr;
...
public:
  ...
  GetAllMessageModificationIdsForNavMsgFamilyResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetAllMessageModificationIdsForNavMsgFamilyResult(CommandBasePtr relatedCommand,
  ...
  static GetAllMessageModificationIdsForNavMsgFamilyResultPtr create(CommandBasePtr relatedCommand,
                                                                     const std::vector<std::string>& ids)
  {
