...
///                                     "QZSSL1CA", "QZSSL1CB", "QZSSL1C", "QZSSL2C", "QZSSL5", "QZSSL1S", "QZSSL5S",
///                                     "QZSSL6", "NAVICL1", "NAVICL5", "NAVICS", "PULSARXL", "PULSARX1" and "PULSARX5"
///
...
public:
  ...
  GetAllMultipathForSignal() : CommandBase(CmdName, TargetId) {}

  GetAllMultipathForSignal(const std::string& signal) : CommandBase(CmdName, TargetId) { setSignal(signal); }
