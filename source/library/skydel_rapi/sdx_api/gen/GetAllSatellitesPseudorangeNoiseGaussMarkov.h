...
{
///
/// Please note the command GetAllSatellitesPseudorangeNoiseGaussMarkov is deprecated since 21.3. You may use
...
public:
  ...
  GetAllSatellitesPseudorangeNoiseGaussMarkov() : CommandBase(CmdName, TargetId) {}

  GetAllSatellitesPseudorangeNoiseGaussMarkov(const std::string& system, int process) : CommandBase(CmdName, TargetId)
  {
