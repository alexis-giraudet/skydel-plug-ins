...
{
///
/// Please note the command GetAllSatellitesPseudorangeNoiseSineWave is deprecated since 21.3. You may use
...
public:
  ...
  GetAllSatellitesPseudorangeNoiseSineWave() : CommandBase(CmdName, TargetId) {}

  GetAllSatellitesPseudorangeNoiseSineWave(const std::string& system, int sineWave) : CommandBase(CmdName, TargetId)
  {
