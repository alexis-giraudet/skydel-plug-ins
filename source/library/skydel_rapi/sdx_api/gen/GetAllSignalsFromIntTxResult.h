...
public:
  ...
  GetAllSignalsFromIntTxResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetAllSignalsFromIntTxResult(CommandBasePtr relatedCommand,
                               const std::string& id,
  ...
  static GetAllSignalsFromIntTxResultPtr create(CommandBasePtr relatedCommand,
                                                const std::string& id,
                                                const std::vector<std::string>& idsSignal)
  {
