...
public:
  ...
  GetAllVehicleAntennaNamesResult() : CommandResult(CmdName, TargetId) {}

  GetAllVehicleAntennaNamesResult(const std::vector<std::string>& antennaNames) : CommandResult(CmdName, TargetId)
  {
  ...
  static GetAllVehicleAntennaNamesResultPtr create(CommandBasePtr relatedCommand,
  ...
  virtual bool isValid() const override
  {
    ...
    return m_values.IsObject() && parse_json<std::vector<std::string>>::is_valid(m_values["AntennaNames"]);
  }
