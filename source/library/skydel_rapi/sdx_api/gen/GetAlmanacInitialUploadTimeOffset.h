...
public:
  ...
  GetAlmanacInitialUploadTimeOffset() : CommandBase(CmdName, TargetId) {}

  static GetAlmanacInitialUploadTimeOffsetPtr create() { return std::make_shared<GetAlmanacInitialUploadTimeOffset>(); }
