...
public:
  ...
  GetAlmanacInitialUploadTimeOffsetResult() : CommandResult(CmdName, TargetId) {}

  GetAlmanacInitialUploadTimeOffsetResult(const std::string& system, int offset) : CommandResult(CmdName, TargetId)
  {
  ...
  static GetAlmanacInitialUploadTimeOffsetResultPtr create(CommandBasePtr relatedCommand,
