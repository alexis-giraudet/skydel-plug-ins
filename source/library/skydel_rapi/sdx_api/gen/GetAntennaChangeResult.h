...
public:
  ...
  GetAntennaChangeResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetAntennaChangeResult(CommandBasePtr relatedCommand,
                         double startTime,
  ...
  static GetAntennaChangeResultPtr create(CommandBasePtr relatedCommand,
                                          double startTime,
                                          const std::string& antenna,
                                          const std::string& id)
  {
