...
public:
  ...
  GetBeiDouEphBoolParamForEachSVResult() : CommandResult(CmdName, TargetId) {}

  GetBeiDouEphBoolParamForEachSVResult(const std::string& paramName,
  ...
  GetBeiDouEphBoolParamForEachSVResult(CommandBasePtr relatedCommand,
  ...
  static GetBeiDouEphBoolParamForEachSVResultPtr create(const std::string& paramName,
                                                        const std::vector<bool>& val,
                                                        const std::optional<std::string>& dataSetName = {})
  {
  ...
  static GetBeiDouEphBoolParamForEachSVResultPtr create(CommandBasePtr relatedCommand,
                                                        const std::string& paramName,
                                                        const std::vector<bool>& val,
                                                        const std::optional<std::string>& dataSetName = {})
  {
