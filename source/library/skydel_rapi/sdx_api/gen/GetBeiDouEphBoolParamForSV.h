...
{
///
/// Please note the command GetBeiDouEphBoolParamForSV is deprecated since 23.11. You may use
...
public:
  ...
  GetBeiDouEphBoolParamForSV() : CommandBase(CmdName, TargetId) {}

  GetBeiDouEphBoolParamForSV(int svId,
  ...
  static GetBeiDouEphBoolParamForSVPtr create(int svId,
                                              const std::string& paramName,
                                              const std::optional<std::string>& dataSetName = {})
  {
