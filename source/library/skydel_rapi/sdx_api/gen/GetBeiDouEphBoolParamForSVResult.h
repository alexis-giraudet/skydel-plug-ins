...
{
public:
  inline static const char* const CmdName = "GetBeiDouEphBoolParamForSVResult";
  ...
  GetBeiDouEphBoolParamForSVResult() : CommandResult(CmdName, TargetId) {}

  GetBeiDouEphBoolParamForSVResult(int svId,
  ...
  GetBeiDouEphBoolParamForSVResult(CommandBasePtr relatedCommand,
                                   int svId,
                                   const std::string& paramName,
                                   bool val,
                                   const std::optional<std::string>& dataSetName = {}) :
  ...
  static GetBeiDouEphBoolParamForSVResultPtr create(int svId,
                                                    const std::string& paramName,
                                                    bool val,
                                                    const std::optional<std::string>& dataSetName = {})
  {
  ...
  static GetBeiDouEphBoolParamForSVResultPtr create(CommandBasePtr relatedCommand,
                                                    int svId,
                                                    const std::string& paramName,
                                                    bool val,
                                                    const std::optional<std::string>& dataSetName = {})
...
REGISTER_COMMAND_TO_FACTORY(GetBeiDouEphBoolParamForSVResult);
} // namespace Cmd
} // namespace Sdx
