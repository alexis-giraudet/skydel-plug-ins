...
public:
  ...
  GetBeiDouEphDoubleParamForEachSVResult() : CommandResult(CmdName, TargetId) {}

  GetBeiDouEphDoubleParamForEachSVResult(const std::string& paramName,
  ...
  GetBeiDouEphDoubleParamForEachSVResult(CommandBasePtr relatedCommand,
  ...
  static GetBeiDouEphDoubleParamForEachSVResultPtr create(const std::string& paramName,
                                                          const std::vector<double>& val,
                                                          const std::optional<std::string>& dataSetName = {})
  {
  ...
  static GetBeiDouEphDoubleParamForEachSVResultPtr create(CommandBasePtr relatedCommand,
                                                          const std::string& paramName,
                                                          const std::vector<double>& val,
                                                          const std::optional<std::string>& dataSetName = {})
  {
