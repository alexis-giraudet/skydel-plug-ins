...
{
///
/// Please note the command GetBeiDouEphDoubleParamForSV is deprecated since 23.11. You may use
...
{
public:
  inline static const char* const CmdName = "GetBeiDouEphDoubleParamForSV";
  ...
  GetBeiDouEphDoubleParamForSV() : CommandBase(CmdName, TargetId) {}

  GetBeiDouEphDoubleParamForSV(int svId,
  ...
  static GetBeiDouEphDoubleParamForSVPtr create(int svId,
                                                const std::string& paramName,
                                                const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(GetBeiDouEphDoubleParamForSV);
} // namespace Cmd
} // namespace Sdx
