...
{
///
/// Please note the command GetBeiDouEphemerisBoolParams is deprecated since 21.3. You may use
...
public:
  ...
  inline static const char* const Deprecated =
    "Please note the command GetBeiDouEphemerisBoolParams is deprecated since 23.11. You may use GetConstellationParameterForSV.";

  GetBeiDouEphemerisBoolParams() : CommandBase(CmdName, TargetId) {}
