...
{
///
/// Please note the command GetBeiDouEphemerisDoubleParams is deprecated since 21.3. You may use
/// GetBeiDouEphDoubleParamForEachSV.
///
/// Please note the command GetBeiDouEphDoubleParamForEachSV is deprecated since 23.11. You may use
...
/// to SetBeiDouEphDoubleParamForSV for accepted names DataSetName optional string Optional name of the data set to use.
...
{
public:
  inline static const char* const CmdName = "GetBeiDouEphemerisDoubleParams";
  ...
  inline static const char* const Deprecated =
    "Please note the command GetBeiDouEphemerisDoubleParams is deprecated since 23.11. You may use GetConstellationParameterForSV.";

  GetBeiDouEphemerisDoubleParams() : CommandBase(CmdName, TargetId) {}
...
REGISTER_COMMAND_TO_FACTORY(GetBeiDouEphemerisDoubleParams);
} // namespace Cmd
} // namespace Sdx
