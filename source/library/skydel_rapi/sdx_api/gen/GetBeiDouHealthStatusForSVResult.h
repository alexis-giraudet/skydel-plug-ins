...
public:
  ...
  GetBeiDouHealthStatusForSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetBeiDouHealthStatusForSVResult(CommandBasePtr relatedCommand,
                                   int svId,
                                   int health,
  ...
  static GetBeiDouHealthStatusForSVResultPtr create(int svId,
                                                    int health,
                                                    const std::optional<std::string>& dataSetName = {})
  {
  ...
  static GetBeiDouHealthStatusForSVResultPtr create(CommandBasePtr relatedCommand,
                                                    int svId,
                                                    int health,
                                                    const std::optional<std::string>& dataSetName = {})
  {
