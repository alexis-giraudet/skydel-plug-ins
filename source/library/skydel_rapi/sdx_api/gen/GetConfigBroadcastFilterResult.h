...
public:
  ...
  GetConfigBroadcastFilterResult() : CommandResult(CmdName, TargetId) {}

  GetConfigBroadcastFilterResult(const std::vector<Sdx::ConfigFilter>& filter) : CommandResult(CmdName, TargetId)
  {
  ...
  static GetConfigBroadcastFilterResultPtr create(CommandBasePtr relatedCommand,
                                                  const std::vector<Sdx::ConfigFilter>& filter)
  {
