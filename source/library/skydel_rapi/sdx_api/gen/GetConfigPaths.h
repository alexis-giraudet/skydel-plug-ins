...
public:
  ...
  GetConfigPaths() : CommandBase(CmdName, TargetId) {}

  static GetConfigPathsPtr create() { return std::make_shared<GetConfigPaths>(); }

  static GetConfigPathsPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetConfigPaths>(ptr); }
