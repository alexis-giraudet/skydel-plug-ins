...
/// ----------- ---------------
/// ------------------------------------------------------------------------------------------- System      string
/// "GPS", "Galileo", "BeiDou", "QZSS", "NavIC" or "PULSAR". ParamName   string          Refer to
/// SetConstellationParameterForSV for accepted names. DataSetName optional string Optional name of the data set to use.
...
public:
  ...
  GetConstellationParameterForEachSV() : CommandBase(CmdName, TargetId) {}

  GetConstellationParameterForEachSV(const std::string& system,
  ...
  static GetConstellationParameterForEachSVPtr create(const std::string& system,
                                                      const std::string& paramName,
                                                      const std::optional<std::string>& dataSetName = {})
  {
