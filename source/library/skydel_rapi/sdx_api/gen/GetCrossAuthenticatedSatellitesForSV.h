...
public:
  ...
  GetCrossAuthenticatedSatellitesForSV() : CommandBase(CmdName, TargetId) {}

  GetCrossAuthenticatedSatellitesForSV(int svId) : CommandBase(CmdName, TargetId) { setSvId(svId); }
