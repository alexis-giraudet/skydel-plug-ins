...
public:
  ...
  GetCrossAuthenticatedSatellitesForSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetCrossAuthenticatedSatellitesForSVResult(CommandBasePtr relatedCommand,
                                             int svId,
  ...
  static GetCrossAuthenticatedSatellitesForSVResultPtr create(CommandBasePtr relatedCommand,
                                                              int svId,
                                                              const std::vector<int>& svIdList)
  {
