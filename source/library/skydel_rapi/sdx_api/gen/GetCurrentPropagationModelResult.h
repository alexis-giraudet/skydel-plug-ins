...
public:
  ...
  GetCurrentPropagationModelResult() : CommandResult(CmdName, TargetId) {}

  GetCurrentPropagationModelResult(const Sdx::PropagationModelType& model) : CommandResult(CmdName, TargetId)
  {
  ...
  static GetCurrentPropagationModelResultPtr create(CommandBasePtr relatedCommand,
