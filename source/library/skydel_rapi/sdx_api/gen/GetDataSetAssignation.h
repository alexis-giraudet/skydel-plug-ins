...
public:
  ...
  GetDataSetAssignation() : CommandBase(CmdName, TargetId) {}

  GetDataSetAssignation(const std::string& system, const std::string& dataSetType) : CommandBase(CmdName, TargetId)
  {
