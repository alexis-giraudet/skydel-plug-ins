...
public:
  ...
  GetDataSetAssignationResult() : CommandResult(CmdName, TargetId) {}

  GetDataSetAssignationResult(const std::string& system,
  ...
  GetDataSetAssignationResult(CommandBasePtr relatedCommand,
  ...
  static GetDataSetAssignationResultPtr create(const std::string& system,
                                               const std::string& dataSetType,
                                               const std::string& dataSetName)
  {
  ...
  static GetDataSetAssignationResultPtr create(CommandBasePtr relatedCommand,
                                               const std::string& system,
                                               const std::string& dataSetType,
                                               const std::string& dataSetName)
  {
  ...
  std::string dataSetType() const { return parse_json<std::string>::parse(m_values["DataSetType"]); }

  void setDataSetType(const std::string& dataSetType)
  {
    m_values.AddMember("DataSetType",
                       parse_json<std::string>::format(dataSetType, m_values.GetAllocator()),
                       m_values.GetAllocator());
  }
