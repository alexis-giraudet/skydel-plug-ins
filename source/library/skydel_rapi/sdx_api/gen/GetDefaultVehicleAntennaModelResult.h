...
public:
  ...
  GetDefaultVehicleAntennaModelResult() : CommandResult(CmdName, TargetId) {}

  GetDefaultVehicleAntennaModelResult(const std::string& name) : CommandResult(CmdName, TargetId) { setName(name); }
