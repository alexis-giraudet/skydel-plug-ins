...
public:
  ...
  GetDuration() : CommandBase(CmdName, TargetId) {}

  static GetDurationPtr create() { return std::make_shared<GetDuration>(); }

  static GetDurationPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetDuration>(ptr); }
