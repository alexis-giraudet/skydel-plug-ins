...
public:
  ...
  GetDurationResult() : CommandResult(CmdName, TargetId) {}

  GetDurationResult(int second) : CommandResult(CmdName, TargetId) { setSecond(second); }

  GetDurationResult(CommandBasePtr relatedCommand, int second) : CommandResult(CmdName, TargetId, relatedCommand)
  {

    setSecond(second);
  }

  static GetDurationResultPtr create(int second) { return std::make_shared<GetDurationResult>(second); }
