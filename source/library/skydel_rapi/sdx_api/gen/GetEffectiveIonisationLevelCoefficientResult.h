...
public:
  ...
  GetEffectiveIonisationLevelCoefficientResult() : CommandResult(CmdName, TargetId) {}

  GetEffectiveIonisationLevelCoefficientResult(int index, double val) : CommandResult(CmdName, TargetId)
  {
