...
public:
  ...
  GetElevationAzimuthForEachSV() : CommandBase(CmdName, TargetId) {}

  GetElevationAzimuthForEachSV(const std::string& system) : CommandBase(CmdName, TargetId) { setSystem(system); }
