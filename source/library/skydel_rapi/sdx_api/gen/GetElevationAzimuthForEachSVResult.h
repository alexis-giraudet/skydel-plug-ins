...
/// ----------------- -------------------------------
/// --------------------------------------------------------------------------- System            string "GPS",
/// "GLONASS", "Galileo", "BeiDou", "SBAS", "QZSS", "NavIC" or "PULSAR". ElevationAzimuths array optional
/// ElevationAzimuth Elevation and Azimuth position angles of the satellites.
///
...
public:
  ...
  GetElevationAzimuthForEachSVResult() : CommandResult(CmdName, TargetId) {}

  GetElevationAzimuthForEachSVResult(const std::string& system,
                                     const std::vector<std::optional<Sdx::ElevationAzimuth>>& elevationAzimuths) :
  ...
  GetElevationAzimuthForEachSVResult(CommandBasePtr relatedCommand,
  ...
  static GetElevationAzimuthForEachSVResultPtr create(
    const std::string& system,
    const std::vector<std::optional<Sdx::ElevationAzimuth>>& elevationAzimuths)
  {
  ...
  {
    m_values.AddMember("ElevationAzimuths",
                       parse_json<std::vector<std::optional<Sdx::ElevationAzimuth>>>::format(elevationAzimuths,
                                                                                             m_values.GetAllocator()),
                       m_values.GetAllocator());
  }
};
