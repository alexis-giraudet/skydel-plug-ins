...
/// ----------- ------------
/// ---------------------------------------------------------------------------------------------- System      string
/// The system, can be "GPS", "GLONASS", "Galileo", "BeiDou", "SBAS", "QZSS", "NavIC" or "PULSAR". SvId        int The
/// satellite SV ID. SignalArray array string The list of enabled signals.
///
...
public:
  ...
  GetEnabledSignalsForSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetEnabledSignalsForSVResult(CommandBasePtr relatedCommand,
  ...
  static GetEnabledSignalsForSVResultPtr create(const std::string& system,
                                                int svId,
                                                const std::vector<std::string>& signalArray)
  {
  ...
  static GetEnabledSignalsForSVResultPtr create(CommandBasePtr relatedCommand,
                                                const std::string& system,
                                                int svId,
                                                const std::vector<std::string>& signalArray)
  {
