...
public:
  ...
  GetEncryptionLibraryPath() : CommandBase(CmdName, TargetId) {}

  GetEncryptionLibraryPath(const Sdx::EncryptionSignalType& type) : CommandBase(CmdName, TargetId) { setType(type); }
