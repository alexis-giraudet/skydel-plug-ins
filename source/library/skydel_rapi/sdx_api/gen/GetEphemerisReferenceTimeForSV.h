...
{
public:
  inline static const char* const CmdName = "GetEphemerisReferenceTimeForSV";
  ...
  GetEphemerisReferenceTimeForSV() : CommandBase(CmdName, TargetId) {}

  GetEphemerisReferenceTimeForSV(const std::string& system,
                                 int svId,
  ...
  static GetEphemerisReferenceTimeForSVPtr create(const std::string& system,
                                                  int svId,
                                                  const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(GetEphemerisReferenceTimeForSV);
} // namespace Cmd
} // namespace Sdx
