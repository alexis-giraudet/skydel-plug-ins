...
public:
  ...
  GetGalileoEphDoubleParamForEachSVResult() : CommandResult(CmdName, TargetId) {}

  GetGalileoEphDoubleParamForEachSVResult(const std::string& paramName,
  ...
  GetGalileoEphDoubleParamForEachSVResult(CommandBasePtr relatedCommand,
  ...
  static GetGalileoEphDoubleParamForEachSVResultPtr create(const std::string& paramName,
                                                           const std::vector<double>& val,
                                                           const std::optional<std::string>& dataSetName = {})
  {
  ...
  static GetGalileoEphDoubleParamForEachSVResultPtr create(CommandBasePtr relatedCommand,
                                                           const std::string& paramName,
                                                           const std::vector<double>& val,
                                                           const std::optional<std::string>& dataSetName = {})
  {
