...
{
///
/// Please note the command GetGalileoEphDoubleParamForSV is deprecated since 23.11. You may use
...
{
public:
  inline static const char* const CmdName = "GetGalileoEphDoubleParamForSV";
  ...
  GetGalileoEphDoubleParamForSV() : CommandBase(CmdName, TargetId) {}

  GetGalileoEphDoubleParamForSV(int svId,
  ...
  static GetGalileoEphDoubleParamForSVPtr create(int svId,
                                                 const std::string& paramName,
                                                 const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(GetGalileoEphDoubleParamForSV);
} // namespace Cmd
} // namespace Sdx
