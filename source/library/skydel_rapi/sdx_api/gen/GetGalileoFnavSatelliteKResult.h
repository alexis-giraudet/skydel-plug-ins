...
public:
  ...
  GetGalileoFnavSatelliteKResult() : CommandResult(CmdName, TargetId) {}

  GetGalileoFnavSatelliteKResult(int prn, int k) : CommandResult(CmdName, TargetId)
  {
  ...
  virtual bool isValid() const override
  {
    ...
    return m_values.IsObject() && parse_json<int>::is_valid(m_values["Prn"]) &&
  ...
  int k() const { return parse_json<int>::parse(m_values["K"]); }
