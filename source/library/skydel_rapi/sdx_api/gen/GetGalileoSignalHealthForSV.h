...
/// ----------- ---------------
/// ------------------------------------------------------------------------------------------- SvId        int The
/// satellite's SV ID 1..36 Component   string          Component is either "E5a", "E5b", or "E1B" DataSetName optional
...
public:
  ...
  GetGalileoSignalHealthForSV() : CommandBase(CmdName, TargetId) {}

  GetGalileoSignalHealthForSV(int svId,
  ...
  static GetGalileoSignalHealthForSVPtr create(int svId,
                                               const std::string& component,
                                               const std::optional<std::string>& dataSetName = {})
  {
