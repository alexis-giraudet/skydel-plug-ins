...
public:
  ...
  GetGaussianNoiseSeedResult() : CommandResult(CmdName, TargetId) {}

  GetGaussianNoiseSeedResult(const std::string& id, int outputIdx, int seed) : CommandResult(CmdName, TargetId)
  {
  ...
  static GetGaussianNoiseSeedResultPtr create(CommandBasePtr relatedCommand,
                                              const std::string& id,
                                              int outputIdx,
                                              int seed)
  {
