...
public:
  ...
  GetGlonassAlmanacUnhealthyFlagForSV() : CommandBase(CmdName, TargetId) {}

  GetGlonassAlmanacUnhealthyFlagForSV(int svId) : CommandBase(CmdName, TargetId) { setSvId(svId); }
