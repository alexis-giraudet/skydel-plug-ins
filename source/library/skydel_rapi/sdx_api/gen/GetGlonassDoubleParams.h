...
{
///
/// Please note the command GetGlonassDoubleParams is deprecated since 21.3. You may use
...
public:
  ...
  GetGlonassDoubleParams() : CommandBase(CmdName, TargetId) {}

  GetGlonassDoubleParams(const std::string& paramName) : CommandBase(CmdName, TargetId) { setParamName(paramName); }
