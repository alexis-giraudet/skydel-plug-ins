...
public:
  ...
  GetGlonassEphDoubleParamForEachSV() : CommandBase(CmdName, TargetId) {}

  GetGlonassEphDoubleParamForEachSV(const std::string& paramName) : CommandBase(CmdName, TargetId)
  {
