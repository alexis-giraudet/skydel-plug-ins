...
public:
  ...
  GetGlonassEphDoubleParamForSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetGlonassEphDoubleParamForSVResult(CommandBasePtr relatedCommand,
                                      int svId,
  ...
  static GetGlonassEphDoubleParamForSVResultPtr create(CommandBasePtr relatedCommand,
                                                       int svId,
                                                       const std::string& paramName,
                                                       double val)
  {
