...
/// ------------ ---------------
/// ------------------------------------------------------------------------------------------- SvId         int
/// Satellite's SV ID 1..32, or use 0 to apply new value to all satellites. AntiSpoofing GpsASFlag       GPS
/// Anti-Spoofing Flag. DataSetName  optional string Optional name of the data set to use. If no value is provided, the
...
public:
  ...
  GetGpsAntiSpoofingFlagForSVResult() : CommandResult(CmdName, TargetId) {}

  GetGpsAntiSpoofingFlagForSVResult(int svId,
                                    const Sdx::GpsASFlag& antiSpoofing,
  ...
  GetGpsAntiSpoofingFlagForSVResult(CommandBasePtr relatedCommand,
                                    int svId,
                                    const Sdx::GpsASFlag& antiSpoofing,
                                    const std::optional<std::string>& dataSetName = {}) :
  ...
  static GetGpsAntiSpoofingFlagForSVResultPtr create(int svId,
                                                     const Sdx::GpsASFlag& antiSpoofing,
                                                     const std::optional<std::string>& dataSetName = {})
  {
  ...
  static GetGpsAntiSpoofingFlagForSVResultPtr create(CommandBasePtr relatedCommand,
                                                     int svId,
                                                     const Sdx::GpsASFlag& antiSpoofing,
                                                     const std::optional<std::string>& dataSetName = {})
  {
  ...
  Sdx::GpsASFlag antiSpoofing() const { return parse_json<Sdx::GpsASFlag>::parse(m_values["AntiSpoofing"]); }

  void setAntiSpoofing(const Sdx::GpsASFlag& antiSpoofing)
  {
    m_values.AddMember("AntiSpoofing",
                       parse_json<Sdx::GpsASFlag>::format(antiSpoofing, m_values.GetAllocator()),
