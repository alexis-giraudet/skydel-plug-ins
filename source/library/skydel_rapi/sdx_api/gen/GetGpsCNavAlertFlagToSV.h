...
{
public:
  inline static const char* const CmdName = "GetGpsCNavAlertFlagToSV";
  ...
  GetGpsCNavAlertFlagToSV() : CommandBase(CmdName, TargetId) {}

  GetGpsCNavAlertFlagToSV(int svId, const std::optional<std::string>& dataSetName = {}) : CommandBase(CmdName, TargetId)
  {
...
REGISTER_COMMAND_TO_FACTORY(GetGpsCNavAlertFlagToSV);
} // namespace Cmd
} // namespace Sdx
