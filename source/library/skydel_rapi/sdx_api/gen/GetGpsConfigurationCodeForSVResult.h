...
public:
  ...
  GetGpsConfigurationCodeForSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetGpsConfigurationCodeForSVResult(CommandBasePtr relatedCommand,
                                     int svId,
                                     int svConfig,
  ...
  static GetGpsConfigurationCodeForSVResultPtr create(int svId,
                                                      int svConfig,
                                                      const std::optional<std::string>& dataSetName = {})
  {
  ...
  static GetGpsConfigurationCodeForSVResultPtr create(CommandBasePtr relatedCommand,
                                                      int svId,
                                                      int svConfig,
                                                      const std::optional<std::string>& dataSetName = {})
  {
