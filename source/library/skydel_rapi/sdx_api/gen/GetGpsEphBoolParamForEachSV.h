...
{
///
/// Please note the command GetGpsEphBoolParamForEachSV is deprecated since 23.11. You may use
...
/// to SetGpsEphBoolParamForSV for accepted names DataSetName optional string Optional name of the data set to use. If
...
public:
  ...
  GetGpsEphBoolParamForEachSV() : CommandBase(CmdName, TargetId) {}
