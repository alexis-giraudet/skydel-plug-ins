...
{
///
/// Please note the command GetGpsEphBoolParamForSV is deprecated since 23.11. You may use
...
public:
  ...
  GetGpsEphBoolParamForSV() : CommandBase(CmdName, TargetId) {}
  ...
  static GetGpsEphBoolParamForSVPtr create(int svId,
