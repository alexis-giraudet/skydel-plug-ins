...
{
///
/// Please note the command GetGpsEphDoubleParamForSV is deprecated since 23.11. You may use
...
/// (see table above for accepted names) DataSetName optional string Optional name of the data set to use. If no value
...
{
public:
  inline static const char* const CmdName = "GetGpsEphDoubleParamForSV";
  ...
  GetGpsEphDoubleParamForSV() : CommandBase(CmdName, TargetId) {}

  GetGpsEphDoubleParamForSV(int svId,
  ...
  static GetGpsEphDoubleParamForSVPtr create(int svId,
                                             const std::string& paramName,
                                             const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(GetGpsEphDoubleParamForSV);
} // namespace Cmd
} // namespace Sdx
