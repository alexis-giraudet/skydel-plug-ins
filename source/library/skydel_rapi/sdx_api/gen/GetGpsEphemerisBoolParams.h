...
public:
  ...
  inline static const char* const Deprecated =
    "Please note the command GetGpsEphemerisBoolParams is deprecated since 23.11. You may use GetConstellationParameterForSV.";

  GetGpsEphemerisBoolParams() : CommandBase(CmdName, TargetId) {}
