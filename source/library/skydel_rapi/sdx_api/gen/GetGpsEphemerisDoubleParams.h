...
{
///
/// Please note the command GetGpsEphemerisDoubleParams is deprecated since 21.3. You may use
...
public:
  ...
  inline static const char* const Deprecated =
    "Please note the command GetGpsEphemerisDoubleParams is deprecated since 23.11. You may use GetConstellationParameterForSV.";

  GetGpsEphemerisDoubleParams() : CommandBase(CmdName, TargetId) {}
