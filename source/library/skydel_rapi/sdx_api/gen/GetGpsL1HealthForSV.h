...
{
public:
  inline static const char* const CmdName = "GetGpsL1HealthForSV";
  ...
  GetGpsL1HealthForSV() : CommandBase(CmdName, TargetId) {}

  GetGpsL1HealthForSV(int svId, const std::optional<std::string>& dataSetName = {}) : CommandBase(CmdName, TargetId)
  {
...
REGISTER_COMMAND_TO_FACTORY(GetGpsL1HealthForSV);
} // namespace Cmd
} // namespace Sdx
