...
{
public:
  inline static const char* const CmdName = "GetGpsL1cHealthForSV";
  ...
  GetGpsL1cHealthForSV() : CommandBase(CmdName, TargetId) {}

  GetGpsL1cHealthForSV(int svId, const std::optional<std::string>& dataSetName = {}) : CommandBase(CmdName, TargetId)
  {
...
REGISTER_COMMAND_TO_FACTORY(GetGpsL1cHealthForSV);
} // namespace Cmd
} // namespace Sdx
