...
{
public:
  inline static const char* const CmdName = "GetGpsL1cHealthForSVResult";
  ...
  GetGpsL1cHealthForSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetGpsL1cHealthForSVResult(CommandBasePtr relatedCommand,
                             int svId,
                             bool health,
  ...
  static GetGpsL1cHealthForSVResultPtr create(CommandBasePtr relatedCommand,
                                              int svId,
                                              bool health,
                                              const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(GetGpsL1cHealthForSVResult);
} // namespace Cmd
} // namespace Sdx
