...
/// ----------- ---------------
/// ------------------------------------------------------------------------------------------- SvId        int
/// Satellite's SV ID 1..32, or use 0 to apply new value to all satellites. Health      bool            L2 health, false
...
{
public:
  inline static const char* const CmdName = "GetGpsL2HealthForSVResult";
  ...
  GetGpsL2HealthForSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetGpsL2HealthForSVResult(CommandBasePtr relatedCommand,
                            int svId,
                            bool health,
  ...
  static GetGpsL2HealthForSVResultPtr create(CommandBasePtr relatedCommand,
                                             int svId,
                                             bool health,
                                             const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(GetGpsL2HealthForSVResult);
} // namespace Cmd
} // namespace Sdx
