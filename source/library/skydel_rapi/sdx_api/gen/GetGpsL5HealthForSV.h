...
{
public:
  inline static const char* const CmdName = "GetGpsL5HealthForSV";
  ...
  GetGpsL5HealthForSV() : CommandBase(CmdName, TargetId) {}

  GetGpsL5HealthForSV(int svId, const std::optional<std::string>& dataSetName = {}) : CommandBase(CmdName, TargetId)
  {
...
REGISTER_COMMAND_TO_FACTORY(GetGpsL5HealthForSV);
} // namespace Cmd
} // namespace Sdx
