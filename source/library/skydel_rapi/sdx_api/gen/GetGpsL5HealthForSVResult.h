...
/// ----------- ---------------
/// ------------------------------------------------------------------------------------------- SvId        int
/// Satellite's SV ID 1..32, or use 0 to apply new value to all satellites. Health      bool            L5 health, false
/// = signal OK, true = signal bad or unavailable DataSetName optional string Optional name of the data set to use. If
...
{
public:
  inline static const char* const CmdName = "GetGpsL5HealthForSVResult";
  ...
  GetGpsL5HealthForSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetGpsL5HealthForSVResult(CommandBasePtr relatedCommand,
                            int svId,
                            bool health,
  ...
  static GetGpsL5HealthForSVResultPtr create(CommandBasePtr relatedCommand,
                                             int svId,
                                             bool health,
                                             const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(GetGpsL5HealthForSVResult);
} // namespace Cmd
} // namespace Sdx
