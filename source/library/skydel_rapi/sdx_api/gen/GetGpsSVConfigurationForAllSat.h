...
{
///
/// Please note the command GetGpsSVConfigurationForAllSat is deprecated since 21.3. You may use
...
public:
  ...
  GetGpsSVConfigurationForAllSat(const std::optional<std::string>& dataSetName = {}) : CommandBase(CmdName, TargetId)
  {
