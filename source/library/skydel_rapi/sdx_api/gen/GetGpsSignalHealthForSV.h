...
{
public:
  inline static const char* const CmdName = "GetGpsSignalHealthForSV";
  ...
  GetGpsSignalHealthForSV() : CommandBase(CmdName, TargetId) {}

  GetGpsSignalHealthForSV(int svId, const std::optional<std::string>& dataSetName = {}) : CommandBase(CmdName, TargetId)
  {
...
REGISTER_COMMAND_TO_FACTORY(GetGpsSignalHealthForSV);
} // namespace Cmd
} // namespace Sdx
