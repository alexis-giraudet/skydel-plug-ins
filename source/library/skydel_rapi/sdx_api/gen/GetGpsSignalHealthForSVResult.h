...
public:
  ...
  GetGpsSignalHealthForSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetGpsSignalHealthForSVResult(CommandBasePtr relatedCommand,
                                int svId,
                                int health,
  ...
  static GetGpsSignalHealthForSVResultPtr create(int svId,
                                                 int health,
                                                 const std::optional<std::string>& dataSetName = {})
  {
  ...
  static GetGpsSignalHealthForSVResultPtr create(CommandBasePtr relatedCommand,
                                                 int svId,
                                                 int health,
                                                 const std::optional<std::string>& dataSetName = {})
  {
