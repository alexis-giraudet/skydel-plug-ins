...
public:
  ...
  GetGpsStartTime() : CommandBase(CmdName, TargetId) {}

  static GetGpsStartTimePtr create() { return std::make_shared<GetGpsStartTime>(); }

  static GetGpsStartTimePtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetGpsStartTime>(ptr); }
