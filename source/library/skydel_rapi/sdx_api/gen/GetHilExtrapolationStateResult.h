...
public:
  ...
  GetHilExtrapolationStateResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetHilExtrapolationStateResult(CommandBasePtr relatedCommand,
                                 const Sdx::HilExtrapolationState& state,
                                 int elapsedTime) :
  ...
  static GetHilExtrapolationStateResultPtr create(CommandBasePtr relatedCommand,
                                                  const Sdx::HilExtrapolationState& state,
                                                  int elapsedTime)
  {
  ...
  virtual bool isValid() const override
  {
    ...
    return m_values.IsObject() && parse_json<Sdx::HilExtrapolationState>::is_valid(m_values["State"]) &&
  ...
  Sdx::HilExtrapolationState state() const { return parse_json<Sdx::HilExtrapolationState>::parse(m_values["State"]); }

  void setState(const Sdx::HilExtrapolationState& state)
  {
    m_values.AddMember("State",
                       parse_json<Sdx::HilExtrapolationState>::format(state, m_values.GetAllocator()),
                       m_values.GetAllocator());
  }

  int elapsedTime() const { return parse_json<int>::parse(m_values["ElapsedTime"]); }

  void setElapsedTime(int elapsedTime)
  {
    m_values.AddMember("ElapsedTime",
                       parse_json<int>::format(elapsedTime, m_values.GetAllocator()),
                       m_values.GetAllocator());
  }
};
