...
{
public:
  inline static const char* const CmdName = "GetIntTxBPSK";
  inline static const char* const Documentation = "Get BPSK signal interference.\n"
                                                  "\n"
                                                  "Name          Type   Description\n"
                                                  "------------- ------ ------------------------------\n"
                                                  "TransmitterId string Transmitter unique identifier.\n"
  ...
  GetIntTxBPSK() : CommandBase(CmdName, TargetId) {}

  GetIntTxBPSK(const std::string& transmitterId, const std::string& signalId) : CommandBase(CmdName, TargetId)
  {
  ...
  static GetIntTxBPSKPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetIntTxBPSK>(ptr); }
...
REGISTER_COMMAND_TO_FACTORY(GetIntTxBPSK);
} // namespace Cmd
} // namespace Sdx
