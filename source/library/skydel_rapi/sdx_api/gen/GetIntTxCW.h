...
public:
  ...
  GetIntTxCW() : CommandBase(CmdName, TargetId) {}

  GetIntTxCW(const std::string& transmitterId, const std::string& signalId) : CommandBase(CmdName, TargetId)
  {
  ...
  static GetIntTxCWPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetIntTxCW>(ptr); }
