...
{
public:
  inline static const char* const CmdName = "GetIntTxChirp";
  inline static const char* const Documentation = "Get informations about the Chirp signal of the transmitter.\n"
                                                  "\n"
                                                  "Name          Type   Description\n"
                                                  "------------- ------ ------------------------------\n"
                                                  "TransmitterId string Transmitter unique identifier.\n"
  ...
  GetIntTxChirp() : CommandBase(CmdName, TargetId) {}

  GetIntTxChirp(const std::string& transmitterId, const std::string& signalId) : CommandBase(CmdName, TargetId)
  {
  ...
  static GetIntTxChirpPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetIntTxChirp>(ptr); }
...
REGISTER_COMMAND_TO_FACTORY(GetIntTxChirp);
} // namespace Cmd
} // namespace Sdx
