...
public:
  ...
  GetIntTxCircular() : CommandBase(CmdName, TargetId) {}

  GetIntTxCircular(const std::string& id) : CommandBase(CmdName, TargetId) { setId(id); }

  static GetIntTxCircularPtr create(const std::string& id) { return std::make_shared<GetIntTxCircular>(id); }
