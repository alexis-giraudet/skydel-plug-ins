...
{
public:
  inline static const char* const CmdName = "GetIntTxCircularResult";
  inline static const char* const Documentation = "Result of GetIntTxCircular.\n"
                                                  "\n"
                                                  "Name        Type            Description\n"
                                                  "----------- --------------- --------------------------------\n"
                                                  "Lat         double          Center latitude (rad)\n"
  ...
  GetIntTxCircularResult() : CommandResult(CmdName, TargetId) {}

  GetIntTxCircularResult(double lat,
                         double lon,
                         double alt,
                         double radius,
                         double speed,
  ...
  GetIntTxCircularResult(CommandBasePtr relatedCommand,
                         double lat,
                         double lon,
                         double alt,
                         double radius,
  ...
  static GetIntTxCircularResultPtr create(double lat,
                                          double lon,
                                          double alt,
                                          double radius,
                                          double speed,
  ...
  static GetIntTxCircularResultPtr create(CommandBasePtr relatedCommand,
                                          double lat,
                                          double lon,
                                          double alt,
                                          double radius,
                                          ...
                                          const std::optional<double>& originAngle = {})
  {
    return std::make_shared<GetIntTxCircularResult>(relatedCommand,
                                                    lat,
                                                    lon,
                                                    alt,
                                                    radius,
...
REGISTER_COMMAND_TO_FACTORY(GetIntTxCircularResult);
} // namespace Cmd
} // namespace Sdx
