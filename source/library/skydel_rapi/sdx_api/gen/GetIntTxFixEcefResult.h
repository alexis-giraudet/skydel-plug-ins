...
{
public:
  inline static const char* const CmdName = "GetIntTxFixEcefResult";
  inline static const char* const Documentation = "Result of GetIntTxFixEcef.\n"
                                                  "\n"
                                                  "Name  Type   Description\n"
                                                  "----- ------ ------------------------------\n"
                                                  "X     double ECEF X (m)\n"
  ...
  GetIntTxFixEcefResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetIntTxFixEcefResult(CommandBasePtr relatedCommand,
                        double x,
                        double y,
                        double z,
                        double yaw,
  ...
  static GetIntTxFixEcefResultPtr
  ...
  static GetIntTxFixEcefResultPtr create(CommandBasePtr relatedCommand,
                                         double x,
                                         double y,
                                         double z,
                                         double yaw,
...
REGISTER_COMMAND_TO_FACTORY(GetIntTxFixEcefResult);
} // namespace Cmd
} // namespace Sdx
