...
{
public:
  inline static const char* const CmdName = "GetIntTxFixResult";
  inline static const char* const Documentation = "Result of GetIntTxFix.\n"
                                                  "\n"
                                                  "Name  Type   Description\n"
                                                  "----- ------ ------------------------------\n"
                                                  "Lat   double Latitude (rad)\n"
  ...
  GetIntTxFixResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetIntTxFixResult(CommandBasePtr relatedCommand,
                    double lat,
                    double lon,
                    double alt,
                    double yaw,
  ...
  static GetIntTxFixResultPtr create(CommandBasePtr relatedCommand,
                                     double lat,
                                     double lon,
                                     double alt,
                                     double yaw,
...
REGISTER_COMMAND_TO_FACTORY(GetIntTxFixResult);
} // namespace Cmd
} // namespace Sdx
