...
public:
  ...
  GetIntTxHiddenOnMapResult() : CommandResult(CmdName, TargetId) {}

  GetIntTxHiddenOnMapResult(bool hiddenOnMap, const std::string& id) : CommandResult(CmdName, TargetId)
  {
  ...
  virtual bool isValid() const override
  {
    ...
    return m_values.IsObject() && parse_json<bool>::is_valid(m_values["HiddenOnMap"]) &&
  ...
  bool hiddenOnMap() const { return parse_json<bool>::parse(m_values["HiddenOnMap"]); }

  void setHiddenOnMap(bool hiddenOnMap)
  {
    m_values.AddMember("HiddenOnMap",
                       parse_json<bool>::format(hiddenOnMap, m_values.GetAllocator()),
