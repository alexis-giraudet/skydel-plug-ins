...
public:
  ...
  GetIntTxIqFileResult() : CommandResult(CmdName, TargetId) {}

  GetIntTxIqFileResult(bool enabled,
                       double centralFreq,
                       double power,
  ...
  GetIntTxIqFileResult(CommandBasePtr relatedCommand,
                       bool enabled,
                       double centralFreq,
                       double power,
                       const std::string& path,
  ...
  static GetIntTxIqFileResultPtr create(bool enabled,
                                        double centralFreq,
                                        double power,
                                        const std::string& path,
                                        const std::string& transmitterId,
  ...
  static GetIntTxIqFileResultPtr create(CommandBasePtr relatedCommand,
                                        bool enabled,
                                        double centralFreq,
                                        double power,
                                        const std::string& path,
                                        ...
                                        const std::optional<int>& group = {})
  {
    return std::make_shared<GetIntTxIqFileResult>(relatedCommand,
                                                  enabled,
                                                  centralFreq,
                                                  power,
                                                  path,
