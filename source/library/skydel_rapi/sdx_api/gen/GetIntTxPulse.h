...
public:
  ...
  GetIntTxPulse() : CommandBase(CmdName, TargetId) {}

  GetIntTxPulse(const std::string& transmitterId, const std::string& signalId) : CommandBase(CmdName, TargetId)
  {
  ...
  static GetIntTxPulsePtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetIntTxPulse>(ptr); }
