...
public:
  ...
  GetIntTxResult() : CommandResult(CmdName, TargetId) {}

  GetIntTxResult(const std::string& usualName,
                 bool enabled,
                 int group,
                 bool dynamic,
                 double power,
  ...
  GetIntTxResult(CommandBasePtr relatedCommand,
  ...
  static GetIntTxResultPtr create(const std::string& usualName,
                                  bool enabled,
                                  int group,
                                  bool dynamic,
                                  double power,
  ...
  static GetIntTxResultPtr create(CommandBasePtr relatedCommand,
                                  const std::string& usualName,
                                  bool enabled,
                                  int group,
                                  bool dynamic,
  ...
  static GetIntTxResultPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetIntTxResult>(ptr); }
