...
public:
  ...
  GetInterModulationResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetInterModulationResult(CommandBasePtr relatedCommand,
                           const std::vector<Sdx::SignalWithComponent>& signalArray,
                           double coefficient) :
  ...
  static GetInterModulationResultPtr create(const std::vector<Sdx::SignalWithComponent>& signalArray,
                                            double coefficient)
  {
    return std::make_shared<GetInterModulationResult>(signalArray, coefficient);
  }

  static GetInterModulationResultPtr create(CommandBasePtr relatedCommand,
                                            const std::vector<Sdx::SignalWithComponent>& signalArray,
                                            double coefficient)
  {
  ...
  double coefficient() const { return parse_json<double>::parse(m_values["Coefficient"]); }

  void setCoefficient(double coefficient)
  {
    m_values.AddMember("Coefficient",
                       parse_json<double>::format(coefficient, m_values.GetAllocator()),
                       m_values.GetAllocator());
  }
};
