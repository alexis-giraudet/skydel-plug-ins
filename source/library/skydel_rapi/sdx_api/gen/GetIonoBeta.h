...
public:
  ...
  GetIonoBeta() : CommandBase(CmdName, TargetId) {}

  GetIonoBeta(int index) : CommandBase(CmdName, TargetId) { setIndex(index); }

  static GetIonoBetaPtr create(int index) { return std::make_shared<GetIonoBeta>(index); }

  static GetIonoBetaPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetIonoBeta>(ptr); }
