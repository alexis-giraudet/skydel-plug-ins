...
public:
  ...
  GetIonoGridError() : CommandBase(CmdName, TargetId) {}

  GetIonoGridError(int band, int point) : CommandBase(CmdName, TargetId)
  {
  ...
  static GetIonoGridErrorPtr create(int band, int point) { return std::make_shared<GetIonoGridError>(band, point); }
