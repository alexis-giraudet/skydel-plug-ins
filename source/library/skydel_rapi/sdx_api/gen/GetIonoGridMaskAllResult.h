...
public:
  ...
  GetIonoGridMaskAllResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetIonoGridMaskAllResult(CommandBasePtr relatedCommand,
  ...
  static GetIonoGridMaskAllResultPtr create(const std::string& serviceProvider,
                                            const std::vector<std::vector<bool>>& grid)
  {
    return std::make_shared<GetIonoGridMaskAllResult>(serviceProvider, grid);
  }

  static GetIonoGridMaskAllResultPtr create(CommandBasePtr relatedCommand,
                                            const std::string& serviceProvider,
                                            const std::vector<std::vector<bool>>& grid)
  {
  ...
  void setGrid(const std::vector<std::vector<bool>>& grid)
  {
    m_values.AddMember("Grid",
                       parse_json<std::vector<std::vector<bool>>>::format(grid, m_values.GetAllocator()),
                       m_values.GetAllocator());
  }
};
