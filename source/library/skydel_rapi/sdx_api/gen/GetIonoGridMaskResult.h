...
public:
  ...
  GetIonoGridMaskResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetIonoGridMaskResult(CommandBasePtr relatedCommand,
  ...
  static GetIonoGridMaskResultPtr create(CommandBasePtr relatedCommand,
                                         const std::string& serviceProvider,
                                         int band,
                                         int point,
                                         bool flag)
