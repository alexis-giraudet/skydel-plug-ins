...
public:
  ...
  GetIonoModel() : CommandBase(CmdName, TargetId) {}

  static GetIonoModelPtr create() { return std::make_shared<GetIonoModel>(); }

  static GetIonoModelPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetIonoModel>(ptr); }
