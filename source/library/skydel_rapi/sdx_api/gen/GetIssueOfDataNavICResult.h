...
public:
  ...
  GetIssueOfDataNavICResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetIssueOfDataNavICResult(CommandBasePtr relatedCommand,
                            int ephemerisAndClock,
  ...
  static GetIssueOfDataNavICResultPtr create(CommandBasePtr relatedCommand,
                                             int ephemerisAndClock,
                                             const std::optional<bool>& overrideRinex = {})
  {
