...
public:
  ...
  GetIssueOfDataQzssResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetIssueOfDataQzssResult(CommandBasePtr relatedCommand,
                           int clock,
                           int ephemeris,
  ...
  static GetIssueOfDataQzssResultPtr create(CommandBasePtr relatedCommand,
                                            int clock,
                                            int ephemeris,
                                            const std::optional<bool>& overrideRinex = {})
  {
