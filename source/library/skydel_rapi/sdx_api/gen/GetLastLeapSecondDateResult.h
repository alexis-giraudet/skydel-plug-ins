...
public:
  ...
  GetLastLeapSecondDateResult() : CommandResult(CmdName, TargetId) {}

  GetLastLeapSecondDateResult(const Sdx::Date& date) : CommandResult(CmdName, TargetId) { setDate(date); }
  ...
  virtual bool isValid() const override
  {
    ...
    return m_values.IsObject() && parse_json<Sdx::Date>::is_valid(m_values["Date"]);
  }
