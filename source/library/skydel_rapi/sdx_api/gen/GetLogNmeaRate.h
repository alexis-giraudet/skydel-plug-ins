...
public:
  ...
  GetLogNmeaRate() : CommandBase(CmdName, TargetId) {}

  static GetLogNmeaRatePtr create() { return std::make_shared<GetLogNmeaRate>(); }

  static GetLogNmeaRatePtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetLogNmeaRate>(ptr); }
