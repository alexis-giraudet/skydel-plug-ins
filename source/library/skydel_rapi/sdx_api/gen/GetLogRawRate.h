...
public:
  ...
  GetLogRawRate() : CommandBase(CmdName, TargetId) {}

  static GetLogRawRatePtr create() { return std::make_shared<GetLogRawRate>(); }

  static GetLogRawRatePtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetLogRawRate>(ptr); }
