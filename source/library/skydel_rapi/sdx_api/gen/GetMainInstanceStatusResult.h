...
public:
  ...
  GetMainInstanceStatusResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetMainInstanceStatusResult(CommandBasePtr relatedCommand,
                              bool isMainInstance,
                              int workerInstanceConnected,
                              int port) :
  ...
  static GetMainInstanceStatusResultPtr create(CommandBasePtr relatedCommand,
                                               bool isMainInstance,
                                               int workerInstanceConnected,
                                               int port)
  {
  ...
  virtual bool isValid() const override
  {
    ...
    return m_values.IsObject() && parse_json<bool>::is_valid(m_values["IsMainInstance"]) &&
  ...
  bool isMainInstance() const { return parse_json<bool>::parse(m_values["IsMainInstance"]); }

  void setIsMainInstance(bool isMainInstance)
  {
    m_values.AddMember("IsMainInstance",
                       parse_json<bool>::format(isMainInstance, m_values.GetAllocator()),
                       m_values.GetAllocator());
  }

  int workerInstanceConnected() const { return parse_json<int>::parse(m_values["WorkerInstanceConnected"]); }

  void setWorkerInstanceConnected(int workerInstanceConnected)
  {
    m_values.AddMember("WorkerInstanceConnected",
                       parse_json<int>::format(workerInstanceConnected, m_values.GetAllocator()),
                       m_values.GetAllocator());
  }
