...
{
public:
  inline static const char* const CmdName = "GetManualPowerOffsetForSV";
  ...
  GetManualPowerOffsetForSV() : CommandBase(CmdName, TargetId) {}
  ...
  static GetManualPowerOffsetForSVPtr create(const std::string& system,
                                             int svId,
...
REGISTER_COMMAND_TO_FACTORY(GetManualPowerOffsetForSV);
} // namespace Cmd
} // namespace Sdx
