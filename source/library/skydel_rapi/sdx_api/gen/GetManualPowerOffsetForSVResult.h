...
///                                                             "NAVICL1", "NAVICL5", "NAVICS", "PULSARXL" and
///                                                             "PULSARX1"
///
...
public:
  ...
  GetManualPowerOffsetForSVResult() : CommandResult(CmdName, TargetId) {}

  GetManualPowerOffsetForSVResult(const std::string& system,
                                  int svId,
  ...
  GetManualPowerOffsetForSVResult(CommandBasePtr relatedCommand,
  ...
  static GetManualPowerOffsetForSVResultPtr create(const std::string& system,
                                                   int svId,
                                                   const std::map<std::string, double>& signalPowerOffsetDict)
  {
  ...
  static GetManualPowerOffsetForSVResultPtr create(CommandBasePtr relatedCommand,
                                                   const std::string& system,
                                                   int svId,
                                                   const std::map<std::string, double>& signalPowerOffsetDict)
  {
