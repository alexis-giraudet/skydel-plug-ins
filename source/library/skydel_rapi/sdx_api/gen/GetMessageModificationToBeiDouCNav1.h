...
public:
  ...
  GetMessageModificationToBeiDouCNav1() : CommandBase(CmdName, TargetId) {}

  GetMessageModificationToBeiDouCNav1(const std::string& id) : CommandBase(CmdName, TargetId) { setId(id); }
