...
{
public:
  inline static const char* const CmdName = "GetMessageModificationToBeiDouCNav1Result";
  ...
  GetMessageModificationToBeiDouCNav1Result() : CommandResult(CmdName, TargetId) {}

  GetMessageModificationToBeiDouCNav1Result(const std::vector<std::string>& signalArray,
                                            int svId,
                                            int startTime,
                                            int stopTime,
                                            int page,
  ...
  GetMessageModificationToBeiDouCNav1Result(CommandBasePtr relatedCommand,
  ...
  static GetMessageModificationToBeiDouCNav1ResultPtr create(const std::vector<std::string>& signalArray,
                                                             int svId,
                                                             int startTime,
                                                             int stopTime,
                                                             int page,
                                                             ...
                                                             const std::string& id)
  {
    return std::make_shared<GetMessageModificationToBeiDouCNav1Result>(signalArray,
                                                                       svId,
                                                                       startTime,
                                                                       stopTime,
                                                                       page,
  ...
  static GetMessageModificationToBeiDouCNav1ResultPtr create(CommandBasePtr relatedCommand,
                                                             const std::vector<std::string>& signalArray,
                                                             int svId,
                                                             int startTime,
                                                             int stopTime,
                                                             ...
                                                             const std::string& id)
  {
    return std::make_shared<GetMessageModificationToBeiDouCNav1Result>(relatedCommand,
                                                                       signalArray,
                                                                       svId,
                                                                       startTime,
                                                                       stopTime,
...
REGISTER_COMMAND_TO_FACTORY(GetMessageModificationToBeiDouCNav1Result);
} // namespace Cmd
} // namespace Sdx
