...
public:
  ...
  GetMessageModificationToBeiDouCNav2() : CommandBase(CmdName, TargetId) {}

  GetMessageModificationToBeiDouCNav2(const std::string& id) : CommandBase(CmdName, TargetId) { setId(id); }
