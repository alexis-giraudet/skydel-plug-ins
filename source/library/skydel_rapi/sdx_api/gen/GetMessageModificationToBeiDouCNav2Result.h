...
{
public:
  inline static const char* const CmdName = "GetMessageModificationToBeiDouCNav2Result";
  ...
  GetMessageModificationToBeiDouCNav2Result() : CommandResult(CmdName, TargetId) {}

  GetMessageModificationToBeiDouCNav2Result(const std::vector<std::string>& signalArray,
                                            int svId,
                                            int startTime,
                                            int stopTime,
                                            int messageType,
  ...
  GetMessageModificationToBeiDouCNav2Result(CommandBasePtr relatedCommand,
  ...
  static GetMessageModificationToBeiDouCNav2ResultPtr create(const std::vector<std::string>& signalArray,
                                                             int svId,
                                                             int startTime,
                                                             int stopTime,
                                                             int messageType,
                                                             ...
                                                             const std::string& id)
  {
    return std::make_shared<GetMessageModificationToBeiDouCNav2Result>(signalArray,
                                                                       svId,
                                                                       startTime,
                                                                       stopTime,
                                                                       messageType,
  ...
  static GetMessageModificationToBeiDouCNav2ResultPtr create(CommandBasePtr relatedCommand,
                                                             const std::vector<std::string>& signalArray,
                                                             int svId,
                                                             int startTime,
                                                             int stopTime,
                                                             ...
                                                             const std::string& id)
  {
    return std::make_shared<GetMessageModificationToBeiDouCNav2Result>(relatedCommand,
                                                                       signalArray,
                                                                       svId,
                                                                       startTime,
                                                                       stopTime,
...
REGISTER_COMMAND_TO_FACTORY(GetMessageModificationToBeiDouCNav2Result);
} // namespace Cmd
} // namespace Sdx
