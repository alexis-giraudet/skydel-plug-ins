...
public:
  ...
  GetMessageModificationToBeiDouD2Nav() : CommandBase(CmdName, TargetId) {}

  GetMessageModificationToBeiDouD2Nav(const std::string& id) : CommandBase(CmdName, TargetId) { setId(id); }
