...
{
public:
  inline static const char* const CmdName = "GetMessageModificationToBeiDouD2NavResult";
  ...
  GetMessageModificationToBeiDouD2NavResult() : CommandResult(CmdName, TargetId) {}

  GetMessageModificationToBeiDouD2NavResult(const std::vector<std::string>& signalArray,
                                            int svId,
                                            int startTime,
                                            int stopTime,
                                            int subframe,
  ...
  GetMessageModificationToBeiDouD2NavResult(CommandBasePtr relatedCommand,
  ...
  static GetMessageModificationToBeiDouD2NavResultPtr create(const std::vector<std::string>& signalArray,
                                                             int svId,
                                                             int startTime,
                                                             int stopTime,
                                                             int subframe,
                                                             ...
                                                             const std::string& id)
  {
    return std::make_shared<GetMessageModificationToBeiDouD2NavResult>(signalArray,
                                                                       svId,
                                                                       startTime,
                                                                       stopTime,
                                                                       subframe,
  ...
  static GetMessageModificationToBeiDouD2NavResultPtr create(CommandBasePtr relatedCommand,
                                                             const std::vector<std::string>& signalArray,
                                                             int svId,
                                                             int startTime,
                                                             int stopTime,
                                                             ...
                                                             const std::string& id)
  {
    return std::make_shared<GetMessageModificationToBeiDouD2NavResult>(relatedCommand,
                                                                       signalArray,
                                                                       svId,
                                                                       startTime,
                                                                       stopTime,
...
REGISTER_COMMAND_TO_FACTORY(GetMessageModificationToBeiDouD2NavResult);
} // namespace Cmd
} // namespace Sdx
