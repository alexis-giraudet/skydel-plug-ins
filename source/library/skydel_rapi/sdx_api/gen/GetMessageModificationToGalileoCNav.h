...
public:
  ...
  GetMessageModificationToGalileoCNav() : CommandBase(CmdName, TargetId) {}

  GetMessageModificationToGalileoCNav(const std::string& id) : CommandBase(CmdName, TargetId) { setId(id); }
