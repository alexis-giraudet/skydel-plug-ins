...
public:
  ...
  GetMessageModificationToGalileoFNav() : CommandBase(CmdName, TargetId) {}

  GetMessageModificationToGalileoFNav(const std::string& id) : CommandBase(CmdName, TargetId) { setId(id); }
