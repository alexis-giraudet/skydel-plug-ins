...
/// ---------------- ------------
/// --------------------------------------------------------------------------------------------- SignalArray      array
/// string Array of signals to apply the message modification to, accepts "E1" and "E5b" (empty for all) SvId int The
/// satellite's SV ID 1..36 (use 0 to apply modification to all SVs) StartTime        int          Elapsed time in
/// seconds since start of simulation StopTime         int          Elapsed time in seconds since start of simulation
/// (use 0 for no stop time) Subframe         int          Subframe 1..24 (use 0 to apply modification to all subframes)
...
{
public:
  inline static const char* const CmdName = "GetMessageModificationToGalileoINavResult";
  ...
  GetMessageModificationToGalileoINavResult() : CommandResult(CmdName, TargetId) {}

  GetMessageModificationToGalileoINavResult(const std::vector<std::string>& signalArray,
                                            int svId,
                                            int startTime,
                                            int stopTime,
                                            int subframe,
  ...
  GetMessageModificationToGalileoINavResult(CommandBasePtr relatedCommand,
  ...
  static GetMessageModificationToGalileoINavResultPtr create(const std::vector<std::string>& signalArray,
                                                             int svId,
                                                             int startTime,
                                                             int stopTime,
                                                             int subframe,
                                                             ...
                                                             const std::string& id)
  {
    return std::make_shared<GetMessageModificationToGalileoINavResult>(signalArray,
                                                                       svId,
                                                                       startTime,
                                                                       stopTime,
                                                                       subframe,
  ...
  static GetMessageModificationToGalileoINavResultPtr create(CommandBasePtr relatedCommand,
                                                             const std::vector<std::string>& signalArray,
                                                             int svId,
                                                             int startTime,
                                                             int stopTime,
                                                             ...
                                                             const std::string& id)
  {
    return std::make_shared<GetMessageModificationToGalileoINavResult>(relatedCommand,
                                                                       signalArray,
                                                                       svId,
                                                                       startTime,
                                                                       stopTime,
...
REGISTER_COMMAND_TO_FACTORY(GetMessageModificationToGalileoINavResult);
} // namespace Cmd
} // namespace Sdx
