...
public:
  ...
  GetMessageModificationToGlonassNav() : CommandBase(CmdName, TargetId) {}

  GetMessageModificationToGlonassNav(const std::string& id) : CommandBase(CmdName, TargetId) { setId(id); }
