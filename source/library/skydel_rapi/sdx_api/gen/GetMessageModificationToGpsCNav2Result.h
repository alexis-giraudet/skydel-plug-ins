...
public:
  ...
  GetMessageModificationToGpsCNav2Result() : CommandResult(CmdName, TargetId) {}

  GetMessageModificationToGpsCNav2Result(const std::vector<std::string>& signalArray,
                                         int svId,
                                         int startTime,
                                         int stopTime,
                                         int page,
  ...
  GetMessageModificationToGpsCNav2Result(CommandBasePtr relatedCommand,
  ...
  static GetMessageModificationToGpsCNav2ResultPtr create(const std::vector<std::string>& signalArray,
                                                          int svId,
                                                          int startTime,
                                                          int stopTime,
                                                          int page,
                                                          ...
                                                          const std::string& id)
  {
    return std::make_shared<GetMessageModificationToGpsCNav2Result>(signalArray,
                                                                    svId,
                                                                    startTime,
                                                                    stopTime,
                                                                    page,
  ...
  static GetMessageModificationToGpsCNav2ResultPtr create(CommandBasePtr relatedCommand,
                                                          const std::vector<std::string>& signalArray,
                                                          int svId,
                                                          int startTime,
                                                          int stopTime,
                                                          ...
                                                          const std::string& id)
  {
    return std::make_shared<GetMessageModificationToGpsCNav2Result>(relatedCommand,
                                                                    signalArray,
                                                                    svId,
                                                                    startTime,
                                                                    stopTime,
