...
public:
  ...
  GetMessageModificationToGpsCNavResult() : CommandResult(CmdName, TargetId) {}

  GetMessageModificationToGpsCNavResult(const std::vector<std::string>& signalArray,
                                        int svId,
                                        int startTime,
                                        int stopTime,
                                        int messageType,
  ...
  GetMessageModificationToGpsCNavResult(CommandBasePtr relatedCommand,
  ...
  static GetMessageModificationToGpsCNavResultPtr create(const std::vector<std::string>& signalArray,
                                                         int svId,
                                                         int startTime,
                                                         int stopTime,
                                                         int messageType,
                                                         ...
                                                         const std::string& id)
  {
    return std::make_shared<GetMessageModificationToGpsCNavResult>(signalArray,
                                                                   svId,
                                                                   startTime,
                                                                   stopTime,
                                                                   messageType,
  ...
  static GetMessageModificationToGpsCNavResultPtr create(CommandBasePtr relatedCommand,
                                                         const std::vector<std::string>& signalArray,
                                                         int svId,
                                                         int startTime,
                                                         int stopTime,
                                                         ...
                                                         const std::string& id)
  {
    return std::make_shared<GetMessageModificationToGpsCNavResult>(relatedCommand,
                                                                   signalArray,
                                                                   svId,
                                                                   startTime,
                                                                   stopTime,
