...
public:
  ...
  GetMessageModificationToGpsLNavResult() : CommandResult(CmdName, TargetId) {}

  GetMessageModificationToGpsLNavResult(const std::vector<std::string>& signalArray,
                                        int svId,
                                        int startTime,
                                        int stopTime,
                                        int subframe,
  ...
  GetMessageModificationToGpsLNavResult(CommandBasePtr relatedCommand,
  ...
  static GetMessageModificationToGpsLNavResultPtr create(const std::vector<std::string>& signalArray,
                                                         int svId,
                                                         int startTime,
                                                         int stopTime,
                                                         int subframe,
                                                         ...
                                                         const std::string& id)
  {
    return std::make_shared<GetMessageModificationToGpsLNavResult>(signalArray,
                                                                   svId,
                                                                   startTime,
                                                                   stopTime,
                                                                   subframe,
  ...
  static GetMessageModificationToGpsLNavResultPtr create(CommandBasePtr relatedCommand,
                                                         const std::vector<std::string>& signalArray,
                                                         int svId,
                                                         int startTime,
                                                         int stopTime,
                                                         ...
                                                         const std::string& id)
  {
    return std::make_shared<GetMessageModificationToGpsLNavResult>(relatedCommand,
                                                                   signalArray,
                                                                   svId,
                                                                   startTime,
                                                                   stopTime,
