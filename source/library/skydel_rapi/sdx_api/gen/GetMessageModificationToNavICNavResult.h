...
/// ---------------- ------------
/// -------------------------------------------------------------------------------------------------- SignalArray array
/// string Array of signals to apply the message modification to, accepts "NAVICL5", "NAVICS" (empty for all) SvId int
/// The satellite's SV ID 1..14 (use 0 to apply modification to all SVs) StartTime        int          Elapsed time in
/// seconds since start of simulation StopTime         int          Elapsed time in seconds since start of simulation
/// (use 0 for no stop time) Subframe         int          Subframe 1..4 (use 0 to apply modification to all subframes)
...
{
public:
  inline static const char* const CmdName = "GetMessageModificationToNavICNavResult";
  ...
  GetMessageModificationToNavICNavResult() : CommandResult(CmdName, TargetId) {}

  GetMessageModificationToNavICNavResult(const std::vector<std::string>& signalArray,
                                         int svId,
                                         int startTime,
                                         int stopTime,
                                         int subframe,
  ...
  GetMessageModificationToNavICNavResult(CommandBasePtr relatedCommand,
  ...
  static GetMessageModificationToNavICNavResultPtr create(const std::vector<std::string>& signalArray,
                                                          int svId,
                                                          int startTime,
                                                          int stopTime,
                                                          int subframe,
                                                          ...
                                                          const std::string& id)
  {
    return std::make_shared<GetMessageModificationToNavICNavResult>(signalArray,
                                                                    svId,
                                                                    startTime,
                                                                    stopTime,
                                                                    subframe,
  ...
  static GetMessageModificationToNavICNavResultPtr create(CommandBasePtr relatedCommand,
                                                          const std::vector<std::string>& signalArray,
                                                          int svId,
                                                          int startTime,
                                                          int stopTime,
                                                          ...
                                                          const std::string& id)
  {
    return std::make_shared<GetMessageModificationToNavICNavResult>(relatedCommand,
                                                                    signalArray,
                                                                    svId,
                                                                    startTime,
                                                                    stopTime,
...
REGISTER_COMMAND_TO_FACTORY(GetMessageModificationToNavICNavResult);
} // namespace Cmd
} // namespace Sdx
