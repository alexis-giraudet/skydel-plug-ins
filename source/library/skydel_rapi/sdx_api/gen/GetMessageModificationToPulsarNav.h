...
public:
  ...
  GetMessageModificationToPulsarNav() : CommandBase(CmdName, TargetId) {}

  GetMessageModificationToPulsarNav(const std::string& id) : CommandBase(CmdName, TargetId) { setId(id); }
