...
/// ---------------- ------------
/// ----------------------------------------------------------------------------------------- SignalArray      array
/// string Array of signals to apply the message modification to, accepts "PULSARXL" (empty for all) SvId int The
...
{
public:
  inline static const char* const CmdName = "GetMessageModificationToPulsarNavResult";
  ...
  GetMessageModificationToPulsarNavResult() : CommandResult(CmdName, TargetId) {}

  GetMessageModificationToPulsarNavResult(const std::vector<std::string>& signalArray,
                                          int svId,
                                          int startTime,
                                          int stopTime,
  ...
  GetMessageModificationToPulsarNavResult(CommandBasePtr relatedCommand,
  ...
  static GetMessageModificationToPulsarNavResultPtr create(const std::vector<std::string>& signalArray,
                                                           int svId,
                                                           int startTime,
                                                           int stopTime,
                                                           const std::string& condition,
                                                           ...
                                                           const std::string& id)
  {
    return std::make_shared<GetMessageModificationToPulsarNavResult>(signalArray,
                                                                     svId,
                                                                     startTime,
                                                                     stopTime,
                                                                     condition,
  ...
  static GetMessageModificationToPulsarNavResultPtr create(CommandBasePtr relatedCommand,
                                                           const std::vector<std::string>& signalArray,
                                                           int svId,
                                                           int startTime,
                                                           int stopTime,
                                                           ...
                                                           const std::string& id)
  {
    return std::make_shared<GetMessageModificationToPulsarNavResult>(relatedCommand,
                                                                     signalArray,
                                                                     svId,
                                                                     startTime,
                                                                     stopTime,
...
REGISTER_COMMAND_TO_FACTORY(GetMessageModificationToPulsarNavResult);
} // namespace Cmd
} // namespace Sdx
