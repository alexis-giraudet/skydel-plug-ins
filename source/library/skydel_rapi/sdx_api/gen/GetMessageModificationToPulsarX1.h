...
public:
  ...
  GetMessageModificationToPulsarX1() : CommandBase(CmdName, TargetId) {}

  GetMessageModificationToPulsarX1(const std::string& id) : CommandBase(CmdName, TargetId) { setId(id); }
