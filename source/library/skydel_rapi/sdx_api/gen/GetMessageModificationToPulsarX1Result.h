...
/// ---------------- ------------
/// ----------------------------------------------------------------------------------------- SignalArray      array
/// string Array of signals to apply the message modification to, accepts "PULSARX1" (empty for all) SvId int The
...
/// (use 0 for no stop time) MessageType      int          Message type (use -1 to apply modification to all message
/// types) Condition        string       Optional condition to match message content, ex: "EQUAL(45, 10, 0x3f)"
...
public:
  ...
  GetMessageModificationToPulsarX1Result() : CommandResult(CmdName, TargetId) {}

  GetMessageModificationToPulsarX1Result(const std::vector<std::string>& signalArray,
                                         int svId,
                                         int startTime,
                                         int stopTime,
                                         int messageType,
  ...
  GetMessageModificationToPulsarX1Result(CommandBasePtr relatedCommand,
  ...
  static GetMessageModificationToPulsarX1ResultPtr create(const std::vector<std::string>& signalArray,
                                                          int svId,
                                                          int startTime,
                                                          int stopTime,
                                                          int messageType,
                                                          ...
                                                          const std::string& id)
  {
    return std::make_shared<GetMessageModificationToPulsarX1Result>(signalArray,
                                                                    svId,
                                                                    startTime,
                                                                    stopTime,
                                                                    messageType,
  ...
  static GetMessageModificationToPulsarX1ResultPtr create(CommandBasePtr relatedCommand,
                                                          const std::vector<std::string>& signalArray,
                                                          int svId,
                                                          int startTime,
                                                          int stopTime,
                                                          ...
                                                          const std::string& id)
  {
    return std::make_shared<GetMessageModificationToPulsarX1Result>(relatedCommand,
                                                                    signalArray,
                                                                    svId,
                                                                    startTime,
                                                                    stopTime,
