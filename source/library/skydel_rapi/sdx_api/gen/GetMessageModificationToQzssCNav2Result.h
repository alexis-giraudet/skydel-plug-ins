...
/// ---------------- ------------
/// ---------------------------------------------------------------------------------------- SignalArray      array
/// string Array of signals to apply the message modification to, accepts "QZSSL1C" (empty for all) SvId             int
/// The satellite's SV ID 1..10 (use 0 to apply modification to all SVs) StartTime        int          Elapsed time in
/// seconds since start of simulation StopTime         int          Elapsed time in seconds since start of simulation
/// (use 0 for no stop time) Page             int          CNAV2 page (use -1 to apply modification to all pages)
...
{
public:
  inline static const char* const CmdName = "GetMessageModificationToQzssCNav2Result";
  ...
  GetMessageModificationToQzssCNav2Result() : CommandResult(CmdName, TargetId) {}

  GetMessageModificationToQzssCNav2Result(const std::vector<std::string>& signalArray,
                                          int svId,
                                          int startTime,
                                          int stopTime,
                                          int page,
  ...
  GetMessageModificationToQzssCNav2Result(CommandBasePtr relatedCommand,
  ...
  static GetMessageModificationToQzssCNav2ResultPtr create(const std::vector<std::string>& signalArray,
                                                           int svId,
                                                           int startTime,
                                                           int stopTime,
                                                           int page,
                                                           ...
                                                           const std::string& id)
  {
    return std::make_shared<GetMessageModificationToQzssCNav2Result>(signalArray,
                                                                     svId,
                                                                     startTime,
                                                                     stopTime,
                                                                     page,
  ...
  static GetMessageModificationToQzssCNav2ResultPtr create(CommandBasePtr relatedCommand,
                                                           const std::vector<std::string>& signalArray,
                                                           int svId,
                                                           int startTime,
                                                           int stopTime,
                                                           ...
                                                           const std::string& id)
  {
    return std::make_shared<GetMessageModificationToQzssCNav2Result>(relatedCommand,
                                                                     signalArray,
                                                                     svId,
                                                                     startTime,
                                                                     stopTime,
  ...
  virtual bool isValid() const override
  {
    ...
    return m_values.IsObject() && parse_json<std::vector<std::string>>::is_valid(m_values["SignalArray"]) &&
           ...
           parse_json<int>::is_valid(m_values["StopTime"]) && parse_json<int>::is_valid(m_values["Page"]) &&
...
REGISTER_COMMAND_TO_FACTORY(GetMessageModificationToQzssCNav2Result);
} // namespace Cmd
} // namespace Sdx
