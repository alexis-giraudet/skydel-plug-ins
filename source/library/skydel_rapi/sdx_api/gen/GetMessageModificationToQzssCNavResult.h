...
/// ---------------- ------------
/// ----------------------------------------------------------------------------------------------------- SignalArray
/// array string Array of signals to apply the message modification to, accepts "QZSSL2C" and "QZSSL5" (empty for all)
...
{
public:
  inline static const char* const CmdName = "GetMessageModificationToQzssCNavResult";
  ...
  GetMessageModificationToQzssCNavResult() : CommandResult(CmdName, TargetId) {}

  GetMessageModificationToQzssCNavResult(const std::vector<std::string>& signalArray,
                                         int svId,
                                         int startTime,
                                         int stopTime,
                                         int messageType,
  ...
  GetMessageModificationToQzssCNavResult(CommandBasePtr relatedCommand,
  ...
  static GetMessageModificationToQzssCNavResultPtr create(const std::vector<std::string>& signalArray,
                                                          int svId,
                                                          int startTime,
                                                          int stopTime,
                                                          int messageType,
                                                          ...
                                                          const std::string& id)
  {
    return std::make_shared<GetMessageModificationToQzssCNavResult>(signalArray,
                                                                    svId,
                                                                    startTime,
                                                                    stopTime,
                                                                    messageType,
  ...
  static GetMessageModificationToQzssCNavResultPtr create(CommandBasePtr relatedCommand,
                                                          const std::vector<std::string>& signalArray,
                                                          int svId,
                                                          int startTime,
                                                          int stopTime,
                                                          ...
                                                          const std::string& id)
  {
    return std::make_shared<GetMessageModificationToQzssCNavResult>(relatedCommand,
                                                                    signalArray,
                                                                    svId,
                                                                    startTime,
                                                                    stopTime,
...
REGISTER_COMMAND_TO_FACTORY(GetMessageModificationToQzssCNavResult);
} // namespace Cmd
} // namespace Sdx
