...
{
public:
  inline static const char* const CmdName = "GetMessageModificationToQzssLNav";
  inline static const char* const Documentation = "Get infos about the QZSS LNAV message modification with this ID.\n"
                                                  "\n"
                                                  "Name Type   Description\n"
                                                  "---- ------ ------------------------------\n"
                                                  "Id   string Unique identifier of the event";
  ...
  GetMessageModificationToQzssLNav() : CommandBase(CmdName, TargetId) {}

  GetMessageModificationToQzssLNav(const std::string& id) : CommandBase(CmdName, TargetId) { setId(id); }
...
REGISTER_COMMAND_TO_FACTORY(GetMessageModificationToQzssLNav);
} // namespace Cmd
} // namespace Sdx
