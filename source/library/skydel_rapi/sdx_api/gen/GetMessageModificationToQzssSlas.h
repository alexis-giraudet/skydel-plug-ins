...
public:
  ...
  GetMessageModificationToQzssSlas() : CommandBase(CmdName, TargetId) {}

  GetMessageModificationToQzssSlas(const std::string& id) : CommandBase(CmdName, TargetId) { setId(id); }
