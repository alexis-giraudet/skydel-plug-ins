...
/// ---------------- ------------
/// ---------------------------------------------------------------------------------------- SignalArray      array
/// string Array of signals to apply the message modification to, accepts "QZSSL1S" (empty for all) SvId             int
...
/// (use 0 for no stop time) MessageType      int          SLAS Message type (use -1 to apply modification to all
...
{
public:
  inline static const char* const CmdName = "GetMessageModificationToQzssSlasResult";
  ...
  GetMessageModificationToQzssSlasResult() : CommandResult(CmdName, TargetId) {}

  GetMessageModificationToQzssSlasResult(const std::vector<std::string>& signalArray,
                                         int svId,
                                         int startTime,
                                         int stopTime,
                                         int messageType,
  ...
  GetMessageModificationToQzssSlasResult(CommandBasePtr relatedCommand,
  ...
  static GetMessageModificationToQzssSlasResultPtr create(const std::vector<std::string>& signalArray,
                                                          int svId,
                                                          int startTime,
                                                          int stopTime,
                                                          int messageType,
                                                          ...
                                                          const std::string& id)
  {
    return std::make_shared<GetMessageModificationToQzssSlasResult>(signalArray,
                                                                    svId,
                                                                    startTime,
                                                                    stopTime,
                                                                    messageType,
  ...
  static GetMessageModificationToQzssSlasResultPtr create(CommandBasePtr relatedCommand,
                                                          const std::vector<std::string>& signalArray,
                                                          int svId,
                                                          int startTime,
                                                          int stopTime,
                                                          ...
                                                          const std::string& id)
  {
    return std::make_shared<GetMessageModificationToQzssSlasResult>(relatedCommand,
                                                                    signalArray,
                                                                    svId,
                                                                    startTime,
                                                                    stopTime,
...
REGISTER_COMMAND_TO_FACTORY(GetMessageModificationToQzssSlasResult);
} // namespace Cmd
} // namespace Sdx
