...
/// ---------------- ------------
/// ----------------------------------------------------------------------------------------------------- SignalArray
/// array string Array of signals to apply the message modification to, accepts "SBASL1" and "SBASL5" (empty for all).
...
{
public:
  inline static const char* const CmdName = "GetMessageModificationToSbasNavResult";
  ...
  GetMessageModificationToSbasNavResult() : CommandResult(CmdName, TargetId) {}

  GetMessageModificationToSbasNavResult(const std::vector<std::string>& signalArray,
                                        int svId,
                                        int startTime,
                                        int stopTime,
                                        int messageType,
  ...
  GetMessageModificationToSbasNavResult(CommandBasePtr relatedCommand,
  ...
  static GetMessageModificationToSbasNavResultPtr create(const std::vector<std::string>& signalArray,
                                                         int svId,
                                                         int startTime,
                                                         int stopTime,
                                                         int messageType,
                                                         ...
                                                         const std::string& id)
  {
    return std::make_shared<GetMessageModificationToSbasNavResult>(signalArray,
                                                                   svId,
                                                                   startTime,
                                                                   stopTime,
                                                                   messageType,
  ...
  static GetMessageModificationToSbasNavResultPtr create(CommandBasePtr relatedCommand,
                                                         const std::vector<std::string>& signalArray,
                                                         int svId,
                                                         int startTime,
                                                         int stopTime,
                                                         ...
                                                         const std::string& id)
  {
    return std::make_shared<GetMessageModificationToSbasNavResult>(relatedCommand,
                                                                   signalArray,
                                                                   svId,
                                                                   startTime,
                                                                   stopTime,
...
REGISTER_COMMAND_TO_FACTORY(GetMessageModificationToSbasNavResult);
} // namespace Cmd
} // namespace Sdx
