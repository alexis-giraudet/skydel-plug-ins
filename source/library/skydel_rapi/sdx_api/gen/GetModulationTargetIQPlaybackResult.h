...
public:
  ...
  GetModulationTargetIQPlaybackResult() : CommandResult(CmdName, TargetId) {}

  GetModulationTargetIQPlaybackResult(int output,
  ...
  GetModulationTargetIQPlaybackResult(CommandBasePtr relatedCommand,
                                      int output,
                                      const std::vector<std::string>& files,
                                      int gain,
                                      const std::string& id) :
  ...
  static GetModulationTargetIQPlaybackResultPtr create(int output,
                                                       const std::vector<std::string>& files,
                                                       int gain,
                                                       const std::string& id)
  {
  ...
  static GetModulationTargetIQPlaybackResultPtr create(CommandBasePtr relatedCommand,
                                                       int output,
                                                       const std::vector<std::string>& files,
                                                       int gain,
                                                       const std::string& id)
