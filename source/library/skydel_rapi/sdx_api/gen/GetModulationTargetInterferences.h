...
public:
  ...
  GetModulationTargetInterferences() : CommandBase(CmdName, TargetId) {}

  GetModulationTargetInterferences(int output, const std::string& id) : CommandBase(CmdName, TargetId)
  {
