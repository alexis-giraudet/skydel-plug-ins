...
/// "QZSSL1S", "QZSSL5S", "QZSSL6", "NAVICL1", "NAVICL5", "NAVICS", "PULSARXL", "PULSARX1"
///
...
{
public:
  inline static const char* const CmdName = "GetModulationTargetInterferencesResult";
  ...
  GetModulationTargetInterferencesResult() : CommandResult(CmdName, TargetId) {}

  GetModulationTargetInterferencesResult(int output,
                                         int minRate,
                                         int maxRate,
                                         int group,
                                         double centralFreq,
  ...
  GetModulationTargetInterferencesResult(CommandBasePtr relatedCommand,
                                         int output,
                                         int minRate,
                                         int maxRate,
                                         int group,
  ...
  static GetModulationTargetInterferencesResultPtr create(int output,
                                                          int minRate,
                                                          int maxRate,
                                                          int group,
                                                          double centralFreq,
                                                          ...
                                                          const std::optional<std::string>& signal = {})
  {
    return std::make_shared<GetModulationTargetInterferencesResult>(output,
                                                                    minRate,
                                                                    maxRate,
                                                                    group,
                                                                    centralFreq,
  ...
  static GetModulationTargetInterferencesResultPtr create(CommandBasePtr relatedCommand,
                                                          int output,
                                                          int minRate,
                                                          int maxRate,
                                                          int group,
                                                          ...
                                                          const std::optional<std::string>& signal = {})
  {
    return std::make_shared<GetModulationTargetInterferencesResult>(relatedCommand,
                                                                    output,
                                                                    minRate,
                                                                    maxRate,
                                                                    group,
...
REGISTER_COMMAND_TO_FACTORY(GetModulationTargetInterferencesResult);
} // namespace Cmd
} // namespace Sdx
