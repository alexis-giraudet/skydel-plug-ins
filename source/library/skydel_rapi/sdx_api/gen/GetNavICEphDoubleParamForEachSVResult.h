...
public:
  ...
  GetNavICEphDoubleParamForEachSVResult() : CommandResult(CmdName, TargetId) {}

  GetNavICEphDoubleParamForEachSVResult(const std::string& paramName,
  ...
  GetNavICEphDoubleParamForEachSVResult(CommandBasePtr relatedCommand,
  ...
  static GetNavICEphDoubleParamForEachSVResultPtr create(const std::string& paramName,
                                                         const std::vector<double>& val,
                                                         const std::optional<std::string>& dataSetName = {})
  {
  ...
  static GetNavICEphDoubleParamForEachSVResultPtr create(CommandBasePtr relatedCommand,
                                                         const std::string& paramName,
                                                         const std::vector<double>& val,
                                                         const std::optional<std::string>& dataSetName = {})
  {
