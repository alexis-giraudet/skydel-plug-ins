...
{
///
/// Please note the command GetNavICEphemerisDoubleParam is deprecated since 21.3. You may use
/// GetNavICEphDoubleParamForSV.
///
/// Please note the command GetNavICEphDoubleParamForSV is deprecated since 23.11. You may use
...
/// table above for accepted names) DataSetName optional string Optional name of the data set to use. If no value is
...
{
public:
  inline static const char* const CmdName = "GetNavICEphemerisDoubleParam";
  ...
  inline static const char* const Deprecated =
    "Please note the command GetNavICEphemerisDoubleParam is deprecated since 23.11. You may use GetConstellationParameterForSV.";

  GetNavICEphemerisDoubleParam() : CommandBase(CmdName, TargetId) {}

  GetNavICEphemerisDoubleParam(int svId,
  ...
  static GetNavICEphemerisDoubleParamPtr create(int svId,
                                                const std::string& paramName,
                                                const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(GetNavICEphemerisDoubleParam);
} // namespace Cmd
} // namespace Sdx
