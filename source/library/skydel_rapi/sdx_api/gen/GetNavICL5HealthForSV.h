...
{
public:
  inline static const char* const CmdName = "GetNavICL5HealthForSV";
  ...
  GetNavICL5HealthForSV() : CommandBase(CmdName, TargetId) {}

  GetNavICL5HealthForSV(int svId, const std::optional<std::string>& dataSetName = {}) : CommandBase(CmdName, TargetId)
  {
...
REGISTER_COMMAND_TO_FACTORY(GetNavICL5HealthForSV);
} // namespace Cmd
} // namespace Sdx
