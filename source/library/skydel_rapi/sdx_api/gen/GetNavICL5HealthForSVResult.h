...
{
public:
  inline static const char* const CmdName = "GetNavICL5HealthForSVResult";
  ...
  GetNavICL5HealthForSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetNavICL5HealthForSVResult(CommandBasePtr relatedCommand,
                              int svId,
                              bool health,
  ...
  static GetNavICL5HealthForSVResultPtr create(int svId,
                                               bool health,
                                               const std::optional<std::string>& dataSetName = {})
  {
  ...
  static GetNavICL5HealthForSVResultPtr create(CommandBasePtr relatedCommand,
                                               int svId,
                                               bool health,
                                               const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(GetNavICL5HealthForSVResult);
} // namespace Cmd
} // namespace Sdx
