...
/// ----------- ---------------
/// ------------------------------------------------------------------------------------------- SvId        int
/// Satellite SV ID 1..14, or use 0 to apply new value to all satellites. Health      bool            S health, false =
...
{
public:
  inline static const char* const CmdName = "GetNavICSHealthForSVResult";
  ...
  GetNavICSHealthForSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetNavICSHealthForSVResult(CommandBasePtr relatedCommand,
                             int svId,
                             bool health,
  ...
  static GetNavICSHealthForSVResultPtr create(CommandBasePtr relatedCommand,
                                              int svId,
                                              bool health,
                                              const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(GetNavICSHealthForSVResult);
} // namespace Cmd
} // namespace Sdx
