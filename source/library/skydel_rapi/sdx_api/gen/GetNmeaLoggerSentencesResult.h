...
public:
  ...
  GetNmeaLoggerSentencesResult() : CommandResult(CmdName, TargetId) {}

  GetNmeaLoggerSentencesResult(const std::vector<std::string>& sentences) : CommandResult(CmdName, TargetId)
  {
  ...
  static GetNmeaLoggerSentencesResultPtr create(CommandBasePtr relatedCommand,
