...
public:
  ...
  GetNmeaLoggerSerialPortDelay() : CommandBase(CmdName, TargetId) {}

  static GetNmeaLoggerSerialPortDelayPtr create() { return std::make_shared<GetNmeaLoggerSerialPortDelay>(); }
