...
public:
  ...
  GetNtpServer() : CommandBase(CmdName, TargetId) {}

  static GetNtpServerPtr create() { return std::make_shared<GetNtpServer>(); }

  static GetNtpServerPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetNtpServer>(ptr); }
