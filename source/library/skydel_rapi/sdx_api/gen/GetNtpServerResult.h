...
public:
  ...
  GetNtpServerResult() : CommandResult(CmdName, TargetId) {}

  GetNtpServerResult(const std::string& address, const std::optional<int>& port = {}) : CommandResult(CmdName, TargetId)
  {
  ...
  static GetNtpServerResultPtr create(CommandBasePtr relatedCommand,
