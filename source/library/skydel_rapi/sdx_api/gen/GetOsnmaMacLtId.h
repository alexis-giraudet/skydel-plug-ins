...
public:
  ...
  GetOsnmaMacLtId() : CommandBase(CmdName, TargetId) {}

  static GetOsnmaMacLtIdPtr create() { return std::make_shared<GetOsnmaMacLtId>(); }

  static GetOsnmaMacLtIdPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetOsnmaMacLtId>(ptr); }
