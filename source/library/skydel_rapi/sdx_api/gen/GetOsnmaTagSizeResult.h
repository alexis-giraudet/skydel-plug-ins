...
public:
  ...
  GetOsnmaTagSizeResult() : CommandResult(CmdName, TargetId) {}

  GetOsnmaTagSizeResult(int tagSize) : CommandResult(CmdName, TargetId) { setTagSize(tagSize); }

  GetOsnmaTagSizeResult(CommandBasePtr relatedCommand, int tagSize) : CommandResult(CmdName, TargetId, relatedCommand)
  {

    setTagSize(tagSize);
  }

  static GetOsnmaTagSizeResultPtr create(int tagSize) { return std::make_shared<GetOsnmaTagSizeResult>(tagSize); }
  ...
  virtual bool isValid() const override
  {
    ...
    return m_values.IsObject() && parse_json<int>::is_valid(m_values["TagSize"]);
  }
  ...
  int tagSize() const { return parse_json<int>::parse(m_values["TagSize"]); }
