...
public:
  ...
  GetPowerSbasOffsetResult() : CommandResult(CmdName, TargetId) {}

  GetPowerSbasOffsetResult(const std::string& serviceProvider, double offset) : CommandResult(CmdName, TargetId)
  {
  ...
  static GetPowerSbasOffsetResultPtr create(CommandBasePtr relatedCommand,
