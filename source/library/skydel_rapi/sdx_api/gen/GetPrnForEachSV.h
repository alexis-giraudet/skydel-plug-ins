...
public:
  ...
  GetPrnForEachSV() : CommandBase(CmdName, TargetId) {}

  GetPrnForEachSV(const std::string& signal) : CommandBase(CmdName, TargetId) { setSignal(signal); }

  static GetPrnForEachSVPtr create(const std::string& signal) { return std::make_shared<GetPrnForEachSV>(signal); }

  static GetPrnForEachSVPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetPrnForEachSV>(ptr); }
