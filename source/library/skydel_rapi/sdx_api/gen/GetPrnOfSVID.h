...
/// "NAVICL1", "NAVICL5", "NAVICS", "PULSARXL", "PULSARX1", "PULSARX5" SvId   int    Satellite SV ID.
///
...
public:
  ...
  GetPrnOfSVID() : CommandBase(CmdName, TargetId) {}

  GetPrnOfSVID(const std::string& signal, int svId) : CommandBase(CmdName, TargetId)
  {
  ...
  static GetPrnOfSVIDPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetPrnOfSVID>(ptr); }
