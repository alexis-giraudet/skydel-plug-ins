...
/// "NAVICL1", "NAVICL5", "NAVICS", "PULSARXL", "PULSARX1" SvId   int    Satellite SV ID. Prn    int    PRN number.
///
...
{
public:
  inline static const char* const CmdName = "GetPrnOfSVIDResult";
  ...
  GetPrnOfSVIDResult() : CommandResult(CmdName, TargetId) {}

  GetPrnOfSVIDResult(const std::string& signal, int svId, int prn) : CommandResult(CmdName, TargetId)
  {
...
REGISTER_COMMAND_TO_FACTORY(GetPrnOfSVIDResult);
} // namespace Cmd
} // namespace Sdx
