...
public:
  ...
  GetPropagationModelParameters() : CommandBase(CmdName, TargetId) {}
  ...
  static GetPropagationModelParametersPtr create(const Sdx::PropagationModelType& model,
                                                 const std::vector<std::string>& paramArray)
  {
