...
public:
  ...
  GetPropagationModelParametersResult() : CommandResult(CmdName, TargetId) {}

  GetPropagationModelParametersResult(const Sdx::PropagationModelType& model,
  ...
  GetPropagationModelParametersResult(CommandBasePtr relatedCommand,
                                      const Sdx::PropagationModelType& model,
                                      const std::map<std::string, double>& paramValueDict) :
  ...
  static GetPropagationModelParametersResultPtr create(const Sdx::PropagationModelType& model,
                                                       const std::map<std::string, double>& paramValueDict)
  {
    return std::make_shared<GetPropagationModelParametersResult>(model, paramValueDict);
  }

  static GetPropagationModelParametersResultPtr create(CommandBasePtr relatedCommand,
                                                       const Sdx::PropagationModelType& model,
                                                       const std::map<std::string, double>& paramValueDict)
  {
