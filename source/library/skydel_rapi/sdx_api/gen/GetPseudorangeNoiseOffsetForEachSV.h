...
public:
  ...
  GetPseudorangeNoiseOffsetForEachSV() : CommandBase(CmdName, TargetId) {}

  GetPseudorangeNoiseOffsetForEachSV(const std::string& system) : CommandBase(CmdName, TargetId) { setSystem(system); }
