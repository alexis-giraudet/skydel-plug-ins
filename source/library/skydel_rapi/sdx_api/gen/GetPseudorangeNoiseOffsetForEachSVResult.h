...
public:
  ...
  GetPseudorangeNoiseOffsetForEachSVResult() : CommandResult(CmdName, TargetId) {}

  GetPseudorangeNoiseOffsetForEachSVResult(const std::string& system,
  ...
  GetPseudorangeNoiseOffsetForEachSVResult(CommandBasePtr relatedCommand,
  ...
  static GetPseudorangeNoiseOffsetForEachSVResultPtr create(const std::string& system,
                                                            const std::vector<bool>& enabled,
                                                            const std::vector<double>& offset)
  {
  ...
  static GetPseudorangeNoiseOffsetForEachSVResultPtr create(CommandBasePtr relatedCommand,
                                                            const std::string& system,
                                                            const std::vector<bool>& enabled,
                                                            const std::vector<double>& offset)
  {
