...
public:
  ...
  GetPseudorangeNoiseOffsetForSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetPseudorangeNoiseOffsetForSVResult(CommandBasePtr relatedCommand,
  ...
  static GetPseudorangeNoiseOffsetForSVResultPtr create(const std::string& system,
                                                        int svId,
                                                        bool enabled,
                                                        double offset)
  {
  ...
  static GetPseudorangeNoiseOffsetForSVResultPtr create(CommandBasePtr relatedCommand,
                                                        const std::string& system,
                                                        int svId,
                                                        bool enabled,
                                                        double offset)
