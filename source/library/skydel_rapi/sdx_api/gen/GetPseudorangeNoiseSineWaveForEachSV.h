...
public:
  ...
  GetPseudorangeNoiseSineWaveForEachSV() : CommandBase(CmdName, TargetId) {}

  GetPseudorangeNoiseSineWaveForEachSV(const std::string& system, int sineWave) : CommandBase(CmdName, TargetId)
  {
