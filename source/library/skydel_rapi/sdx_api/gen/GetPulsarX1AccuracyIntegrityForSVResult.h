...
/// Health      bool            X1 accuracy integrity, false = User Range Error exceeds alarm threshold, true = User
...
public:
  ...
  GetPulsarX1AccuracyIntegrityForSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetPulsarX1AccuracyIntegrityForSVResult(CommandBasePtr relatedCommand,
                                          int svId,
                                          bool health,
  ...
  static GetPulsarX1AccuracyIntegrityForSVResultPtr create(int svId,
                                                           bool health,
                                                           const std::optional<std::string>& dataSetName = {})
  {
  ...
  static GetPulsarX1AccuracyIntegrityForSVResultPtr create(CommandBasePtr relatedCommand,
                                                           int svId,
                                                           bool health,
                                                           const std::optional<std::string>& dataSetName = {})
  {
