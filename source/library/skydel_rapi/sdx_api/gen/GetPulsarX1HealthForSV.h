...
{
public:
  inline static const char* const CmdName = "GetPulsarX1HealthForSV";
  ...
  GetPulsarX1HealthForSV() : CommandBase(CmdName, TargetId) {}

  GetPulsarX1HealthForSV(int svId, const std::optional<std::string>& dataSetName = {}) : CommandBase(CmdName, TargetId)
  {
...
REGISTER_COMMAND_TO_FACTORY(GetPulsarX1HealthForSV);
} // namespace Cmd
} // namespace Sdx
