...
{
public:
  inline static const char* const CmdName = "GetPulsarX5AccuracyIntegrityForSVResult";
  ...
  GetPulsarX5AccuracyIntegrityForSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetPulsarX5AccuracyIntegrityForSVResult(CommandBasePtr relatedCommand,
                                          int svId,
                                          bool health,
  ...
  static GetPulsarX5AccuracyIntegrityForSVResultPtr create(int svId,
                                                           bool health,
                                                           const std::optional<std::string>& dataSetName = {})
  {
  ...
  static GetPulsarX5AccuracyIntegrityForSVResultPtr create(CommandBasePtr relatedCommand,
                                                           int svId,
                                                           bool health,
                                                           const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(GetPulsarX5AccuracyIntegrityForSVResult);
} // namespace Cmd
} // namespace Sdx
