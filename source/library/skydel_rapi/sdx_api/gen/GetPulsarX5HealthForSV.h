...
public:
  ...
  GetPulsarX5HealthForSV() : CommandBase(CmdName, TargetId) {}

  GetPulsarX5HealthForSV(int svId, const std::optional<std::string>& dataSetName = {}) : CommandBase(CmdName, TargetId)
  {
