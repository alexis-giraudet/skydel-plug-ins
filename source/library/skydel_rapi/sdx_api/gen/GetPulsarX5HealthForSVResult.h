...
public:
  ...
  GetPulsarX5HealthForSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetPulsarX5HealthForSVResult(CommandBasePtr relatedCommand,
                               int svId,
                               bool health,
  ...
  static GetPulsarX5HealthForSVResultPtr create(int svId,
                                                bool health,
                                                const std::optional<std::string>& dataSetName = {})
  {
  ...
  static GetPulsarX5HealthForSVResultPtr create(CommandBasePtr relatedCommand,
                                                int svId,
                                                bool health,
                                                const std::optional<std::string>& dataSetName = {})
  {
