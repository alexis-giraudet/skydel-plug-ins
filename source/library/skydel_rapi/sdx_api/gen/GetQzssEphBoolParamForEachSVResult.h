...
public:
  ...
  GetQzssEphBoolParamForEachSVResult() : CommandResult(CmdName, TargetId) {}

  GetQzssEphBoolParamForEachSVResult(const std::string& paramName,
  ...
  GetQzssEphBoolParamForEachSVResult(CommandBasePtr relatedCommand,
  ...
  static GetQzssEphBoolParamForEachSVResultPtr create(const std::string& paramName,
                                                      const std::vector<bool>& val,
                                                      const std::optional<std::string>& dataSetName = {})
  {
  ...
  static GetQzssEphBoolParamForEachSVResultPtr create(CommandBasePtr relatedCommand,
                                                      const std::string& paramName,
                                                      const std::vector<bool>& val,
                                                      const std::optional<std::string>& dataSetName = {})
  {
