...
///
/// Please note the command GetQzssEphBoolParamForSV is deprecated since 23.11. You may use
...
/// ----------- ---------------
/// ------------------------------------------------------------------------------------------- SvId        int
/// Satellite SV ID 1..10, or use 0 to apply new value to all satellites ParamName   string          Parameter name (see
...
{
public:
  inline static const char* const CmdName = "GetQzssEphemerisBoolParam";
  ...
  inline static const char* const Deprecated =
    "Please note the command GetQzssEphemerisBoolParam is deprecated since 23.11. You may use GetConstellationParameterForSV.";

  GetQzssEphemerisBoolParam() : CommandBase(CmdName, TargetId) {}

  GetQzssEphemerisBoolParam(int svId,
  ...
  static GetQzssEphemerisBoolParamPtr create(int svId,
                                             const std::string& paramName,
                                             const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(GetQzssEphemerisBoolParam);
} // namespace Cmd
} // namespace Sdx
