...
{
///
/// Please note the command GetQzssEphemerisDoubleParam is deprecated since 21.3. You may use
...
{
public:
  inline static const char* const CmdName = "GetQzssEphemerisDoubleParam";
  ...
  inline static const char* const Deprecated =
    "Please note the command GetQzssEphemerisDoubleParam is deprecated since 23.11. You may use GetConstellationParameterForSV.";

  GetQzssEphemerisDoubleParam() : CommandBase(CmdName, TargetId) {}

  GetQzssEphemerisDoubleParam(int svId,
  ...
  static GetQzssEphemerisDoubleParamPtr create(int svId,
                                               const std::string& paramName,
                                               const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(GetQzssEphemerisDoubleParam);
} // namespace Cmd
} // namespace Sdx
