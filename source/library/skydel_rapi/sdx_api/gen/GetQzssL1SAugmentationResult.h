...
public:
  ...
  GetQzssL1SAugmentationResult() : CommandResult(CmdName, TargetId) {}

  GetQzssL1SAugmentationResult(const std::string& system,
                               int prn,
                               bool augmentIOD,
                               bool augmentPRC,
                               double prc,
  ...
  GetQzssL1SAugmentationResult(CommandBasePtr relatedCommand,
  ...
  static GetQzssL1SAugmentationResultPtr create(const std::string& system,
                                                int prn,
                                                bool augmentIOD,
                                                bool augmentPRC,
                                                double prc,
  ...
  static GetQzssL1SAugmentationResultPtr create(CommandBasePtr relatedCommand,
                                                const std::string& system,
                                                int prn,
                                                bool augmentIOD,
                                                bool augmentPRC,
