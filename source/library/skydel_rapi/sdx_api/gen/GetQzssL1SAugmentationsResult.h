...
public:
  ...
  GetQzssL1SAugmentationsResult() : CommandResult(CmdName, TargetId) {}

  GetQzssL1SAugmentationsResult(const std::vector<std::string>& ids) : CommandResult(CmdName, TargetId) { setIds(ids); }
