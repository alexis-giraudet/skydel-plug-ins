...
{
public:
  inline static const char* const CmdName = "GetQzssL1cHealthForSV";
  ...
  GetQzssL1cHealthForSV() : CommandBase(CmdName, TargetId) {}

  GetQzssL1cHealthForSV(int svId, const std::optional<std::string>& dataSetName = {}) : CommandBase(CmdName, TargetId)
  {
...
REGISTER_COMMAND_TO_FACTORY(GetQzssL1cHealthForSV);
} // namespace Cmd
} // namespace Sdx
