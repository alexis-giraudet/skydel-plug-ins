...
{
public:
  inline static const char* const CmdName = "GetQzssL2HealthForSV";
  ...
  GetQzssL2HealthForSV() : CommandBase(CmdName, TargetId) {}

  GetQzssL2HealthForSV(int svId, const std::optional<std::string>& dataSetName = {}) : CommandBase(CmdName, TargetId)
  {
...
REGISTER_COMMAND_TO_FACTORY(GetQzssL2HealthForSV);
} // namespace Cmd
} // namespace Sdx
