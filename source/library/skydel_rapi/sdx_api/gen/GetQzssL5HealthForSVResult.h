...
{
public:
  inline static const char* const CmdName = "GetQzssL5HealthForSVResult";
  ...
  GetQzssL5HealthForSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetQzssL5HealthForSVResult(CommandBasePtr relatedCommand,
                             int svId,
                             bool health,
  ...
  static GetQzssL5HealthForSVResultPtr create(CommandBasePtr relatedCommand,
                                              int svId,
                                              bool health,
                                              const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(GetQzssL5HealthForSVResult);
} // namespace Cmd
} // namespace Sdx
