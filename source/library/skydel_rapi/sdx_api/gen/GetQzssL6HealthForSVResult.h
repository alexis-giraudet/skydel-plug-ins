...
/// ----------- ---------------
/// ------------------------------------------------------------------------------------------- SvId        int
/// Satellite SV ID 1..10, or use 0 to apply new value to all satellites. Health      bool            L6 health, false =
...
{
public:
  inline static const char* const CmdName = "GetQzssL6HealthForSVResult";
  ...
  GetQzssL6HealthForSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetQzssL6HealthForSVResult(CommandBasePtr relatedCommand,
                             int svId,
                             bool health,
  ...
  static GetQzssL6HealthForSVResultPtr create(CommandBasePtr relatedCommand,
                                              int svId,
                                              bool health,
                                              const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(GetQzssL6HealthForSVResult);
} // namespace Cmd
} // namespace Sdx
