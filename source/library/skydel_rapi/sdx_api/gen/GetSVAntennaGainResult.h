...
/// dimension to azimuth [0, 360[. Type   AntennaPatternType Pattern type Band   GNSSBand           Frequency band
...
public:
  ...
  GetSVAntennaGainResult() : CommandResult(CmdName, TargetId) {}

  GetSVAntennaGainResult(const std::vector<std::vector<double>>& gain,
  ...
  GetSVAntennaGainResult(CommandBasePtr relatedCommand,
  ...
  static GetSVAntennaGainResultPtr create(const std::vector<std::vector<double>>& gain,
                                          const Sdx::AntennaPatternType& type,
                                          const Sdx::GNSSBand& band,
                                          const std::string& system,
                                          const std::optional<std::string>& name = {})
  ...
  static GetSVAntennaGainResultPtr create(CommandBasePtr relatedCommand,
                                          const std::vector<std::vector<double>>& gain,
                                          const Sdx::AntennaPatternType& type,
                                          const Sdx::GNSSBand& band,
                                          const std::string& system,
