...
public:
  ...
  GetSVAntennaModelForSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetSVAntennaModelForSVResult(CommandBasePtr relatedCommand,
  ...
  static GetSVAntennaModelForSVResultPtr create(const std::string& system,
                                                int svId,
                                                const std::string& antennaModelName)
  {
  ...
  static GetSVAntennaModelForSVResultPtr create(CommandBasePtr relatedCommand,
                                                const std::string& system,
                                                int svId,
                                                const std::string& antennaModelName)
  {
