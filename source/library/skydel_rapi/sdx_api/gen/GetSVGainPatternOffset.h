...
public:
  ...
  GetSVGainPatternOffset() : CommandBase(CmdName, TargetId) {}

  GetSVGainPatternOffset(const Sdx::GNSSBand& band,
  ...
  static GetSVGainPatternOffsetPtr create(const Sdx::GNSSBand& band,
                                          const std::string& system,
                                          const std::optional<std::string>& antennaName = {})
  {
