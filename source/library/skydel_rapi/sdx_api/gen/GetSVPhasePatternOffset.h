...
{
public:
  inline static const char* const CmdName = "GetSVPhasePatternOffset";
  ...
  GetSVPhasePatternOffset() : CommandBase(CmdName, TargetId) {}

  GetSVPhasePatternOffset(const Sdx::GNSSBand& band,
  ...
  static GetSVPhasePatternOffsetPtr create(const Sdx::GNSSBand& band,
                                           const std::string& system,
                                           const std::optional<std::string>& antennaName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(GetSVPhasePatternOffset);
} // namespace Cmd
} // namespace Sdx
