...
{
public:
  inline static const char* const CmdName = "GetSVPhasePatternOffsetResult";
  ...
  GetSVPhasePatternOffsetResult() : CommandResult(CmdName, TargetId) {}

  GetSVPhasePatternOffsetResult(const Sdx::GNSSBand& band,
  ...
  GetSVPhasePatternOffsetResult(CommandBasePtr relatedCommand,
  ...
  static GetSVPhasePatternOffsetResultPtr create(const Sdx::GNSSBand& band,
                                                 const std::string& system,
                                                 double offset,
                                                 const std::optional<std::string>& antennaName = {})
  {
  ...
  static GetSVPhasePatternOffsetResultPtr create(CommandBasePtr relatedCommand,
                                                 const Sdx::GNSSBand& band,
                                                 const std::string& system,
                                                 double offset,
                                                 const std::optional<std::string>& antennaName = {})
...
REGISTER_COMMAND_TO_FACTORY(GetSVPhasePatternOffsetResult);
} // namespace Cmd
} // namespace Sdx
