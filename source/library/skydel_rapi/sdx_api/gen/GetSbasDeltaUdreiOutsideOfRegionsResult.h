...
public:
  ...
  GetSbasDeltaUdreiOutsideOfRegionsResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetSbasDeltaUdreiOutsideOfRegionsResult(CommandBasePtr relatedCommand,
  ...
  static GetSbasDeltaUdreiOutsideOfRegionsResultPtr create(CommandBasePtr relatedCommand,
                                                           const std::string& serviceProvider,
                                                           int deltaUdrei)
  {
