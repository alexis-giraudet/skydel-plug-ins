...
public:
  ...
  GetSbasEphParamsForSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetSbasEphParamsForSVResult(CommandBasePtr relatedCommand,
                              int svId,
  ...
  static GetSbasEphParamsForSVResultPtr create(CommandBasePtr relatedCommand,
                                               int svId,
                                               const std::map<std::string, double>& paramValueDict)
  {
