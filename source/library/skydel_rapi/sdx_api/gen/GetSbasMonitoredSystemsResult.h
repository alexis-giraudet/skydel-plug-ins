...
public:
  ...
  GetSbasMonitoredSystemsResult() : CommandResult(CmdName, TargetId) {}

  GetSbasMonitoredSystemsResult(const std::vector<std::string>& systems) : CommandResult(CmdName, TargetId)
  {
