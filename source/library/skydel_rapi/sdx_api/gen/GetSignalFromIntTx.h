...
{
///
/// Get all signal ID from this interference transmitters and this signal type. If the signal type is invalid, get the
/// IDs of CW type.
///
...
public:
  ...
  GetSignalFromIntTx() : CommandBase(CmdName, TargetId) {}

  GetSignalFromIntTx(const std::string& idTransmitter, const std::string& signalType) : CommandBase(CmdName, TargetId)
  {
