...
public:
  ...
  GetSpoofTxAntenna() : CommandBase(CmdName, TargetId) {}

  GetSpoofTxAntenna(const std::string& id) : CommandBase(CmdName, TargetId) { setId(id); }

  static GetSpoofTxAntennaPtr create(const std::string& id) { return std::make_shared<GetSpoofTxAntenna>(id); }
