...
{
public:
  inline static const char* const CmdName = "GetSpoofTxAntennaOffsetResult";
  inline static const char* const Documentation = "Result of GetSpoofTxAntennaOffset.\n"
                                                  "\n"
                                                  "Name  Type   Description\n"
                                                  "----- ------ --------------------------------------\n"
                                                  "X     double Antenna X offset in the body frame\n"
  ...
  GetSpoofTxAntennaOffsetResult() : CommandResult(CmdName, TargetId) {}

  GetSpoofTxAntennaOffsetResult(double x,
                                double y,
                                double z,
                                double yaw,
                                double pitch,
  ...
  GetSpoofTxAntennaOffsetResult(CommandBasePtr relatedCommand,
                                double x,
                                double y,
                                double z,
                                double yaw,
  ...
  static GetSpoofTxAntennaOffsetResultPtr
  ...
  static GetSpoofTxAntennaOffsetResultPtr create(CommandBasePtr relatedCommand,
                                                 double x,
                                                 double y,
                                                 double z,
                                                 double yaw,
...
REGISTER_COMMAND_TO_FACTORY(GetSpoofTxAntennaOffsetResult);
} // namespace Cmd
} // namespace Sdx
