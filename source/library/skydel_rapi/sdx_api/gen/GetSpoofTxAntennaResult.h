...
public:
  ...
  GetSpoofTxAntennaResult() : CommandResult(CmdName, TargetId) {}

  GetSpoofTxAntennaResult(const std::vector<std::vector<double>>& gain,
  ...
  GetSpoofTxAntennaResult(CommandBasePtr relatedCommand,
  ...
  static GetSpoofTxAntennaResultPtr create(const std::vector<std::vector<double>>& gain,
                                           const Sdx::AntennaPatternType& type,
                                           const std::string& id)
  {
  ...
  static GetSpoofTxAntennaResultPtr create(CommandBasePtr relatedCommand,
                                           const std::vector<std::vector<double>>& gain,
                                           const Sdx::AntennaPatternType& type,
                                           const std::string& id)
  {
