...
{
public:
  inline static const char* const CmdName = "GetSpoofTxCircularResult";
  inline static const char* const Documentation = "Result of GetSpoofTxCircular.\n"
                                                  "\n"
                                                  "Name        Type            Description\n"
                                                  "----------- --------------- --------------------------------\n"
                                                  "Lat         double          Center latitude (rad)\n"
  ...
  GetSpoofTxCircularResult() : CommandResult(CmdName, TargetId) {}

  GetSpoofTxCircularResult(double lat,
                           double lon,
                           double alt,
                           double radius,
                           double speed,
  ...
  GetSpoofTxCircularResult(CommandBasePtr relatedCommand,
                           double lat,
                           double lon,
                           double alt,
                           double radius,
  ...
  static GetSpoofTxCircularResultPtr create(double lat,
                                            double lon,
                                            double alt,
                                            double radius,
                                            double speed,
  ...
  static GetSpoofTxCircularResultPtr create(CommandBasePtr relatedCommand,
                                            double lat,
                                            double lon,
                                            double alt,
                                            double radius,
                                            ...
                                            const std::optional<double>& originAngle = {})
  {
    return std::make_shared<GetSpoofTxCircularResult>(relatedCommand,
                                                      lat,
                                                      lon,
                                                      alt,
                                                      radius,
...
REGISTER_COMMAND_TO_FACTORY(GetSpoofTxCircularResult);
} // namespace Cmd
} // namespace Sdx
