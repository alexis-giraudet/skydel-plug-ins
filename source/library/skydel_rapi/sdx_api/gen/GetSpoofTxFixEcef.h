...
public:
  ...
  GetSpoofTxFixEcef() : CommandBase(CmdName, TargetId) {}

  GetSpoofTxFixEcef(const std::string& id) : CommandBase(CmdName, TargetId) { setId(id); }

  static GetSpoofTxFixEcefPtr create(const std::string& id) { return std::make_shared<GetSpoofTxFixEcef>(id); }
