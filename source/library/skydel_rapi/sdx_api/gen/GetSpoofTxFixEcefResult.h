...
public:
  ...
  GetSpoofTxFixEcefResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetSpoofTxFixEcefResult(CommandBasePtr relatedCommand,
                          double x,
                          double y,
                          double z,
                          double yaw,
  ...
  static GetSpoofTxFixEcefResultPtr
  ...
  static GetSpoofTxFixEcefResultPtr create(CommandBasePtr relatedCommand,
                                           double x,
                                           double y,
                                           double z,
                                           double yaw,
