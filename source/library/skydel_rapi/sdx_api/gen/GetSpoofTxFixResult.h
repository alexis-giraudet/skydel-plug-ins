...
public:
  ...
  GetSpoofTxFixResult() : CommandResult(CmdName, TargetId) {}

  GetSpoofTxFixResult(double lat,
                      double lon,
                      double alt,
                      double yaw,
                      double pitch,
  ...
  GetSpoofTxFixResult(CommandBasePtr relatedCommand,
                      double lat,
                      double lon,
                      double alt,
                      double yaw,
  ...
  static GetSpoofTxFixResultPtr create(CommandBasePtr relatedCommand,
                                       double lat,
                                       double lon,
                                       double alt,
                                       double yaw,
