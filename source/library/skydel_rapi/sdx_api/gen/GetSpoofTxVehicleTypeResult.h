...
public:
  ...
  GetSpoofTxVehicleTypeResult() : CommandResult(CmdName, TargetId) {}

  GetSpoofTxVehicleTypeResult(const std::string& type, const std::string& id) : CommandResult(CmdName, TargetId)
  {
  ...
  static GetSpoofTxVehicleTypeResultPtr create(CommandBasePtr relatedCommand,
