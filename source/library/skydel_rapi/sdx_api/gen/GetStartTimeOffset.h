...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      inline static const char* const Documentation = "Get offset between the simulated GPS time and time given by GPS Timing receiver when using GPS Timing receiver to set the start time of the simulation.\n"      "This value has no effect when GPS start time is \"custom\" or \"computer\".";
