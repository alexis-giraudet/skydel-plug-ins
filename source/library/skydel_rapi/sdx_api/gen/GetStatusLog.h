...
public:
  ...
  GetStatusLog() : CommandBase(CmdName, TargetId) {}

  static GetStatusLogPtr create() { return std::make_shared<GetStatusLog>(); }

  static GetStatusLogPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetStatusLog>(ptr); }
