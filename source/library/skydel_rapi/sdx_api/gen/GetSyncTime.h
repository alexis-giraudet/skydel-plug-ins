...
public:
  ...
  GetSyncTime() : CommandBase(CmdName, TargetId) {}

  static GetSyncTimePtr create() { return std::make_shared<GetSyncTime>(); }

  static GetSyncTimePtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetSyncTime>(ptr); }
