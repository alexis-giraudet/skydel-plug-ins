...
public:
  ...
  GetTransmittedPrnForSV() : CommandBase(CmdName, TargetId) {}

  GetTransmittedPrnForSV(int svId, const std::vector<std::string>& signalArray) : CommandBase(CmdName, TargetId)
  {
