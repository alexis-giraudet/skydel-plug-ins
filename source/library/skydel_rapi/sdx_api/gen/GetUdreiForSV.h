...
public:
  ...
  GetUdreiForSV() : CommandBase(CmdName, TargetId) {}

  GetUdreiForSV(const std::string& system, int svId) : CommandBase(CmdName, TargetId)
  {
  ...
  static GetUdreiForSVPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetUdreiForSV>(ptr); }
