...
public:
  ...
  GetVehicleAntennaGainResult() : CommandResult(CmdName, TargetId) {}

  GetVehicleAntennaGainResult(const std::vector<std::vector<double>>& gain,
  ...
  GetVehicleAntennaGainResult(CommandBasePtr relatedCommand,
  ...
  static GetVehicleAntennaGainResultPtr create(const std::vector<std::vector<double>>& gain,
                                               const Sdx::AntennaPatternType& type,
                                               const Sdx::GNSSBand& band,
                                               const std::optional<std::string>& name = {})
  {
  ...
  static GetVehicleAntennaGainResultPtr create(CommandBasePtr relatedCommand,
                                               const std::vector<std::vector<double>>& gain,
                                               const Sdx::AntennaPatternType& type,
                                               const Sdx::GNSSBand& band,
                                               const std::optional<std::string>& name = {})
