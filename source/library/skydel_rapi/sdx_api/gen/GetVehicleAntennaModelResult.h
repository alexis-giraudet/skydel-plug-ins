...
/// type GainOffsetS          double             Pattern offset PhaseOffsetL1        array array double Phase offset
/// matrix (rad). The first dimension will be mapped to elevation [-90, 90] and the second dimension to azimuth [0,
/// 360[. PhaseOffsetTypeL1    AntennaPatternType Pattern type PhasePatternOffsetL1 double             Pattern offset
