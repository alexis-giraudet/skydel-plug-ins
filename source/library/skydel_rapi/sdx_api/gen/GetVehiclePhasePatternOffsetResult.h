...
public:
  ...
  GetVehiclePhasePatternOffsetResult() : CommandResult(CmdName, TargetId) {}

  GetVehiclePhasePatternOffsetResult(const Sdx::GNSSBand& band,
                                     double offset,
  ...
  GetVehiclePhasePatternOffsetResult(CommandBasePtr relatedCommand,
  ...
  static GetVehiclePhasePatternOffsetResultPtr create(const Sdx::GNSSBand& band,
                                                      double offset,
                                                      const std::optional<std::string>& antennaName = {})
  {
  ...
  static GetVehiclePhasePatternOffsetResultPtr create(CommandBasePtr relatedCommand,
                                                      const Sdx::GNSSBand& band,
                                                      double offset,
                                                      const std::optional<std::string>& antennaName = {})
  {
