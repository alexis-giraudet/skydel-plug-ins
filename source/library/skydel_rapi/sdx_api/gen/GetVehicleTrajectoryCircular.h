...
public:
  ...
  GetVehicleTrajectoryCircular() : CommandBase(CmdName, TargetId) {}

  static GetVehicleTrajectoryCircularPtr create() { return std::make_shared<GetVehicleTrajectoryCircular>(); }
