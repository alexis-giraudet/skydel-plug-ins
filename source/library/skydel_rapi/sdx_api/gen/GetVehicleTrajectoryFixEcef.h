...
public:
  ...
  GetVehicleTrajectoryFixEcef() : CommandBase(CmdName, TargetId) {}

  static GetVehicleTrajectoryFixEcefPtr create() { return std::make_shared<GetVehicleTrajectoryFixEcef>(); }
