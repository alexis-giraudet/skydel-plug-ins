...
public:
  ...
  GetVehicleTrajectoryOrbitResult() : CommandResult(CmdName, TargetId) {}

  GetVehicleTrajectoryOrbitResult(const std::string& type,
  ...
  GetVehicleTrajectoryOrbitResult(CommandBasePtr relatedCommand,
  ...
  static GetVehicleTrajectoryOrbitResultPtr create(const std::string& type,
                                                   const Sdx::DateTime& reference,
                                                   double semiMajorAxis,
                                                   double inclination,
                                                   double rightAscension,
                                                   ...
                                                   double argumentOfPerigee)
  {
    return std::make_shared<GetVehicleTrajectoryOrbitResult>(type,
                                                             reference,
                                                             semiMajorAxis,
                                                             inclination,
                                                             rightAscension,
  ...
  static GetVehicleTrajectoryOrbitResultPtr create(CommandBasePtr relatedCommand,
                                                   const std::string& type,
                                                   const Sdx::DateTime& reference,
                                                   double semiMajorAxis,
                                                   double inclination,
                                                   ...
                                                   double argumentOfPerigee)
  {
    return std::make_shared<GetVehicleTrajectoryOrbitResult>(relatedCommand,
                                                             type,
                                                             reference,
                                                             semiMajorAxis,
                                                             inclination,
