...
public:
  ...
  GetVisibleSV() : CommandBase(CmdName, TargetId) {}

  GetVisibleSV(const std::string& system) : CommandBase(CmdName, TargetId) { setSystem(system); }

  static GetVisibleSVPtr create(const std::string& system) { return std::make_shared<GetVisibleSV>(system); }

  static GetVisibleSVPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<GetVisibleSV>(ptr); }
