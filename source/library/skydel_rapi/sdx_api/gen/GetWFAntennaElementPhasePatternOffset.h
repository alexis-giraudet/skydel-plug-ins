...
{
///
/// Please note the command GetWFAntennaElementPhasePatternOffset is deprecated since 23.11. You may use
...
public:
  ...
  GetWFAntennaElementPhasePatternOffset() : CommandBase(CmdName, TargetId) {}

  GetWFAntennaElementPhasePatternOffset(int element) : CommandBase(CmdName, TargetId) { setElement(element); }
