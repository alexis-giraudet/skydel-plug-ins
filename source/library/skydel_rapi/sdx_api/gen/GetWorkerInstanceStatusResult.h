...
public:
  ...
  GetWorkerInstanceStatusResult() : CommandResult(CmdName, TargetId) {}
  ...
  GetWorkerInstanceStatusResult(CommandBasePtr relatedCommand,
                                bool isWorkerInstance,
                                bool isConnected,
  ...
  static GetWorkerInstanceStatusResultPtr create(bool isWorkerInstance,
                                                 bool isConnected,
                                                 const std::string& hostName,
                                                 int hostPort)
  {
  ...
  static GetWorkerInstanceStatusResultPtr create(CommandBasePtr relatedCommand,
                                                 bool isWorkerInstance,
                                                 bool isConnected,
                                                 const std::string& hostName,
                                                 int hostPort)
  {
    return std::make_shared<GetWorkerInstanceStatusResult>(relatedCommand,
                                                           isWorkerInstance,
                                                           isConnected,
                                                           hostName,
                                                           hostPort);
  ...
  virtual bool isValid() const override
  {
    ...
    return m_values.IsObject() && parse_json<bool>::is_valid(m_values["IsWorkerInstance"]) &&
  ...
  bool isWorkerInstance() const { return parse_json<bool>::parse(m_values["IsWorkerInstance"]); }

  void setIsWorkerInstance(bool isWorkerInstance)
  {
    m_values.AddMember("IsWorkerInstance",
                       parse_json<bool>::format(isWorkerInstance, m_values.GetAllocator()),
