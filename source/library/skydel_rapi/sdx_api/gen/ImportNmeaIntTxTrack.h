...
{
public:
  inline static const char* const CmdName = "ImportNmeaIntTxTrack";
  inline static const char* const Documentation = "Import NMEA interference track file\n"
                                                  "\n"
                                                  "Name Type   Description\n"
                                                  "---- ------ ------------------------------\n"
                                                  "Path string NMEA file path\n"
  ...
  ImportNmeaIntTxTrack() : CommandBase(CmdName, TargetId) {}

  ImportNmeaIntTxTrack(const std::string& path, const std::string& id) : CommandBase(CmdName, TargetId)
  {
...
REGISTER_COMMAND_TO_FACTORY(ImportNmeaIntTxTrack);
} // namespace Cmd
} // namespace Sdx
