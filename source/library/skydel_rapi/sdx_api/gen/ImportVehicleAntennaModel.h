...
public:
  ...
  ImportVehicleAntennaModel() : CommandBase(CmdName, TargetId) {}

  ImportVehicleAntennaModel(const std::string& filePath) : CommandBase(CmdName, TargetId) { setFilePath(filePath); }
