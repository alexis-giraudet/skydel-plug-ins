...
public:
  ...
  IsAutomaticGpuAllocationEnabled() : CommandBase(CmdName, TargetId) {}

  static IsAutomaticGpuAllocationEnabledPtr create() { return std::make_shared<IsAutomaticGpuAllocationEnabled>(); }
