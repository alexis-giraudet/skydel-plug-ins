...
public:
  ...
  IsDektecAdjustedNoiseEnabledResult() : CommandResult(CmdName, TargetId) {}

  IsDektecAdjustedNoiseEnabledResult(bool enable) : CommandResult(CmdName, TargetId) { setEnable(enable); }
