...
public:
  ...
  IsEachSVEnabledResult() : CommandResult(CmdName, TargetId) {}

  IsEachSVEnabledResult(const std::string& system, const std::vector<bool>& enabled) : CommandResult(CmdName, TargetId)
  {
  ...
  static IsEachSVEnabledResultPtr create(CommandBasePtr relatedCommand,
