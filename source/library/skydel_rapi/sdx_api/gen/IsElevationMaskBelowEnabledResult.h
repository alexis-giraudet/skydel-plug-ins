...
public:
  ...
  IsElevationMaskBelowEnabledResult() : CommandResult(CmdName, TargetId) {}

  IsElevationMaskBelowEnabledResult(bool enabled) : CommandResult(CmdName, TargetId) { setEnabled(enabled); }
