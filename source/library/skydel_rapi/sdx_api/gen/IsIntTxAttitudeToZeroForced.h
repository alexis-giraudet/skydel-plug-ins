...
{
public:
  inline static const char* const CmdName = "IsIntTxAttitudeToZeroForced";
  ...
  IsIntTxAttitudeToZeroForced() : CommandBase(CmdName, TargetId) {}

  IsIntTxAttitudeToZeroForced(const std::string& id) : CommandBase(CmdName, TargetId) { setId(id); }
...
REGISTER_COMMAND_TO_FACTORY(IsIntTxAttitudeToZeroForced);
} // namespace Cmd
} // namespace Sdx
