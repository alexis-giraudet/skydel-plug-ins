...
public:
  ...
  IsIntTxIgnoreRxAntennaPhasePatternResult() : CommandResult(CmdName, TargetId) {}

  IsIntTxIgnoreRxAntennaPhasePatternResult(bool ignore, const std::string& id) : CommandResult(CmdName, TargetId)
  {
  ...
  static IsIntTxIgnoreRxAntennaPhasePatternResultPtr create(CommandBasePtr relatedCommand,
                                                            bool ignore,
                                                            const std::string& id)
  {
