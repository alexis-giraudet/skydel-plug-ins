...
public:
  ...
  IsIntTxTrajectorySmoothingEnabled() : CommandBase(CmdName, TargetId) {}

  IsIntTxTrajectorySmoothingEnabled(const std::string& id) : CommandBase(CmdName, TargetId) { setId(id); }
