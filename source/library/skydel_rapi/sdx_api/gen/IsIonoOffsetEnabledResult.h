...
public:
  ...
  IsIonoOffsetEnabledResult() : CommandResult(CmdName, TargetId) {}

  IsIonoOffsetEnabledResult(bool isEnabled) : CommandResult(CmdName, TargetId) { setIsEnabled(isEnabled); }
