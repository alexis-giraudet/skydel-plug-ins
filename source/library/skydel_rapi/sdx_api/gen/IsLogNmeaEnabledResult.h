...
public:
  ...
  IsLogNmeaEnabledResult() : CommandResult(CmdName, TargetId) {}
  ...
  IsLogNmeaEnabledResult(CommandBasePtr relatedCommand,
                         bool enabled,
                         const std::optional<bool>& serialPortEnabled = {}) :
  ...
  static IsLogNmeaEnabledResultPtr create(CommandBasePtr relatedCommand,
                                          bool enabled,
                                          const std::optional<bool>& serialPortEnabled = {})
  {
