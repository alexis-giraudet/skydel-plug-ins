...
public:
  ...
  IsLogRawEnabled() : CommandBase(CmdName, TargetId) {}

  static IsLogRawEnabledPtr create() { return std::make_shared<IsLogRawEnabled>(); }

  static IsLogRawEnabledPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<IsLogRawEnabled>(ptr); }
