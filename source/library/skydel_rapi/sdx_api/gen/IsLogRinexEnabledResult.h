...
public:
  ...
  IsLogRinexEnabledResult() : CommandResult(CmdName, TargetId) {}

  IsLogRinexEnabledResult(bool enabled) : CommandResult(CmdName, TargetId) { setEnabled(enabled); }
  ...
  static IsLogRinexEnabledResultPtr create(bool enabled) { return std::make_shared<IsLogRinexEnabledResult>(enabled); }
