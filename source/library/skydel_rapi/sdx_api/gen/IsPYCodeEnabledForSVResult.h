...
public:
  ...
  IsPYCodeEnabledForSVResult() : CommandResult(CmdName, TargetId) {}

  IsPYCodeEnabledForSVResult(const std::string& signal, int svId, bool enabled) : CommandResult(CmdName, TargetId)
  {
  ...
  static IsPYCodeEnabledForSVResultPtr create(CommandBasePtr relatedCommand,
