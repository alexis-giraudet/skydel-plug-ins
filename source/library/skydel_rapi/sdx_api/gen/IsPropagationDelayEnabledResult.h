...
public:
  ...
  IsPropagationDelayEnabledResult() : CommandResult(CmdName, TargetId) {}

  IsPropagationDelayEnabledResult(const std::string& system, bool enabled) : CommandResult(CmdName, TargetId)
  {
  ...
  static IsPropagationDelayEnabledResultPtr create(CommandBasePtr relatedCommand,
