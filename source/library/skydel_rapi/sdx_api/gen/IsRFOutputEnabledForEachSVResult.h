...
public:
  ...
  IsRFOutputEnabledForEachSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  IsRFOutputEnabledForEachSVResult(CommandBasePtr relatedCommand,
  ...
  static IsRFOutputEnabledForEachSVResultPtr create(CommandBasePtr relatedCommand,
                                                    const std::string& system,
                                                    const std::vector<bool>& enabled)
  {
