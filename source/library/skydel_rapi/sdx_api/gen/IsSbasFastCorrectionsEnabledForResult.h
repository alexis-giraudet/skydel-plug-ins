...
/// --------- ---------------
/// ---------------------------------------------------------------------------------------------------- System string
/// "GPS" or "SBAS" IsEnabled bool            True if corrections are enabled ErrorType optional string Comma separated
/// error type to enable/disable. Accepted error types are "PSR offset" and "PSR error".
...
public:
  ...
  IsSbasFastCorrectionsEnabledForResult() : CommandResult(CmdName, TargetId) {}

  IsSbasFastCorrectionsEnabledForResult(const std::string& system,
                                        bool isEnabled,
  ...
  IsSbasFastCorrectionsEnabledForResult(CommandBasePtr relatedCommand,
  ...
  static IsSbasFastCorrectionsEnabledForResultPtr create(const std::string& system,
                                                         bool isEnabled,
                                                         const std::optional<std::string>& errorType = {})
  {
  ...
  static IsSbasFastCorrectionsEnabledForResultPtr create(CommandBasePtr relatedCommand,
                                                         const std::string& system,
                                                         bool isEnabled,
                                                         const std::optional<std::string>& errorType = {})
  {
