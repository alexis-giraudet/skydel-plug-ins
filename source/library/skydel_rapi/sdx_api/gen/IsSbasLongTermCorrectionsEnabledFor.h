...
public:
  ...
  IsSbasLongTermCorrectionsEnabledFor() : CommandBase(CmdName, TargetId) {}

  IsSbasLongTermCorrectionsEnabledFor(const std::string& system) : CommandBase(CmdName, TargetId) { setSystem(system); }
