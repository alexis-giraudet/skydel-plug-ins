...
public:
  ...
  IsSbasLongTermCorrectionsEnabledForResult() : CommandResult(CmdName, TargetId) {}
  ...
  static IsSbasLongTermCorrectionsEnabledForResultPtr create(CommandBasePtr relatedCommand,
