...
/// Enabled array bool Signal is enabled when value is True. Zero based index (index 0 => first SV ID, index 1 => second
/// SV ID, etc).
///
...
public:
  ...
  IsSignalEnabledForEachSVResult() : CommandResult(CmdName, TargetId) {}
  ...
  IsSignalEnabledForEachSVResult(CommandBasePtr relatedCommand,
  ...
  static IsSignalEnabledForEachSVResultPtr create(CommandBasePtr relatedCommand,
                                                  const std::string& signal,
                                                  const std::vector<bool>& enabled)
  {
