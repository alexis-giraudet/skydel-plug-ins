...
///                                      "NAVICL5", "NAVICS", "PULSARXL", "PULSARX1"
...
public:
  ...
  IsSignalEnabledForSVResult() : CommandResult(CmdName, TargetId) {}

  IsSignalEnabledForSVResult(const std::string& signal, int svId, bool enabled) : CommandResult(CmdName, TargetId)
  {
  ...
  static IsSignalEnabledForSVResultPtr create(CommandBasePtr relatedCommand,
