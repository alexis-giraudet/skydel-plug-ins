...
public:
  ...
  IsSignalStrengthModelEnabledResult() : CommandResult(CmdName, TargetId) {}

  IsSignalStrengthModelEnabledResult(bool enabled) : CommandResult(CmdName, TargetId) { setEnabled(enabled); }
