...
{
///
/// Get simulation automatic stop when the vehicle reaches trajectory end enabled or disabled. Only effective with
/// Tracks and Routes
///
///
///
...
public:
  ...
  IsSimulationStopAtTrajectoryEndEnabled() : CommandBase(CmdName, TargetId) {}
