...
public:
  ...
  IsSimulationStopAtTrajectoryEndEnabledResult() : CommandResult(CmdName, TargetId) {}

  IsSimulationStopAtTrajectoryEndEnabledResult(bool enabled) : CommandResult(CmdName, TargetId) { setEnabled(enabled); }
