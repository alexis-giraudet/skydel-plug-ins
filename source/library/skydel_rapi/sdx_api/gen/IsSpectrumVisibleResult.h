...
public:
  ...
  IsSpectrumVisibleResult() : CommandResult(CmdName, TargetId) {}

  IsSpectrumVisibleResult(bool visible) : CommandResult(CmdName, TargetId) { setVisible(visible); }
  ...
  static IsSpectrumVisibleResultPtr create(bool visible) { return std::make_shared<IsSpectrumVisibleResult>(visible); }
