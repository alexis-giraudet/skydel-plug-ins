...
public:
  ...
  IsSpoofTxAttitudeToZeroForcedResult() : CommandResult(CmdName, TargetId) {}

  IsSpoofTxAttitudeToZeroForcedResult(bool enabled, const std::string& id) : CommandResult(CmdName, TargetId)
  {
  ...
  static IsSpoofTxAttitudeToZeroForcedResultPtr create(CommandBasePtr relatedCommand,
                                                       bool enabled,
                                                       const std::string& id)
  {
