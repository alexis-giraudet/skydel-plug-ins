...
public:
  ...
  IsSpoofTxIgnoreRxAntennaGainPattern() : CommandBase(CmdName, TargetId) {}

  IsSpoofTxIgnoreRxAntennaGainPattern(const std::string& id) : CommandBase(CmdName, TargetId) { setId(id); }
