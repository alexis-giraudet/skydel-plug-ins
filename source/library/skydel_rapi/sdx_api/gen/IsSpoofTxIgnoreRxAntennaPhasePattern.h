...
public:
  ...
  IsSpoofTxIgnoreRxAntennaPhasePattern() : CommandBase(CmdName, TargetId) {}

  IsSpoofTxIgnoreRxAntennaPhasePattern(const std::string& id) : CommandBase(CmdName, TargetId) { setId(id); }
