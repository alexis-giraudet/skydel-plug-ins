...
public:
  ...
  IsSpoofTxTrajectorySmoothingEnabledResult() : CommandResult(CmdName, TargetId) {}

  IsSpoofTxTrajectorySmoothingEnabledResult(bool enabled, const std::string& id) : CommandResult(CmdName, TargetId)
  {
  ...
  static IsSpoofTxTrajectorySmoothingEnabledResultPtr create(CommandBasePtr relatedCommand,
                                                             bool enabled,
                                                             const std::string& id)
  {
