...
typedef std::shared_ptr<IsStopMainInstanceWhenWorkerInstanceStopResult>
  IsStopMainInstanceWhenWorkerInstanceStopResultPtr;
...
public:
  ...
  IsStopMainInstanceWhenWorkerInstanceStopResult() : CommandResult(CmdName, TargetId) {}

  IsStopMainInstanceWhenWorkerInstanceStopResult(bool enabled) : CommandResult(CmdName, TargetId)
  {
