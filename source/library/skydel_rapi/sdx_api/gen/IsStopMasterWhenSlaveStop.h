...
{
///
/// Please note the command IsStopMasterWhenSlaveStop is deprecated since 23.11. You may use
...
public:
  ...
  IsStopMasterWhenSlaveStop() : CommandBase(CmdName, TargetId) {}

  static IsStopMasterWhenSlaveStopPtr create() { return std::make_shared<IsStopMasterWhenSlaveStop>(); }
