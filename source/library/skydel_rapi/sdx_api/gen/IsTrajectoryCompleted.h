...
/// For track playback and vehicle simulation, this will return true once the vehicle will reach the last position in
/// the track/route. The value is unreliable for HIL trajectories.
///
///
///
...
public:
  ...
  IsTrajectoryCompleted() : CommandBase(CmdName, TargetId) {}

  static IsTrajectoryCompletedPtr create() { return std::make_shared<IsTrajectoryCompleted>(); }
