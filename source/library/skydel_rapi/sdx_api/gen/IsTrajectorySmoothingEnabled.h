...
public:
  ...
  IsTrajectorySmoothingEnabled() : CommandBase(CmdName, TargetId) {}

  static IsTrajectorySmoothingEnabledPtr create() { return std::make_shared<IsTrajectorySmoothingEnabled>(); }
