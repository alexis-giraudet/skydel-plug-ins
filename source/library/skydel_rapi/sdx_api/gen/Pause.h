...
public:
  ...
  Pause() : CommandBase(CmdName, TargetId) {}

  static PausePtr create() { return std::make_shared<Pause>(); }

  static PausePtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<Pause>(ptr); }
