...
/// -------------- ---------------------
/// --------------------------------------------------------------------------------------- System         string "GPS",
/// "Galileo", "BeiDou", "QZSS", "NavIC" or "PULSAR". SvId           int                   Satellite's SV ID. Toc
/// datetime              Time of Clock. ParametersDict dict string:double    A dictionary of parameters pairs.
...
/// DataSetTypes   optional array string Optional data set type array: "Ephemeris" or "Orbit". If not provided, applies
/// to both.
///
...
public:
  ...
  PushDynamicSVData() : CommandBase(CmdName, TargetId) {}

  PushDynamicSVData(const std::string& system,
                    int svId,
                    const Sdx::DateTime& toc,
                    const std::map<std::string, double>& parametersDict,
                    const std::optional<std::vector<std::string>>& dataSetTypes = {}) :
  ...
  static PushDynamicSVDataPtr create(const std::string& system,
                                     int svId,
                                     const Sdx::DateTime& toc,
                                     const std::map<std::string, double>& parametersDict,
                                     const std::optional<std::vector<std::string>>& dataSetTypes = {})
  ...
  virtual bool isValid() const override
  {
    ...
    return m_values.IsObject() && parse_json<std::string>::is_valid(m_values["System"]) &&
           parse_json<int>::is_valid(m_values["SvId"]) && parse_json<Sdx::DateTime>::is_valid(m_values["Toc"]) &&
  ...
  Sdx::DateTime toc() const { return parse_json<Sdx::DateTime>::parse(m_values["Toc"]); }
  ...
  {
    m_values.AddMember("ParametersDict",
                       parse_json<std::map<std::string, double>>::format(parametersDict, m_values.GetAllocator()),
                       m_values.GetAllocator());
  }
  ...
  {
    m_values.AddMember("DataSetTypes",
                       parse_json<std::optional<std::vector<std::string>>>::format(dataSetTypes,
                                                                                   m_values.GetAllocator()),
                       m_values.GetAllocator());
  }
};
