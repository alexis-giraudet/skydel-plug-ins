...
{
///
/// Push an interference track ecef and ned attitude node. Must be called after BeginIntTxTrackDefinition and before
...
public:
  ...
  PushIntTxTrackEcefNed() : CommandBase(CmdName, TargetId) {}

  PushIntTxTrackEcefNed(int time,
                        double x,
                        double y,
                        double z,
                        double yaw,
  ...
  static PushIntTxTrackEcefNedPtr
