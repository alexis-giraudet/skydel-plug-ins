...
public:
  ...
  PushRouteEcef() : CommandBase(CmdName, TargetId) {}

  PushRouteEcef(double speed, double x, double y, double z) : CommandBase(CmdName, TargetId)
  {
  ...
  static PushRouteEcefPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<PushRouteEcef>(ptr); }

  virtual bool isValid() const override
  {

    return m_values.IsObject() && parse_json<double>::is_valid(m_values["Speed"]) &&
