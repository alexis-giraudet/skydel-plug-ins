...
{
///
/// Push an spoofer transmitter track ecef node. Must be called after BeginSpoofTxTrackDefinition and before
...
public:
  ...
  PushSpoofTxTrackEcef() : CommandBase(CmdName, TargetId) {}

  PushSpoofTxTrackEcef(int time, double x, double y, double z, const std::string& id) : CommandBase(CmdName, TargetId)
  {
