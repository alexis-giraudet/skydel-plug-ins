...
{
///
/// Please note the command RandomizeSeedsForAllSatellitesPseudorangeNoiseGaussMarkov is deprecated since 21.3. You may
/// use RandomizePseudorangeNoiseGaussMarkovSeedsForAllSV.
///
...
typedef std::shared_ptr<RandomizeSeedsForAllSatellitesPseudorangeNoiseGaussMarkov>
  RandomizeSeedsForAllSatellitesPseudorangeNoiseGaussMarkovPtr;
...
public:
  ...
  RandomizeSeedsForAllSatellitesPseudorangeNoiseGaussMarkov() : CommandBase(CmdName, TargetId) {}

  RandomizeSeedsForAllSatellitesPseudorangeNoiseGaussMarkov(const std::string& system) : CommandBase(CmdName, TargetId)
  {
