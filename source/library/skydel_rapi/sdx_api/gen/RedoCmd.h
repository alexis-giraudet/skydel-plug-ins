...
public:
  ...
  RedoCmd() : CommandBase(CmdName, TargetId) {}

  static RedoCmdPtr create() { return std::make_shared<RedoCmd>(); }

  static RedoCmdPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<RedoCmd>(ptr); }
