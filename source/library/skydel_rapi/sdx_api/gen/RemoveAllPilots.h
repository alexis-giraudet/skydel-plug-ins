...
public:
  ...
  RemoveAllPilots() : CommandBase(CmdName, TargetId) {}

  static RemoveAllPilotsPtr create() { return std::make_shared<RemoveAllPilots>(); }

  static RemoveAllPilotsPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<RemoveAllPilots>(ptr); }
