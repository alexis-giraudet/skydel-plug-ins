...
public:
  ...
  RemoveWFElement() : CommandBase(CmdName, TargetId) {}

  static RemoveWFElementPtr create() { return std::make_shared<RemoveWFElement>(); }

  static RemoveWFElementPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<RemoveWFElement>(ptr); }
