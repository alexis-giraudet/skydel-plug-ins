...
public:
  ...
  RenameIntTx() : CommandBase(CmdName, TargetId) {}

  RenameIntTx(const std::string& usualName, const std::string& id) : CommandBase(CmdName, TargetId)
  {
  ...
  static RenameIntTxPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<RenameIntTx>(ptr); }
