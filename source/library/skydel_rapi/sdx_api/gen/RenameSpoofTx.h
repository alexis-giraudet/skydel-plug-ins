...
public:
  ...
  RenameSpoofTx() : CommandBase(CmdName, TargetId) {}

  RenameSpoofTx(const std::string& usualName, const std::string& id) : CommandBase(CmdName, TargetId)
  {
  ...
  static RenameSpoofTxPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<RenameSpoofTx>(ptr); }
