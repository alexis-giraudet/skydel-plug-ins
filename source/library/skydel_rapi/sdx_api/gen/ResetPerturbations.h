...
/// ----------- ---------------
/// ------------------------------------------------------------------------------------------- System      string
/// "GPS", "Galileo", "BeiDou", "QZSS", "NavIC" or "PULSAR" SvId        int             The satellite's SV ID. Use 0 to
/// apply new value to all satellites in the constellation. DataSetName optional string Optional name of the data set to
...
{
public:
  inline static const char* const CmdName = "ResetPerturbations";
  ...
  ResetPerturbations() : CommandBase(CmdName, TargetId) {}
  ...
  static ResetPerturbationsPtr create(const std::string& system,
                                      int svId,
...
REGISTER_COMMAND_TO_FACTORY(ResetPerturbations);
} // namespace Cmd
} // namespace Sdx
