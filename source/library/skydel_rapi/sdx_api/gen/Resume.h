...
public:
  ...
  Resume() : CommandBase(CmdName, TargetId) {}

  static ResumePtr create() { return std::make_shared<Resume>(); }

  static ResumePtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<Resume>(ptr); }
