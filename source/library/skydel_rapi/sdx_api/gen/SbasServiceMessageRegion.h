...
struct parse_json<Sdx::SbasServiceMessageRegion>
{
  static bool is_valid(const rapidjson::Value& value)
  {
    ...
    return value.IsObject() && parse_json<int>::is_valid(value["FirstLatitude"]) &&
           parse_json<int>::is_valid(value["FirstLongitude"]) && parse_json<int>::is_valid(value["SecondLatitude"]) &&
           parse_json<int>::is_valid(value["SecondLongitude"]) && parse_json<std::string>::is_valid(value["Shape"]);
  }
