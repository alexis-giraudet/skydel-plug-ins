...
{
///
/// Please note the command SetAllSatellitesPseudorangeNoiseGaussMarkov is deprecated since 21.3. You may use
...
{
public:
  inline static const char* const CmdName = "SetAllSatellitesPseudorangeNoiseGaussMarkov";
  ...
  SetAllSatellitesPseudorangeNoiseGaussMarkov() : CommandBase(CmdName, TargetId) {}

  SetAllSatellitesPseudorangeNoiseGaussMarkov(const std::string& system,
                                              int process,
  ...
  static SetAllSatellitesPseudorangeNoiseGaussMarkovPtr create(const std::string& system,
                                                               int process,
                                                               const std::vector<bool>& enabled,
                                                               const std::vector<double>& sigma,
                                                               const std::vector<double>& time,
...
REGISTER_COMMAND_TO_FACTORY(SetAllSatellitesPseudorangeNoiseGaussMarkov);
} // namespace Cmd
} // namespace Sdx
