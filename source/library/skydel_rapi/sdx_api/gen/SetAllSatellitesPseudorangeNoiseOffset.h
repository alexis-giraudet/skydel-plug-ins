...
{
///
/// Please note the command SetAllSatellitesPseudorangeNoiseOffset is deprecated since 21.3. You may use
...
public:
  ...
  SetAllSatellitesPseudorangeNoiseOffset() : CommandBase(CmdName, TargetId) {}

  SetAllSatellitesPseudorangeNoiseOffset(const std::string& system,
  ...
  static SetAllSatellitesPseudorangeNoiseOffsetPtr create(const std::string& system,
                                                          const std::vector<bool>& enabled,
                                                          const std::vector<double>& offset)
  {
