...
public:
  ...
  SetAlmanacUploadTimeInterval() : CommandBase(CmdName, TargetId) {}

  SetAlmanacUploadTimeInterval(const std::string& system, int interval) : CommandBase(CmdName, TargetId)
  {
