...
public:
  ...
  SetBeiDouEphBoolParamForEachSV() : CommandBase(CmdName, TargetId) {}

  SetBeiDouEphBoolParamForEachSV(const std::string& paramName,
  ...
  static SetBeiDouEphBoolParamForEachSVPtr create(const std::string& paramName,
                                                  const std::vector<bool>& val,
                                                  const std::optional<std::string>& dataSetName = {})
  {
