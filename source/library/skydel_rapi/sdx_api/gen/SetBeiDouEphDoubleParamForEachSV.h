...
{
public:
  inline static const char* const CmdName = "SetBeiDouEphDoubleParamForEachSV";
  ...
  SetBeiDouEphDoubleParamForEachSV() : CommandBase(CmdName, TargetId) {}

  SetBeiDouEphDoubleParamForEachSV(const std::string& paramName,
  ...
  static SetBeiDouEphDoubleParamForEachSVPtr create(const std::string& paramName,
                                                    const std::vector<double>& val,
                                                    const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(SetBeiDouEphDoubleParamForEachSV);
} // namespace Cmd
} // namespace Sdx
