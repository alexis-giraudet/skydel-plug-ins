...
{
///
/// Please note the command SetBeiDouEphDoubleParamForSV is deprecated since 23.11. You may use
...
public:
  ...
  SetBeiDouEphDoubleParamForSV() : CommandBase(CmdName, TargetId) {}

  SetBeiDouEphDoubleParamForSV(int svId,
  ...
  static SetBeiDouEphDoubleParamForSVPtr create(int svId,
                                                const std::string& paramName,
                                                double val,
                                                const std::optional<std::string>& dataSetName = {})
  {
