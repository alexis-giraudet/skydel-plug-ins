...
{
///
/// Please note the command SetBeiDouEphemerisDoubleParams is deprecated since 21.3. You may use
/// SetBeiDouEphDoubleParamForEachSV.
///
/// Please note the command SetBeiDouEphDoubleParamForEachSV is deprecated since 23.11. You may use
...
/// ----------- ---------------
/// -------------------------------------------------------------------------------------------------- ParamName string
/// Refer to SetBeiDouEphDoubleParamForSV for accepted names Val         array double    Parameter value for each
...
{
public:
  inline static const char* const CmdName = "SetBeiDouEphemerisDoubleParams";
  ...
  inline static const char* const Deprecated =
    "Please note the command SetBeiDouEphemerisDoubleParams is deprecated since 23.11. You may use SetConstellationParameterForSV.";

  SetBeiDouEphemerisDoubleParams() : CommandBase(CmdName, TargetId) {}

  SetBeiDouEphemerisDoubleParams(const std::string& paramName,
  ...
  static SetBeiDouEphemerisDoubleParamsPtr create(const std::string& paramName,
                                                  const std::vector<double>& val,
                                                  const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(SetBeiDouEphemerisDoubleParams);
} // namespace Cmd
} // namespace Sdx
