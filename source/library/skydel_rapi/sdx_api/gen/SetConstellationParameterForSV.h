...
public:
  ...
  SetConstellationParameterForSV() : CommandBase(CmdName, TargetId) {}

  SetConstellationParameterForSV(const std::string& system,
                                 int svId,
  ...
  static SetConstellationParameterForSVPtr create(const std::string& system,
                                                  int svId,
                                                  const std::string& paramName,
                                                  double val,
                                                  const std::optional<std::string>& dataSetName = {})
