...
public:
  ...
  SetDefaultIntTxPersistence() : CommandBase(CmdName, TargetId) {}

  SetDefaultIntTxPersistence(bool defaultValue) : CommandBase(CmdName, TargetId) { setDefaultValue(defaultValue); }
  ...
  virtual bool isValid() const override
  {
    ...
    return m_values.IsObject() && parse_json<bool>::is_valid(m_values["DefaultValue"]);
  }
  ...
  bool defaultValue() const { return parse_json<bool>::parse(m_values["DefaultValue"]); }

  void setDefaultValue(bool defaultValue)
  {
    m_values.AddMember("DefaultValue",
                       parse_json<bool>::format(defaultValue, m_values.GetAllocator()),
