...
public:
  ...
  SetDefaultVehicleAntennaModel() : CommandBase(CmdName, TargetId) {}

  SetDefaultVehicleAntennaModel(const std::string& name) : CommandBase(CmdName, TargetId) { setName(name); }
