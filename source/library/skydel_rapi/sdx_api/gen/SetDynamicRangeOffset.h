...
{
///
/// Set the GNSS dynamic range offset. Changing this value shifts the dynamic power range available for GNSS signals.
...
public:
  ...
  SetDynamicRangeOffset() : CommandBase(CmdName, TargetId) {}

  SetDynamicRangeOffset(double offset) : CommandBase(CmdName, TargetId) { setOffset(offset); }

  static SetDynamicRangeOffsetPtr create(double offset) { return std::make_shared<SetDynamicRangeOffset>(offset); }
