...
public:
  ...
  SetElevationMaskBelow() : CommandBase(CmdName, TargetId) {}

  SetElevationMaskBelow(double angle) : CommandBase(CmdName, TargetId) { setAngle(angle); }

  static SetElevationMaskBelowPtr create(double angle) { return std::make_shared<SetElevationMaskBelow>(angle); }
