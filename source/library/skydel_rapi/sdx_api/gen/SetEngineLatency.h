...
public:
  ...
  SetEngineLatency() : CommandBase(CmdName, TargetId) {}

  SetEngineLatency(int latency) : CommandBase(CmdName, TargetId) { setLatency(latency); }

  static SetEngineLatencyPtr create(int latency) { return std::make_shared<SetEngineLatency>(latency); }
