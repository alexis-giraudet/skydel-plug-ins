...
public:
  ...
  SetGalileoEphDoubleParamForEachSV() : CommandBase(CmdName, TargetId) {}

  SetGalileoEphDoubleParamForEachSV(const std::string& paramName,
  ...
  static SetGalileoEphDoubleParamForEachSVPtr create(const std::string& paramName,
                                                     const std::vector<double>& val,
                                                     const std::optional<std::string>& dataSetName = {})
  {
