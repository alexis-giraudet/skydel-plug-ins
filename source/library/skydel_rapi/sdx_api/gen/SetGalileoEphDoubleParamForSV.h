...
{
///
/// Please note the command SetGalileoEphDoubleParamForSV is deprecated since 23.11. You may use
...
public:
  ...
  SetGalileoEphDoubleParamForSV() : CommandBase(CmdName, TargetId) {}

  SetGalileoEphDoubleParamForSV(int svId,
  ...
  static SetGalileoEphDoubleParamForSVPtr create(int svId,
                                                 const std::string& paramName,
                                                 double val,
                                                 const std::optional<std::string>& dataSetName = {})
  {
