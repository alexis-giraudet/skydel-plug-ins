...
/// ----------- ---------------
/// ------------------------------------------------------------------------------------------- SvId        int The
/// satellite SV ID, or use 0 to apply new value to all satellites. Sisai       int             SISA index. DataSetName
...
{
public:
  inline static const char* const CmdName = "SetGalileoSisaE1E5bIndexForSV";
  ...
  SetGalileoSisaE1E5bIndexForSV() : CommandBase(CmdName, TargetId) {}
  ...
  static SetGalileoSisaE1E5bIndexForSVPtr create(int svId,
                                                 int sisai,
  ...
  int sisai() const { return parse_json<int>::parse(m_values["Sisai"]); }
...
REGISTER_COMMAND_TO_FACTORY(SetGalileoSisaE1E5bIndexForSV);
} // namespace Cmd
} // namespace Sdx
