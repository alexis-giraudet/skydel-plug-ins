...
public:
  ...
  SetGlobalPowerOffset() : CommandBase(CmdName, TargetId) {}

  SetGlobalPowerOffset(double offset) : CommandBase(CmdName, TargetId) { setOffset(offset); }

  static SetGlobalPowerOffsetPtr create(double offset) { return std::make_shared<SetGlobalPowerOffset>(offset); }
