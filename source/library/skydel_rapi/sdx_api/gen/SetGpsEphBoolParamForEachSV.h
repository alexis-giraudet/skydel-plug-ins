...
public:
  ...
  SetGpsEphBoolParamForEachSV() : CommandBase(CmdName, TargetId) {}

  SetGpsEphBoolParamForEachSV(const std::string& paramName,
  ...
  static SetGpsEphBoolParamForEachSVPtr create(const std::string& paramName,
                                               const std::vector<bool>& val,
                                               const std::optional<std::string>& dataSetName = {})
  {
