...
public:
  ...
  SetGpsEphDoubleParamForEachSV() : CommandBase(CmdName, TargetId) {}

  SetGpsEphDoubleParamForEachSV(const std::string& paramName,
  ...
  static SetGpsEphDoubleParamForEachSVPtr create(const std::string& paramName,
                                                 const std::vector<double>& val,
                                                 const std::optional<std::string>& dataSetName = {})
  {
