...
{
///
/// Please note the command SetGpsEphemerisDoubleParams is deprecated since 21.3. You may use
/// SetGpsEphDoubleParamForEachSV.
///
/// Please note the command SetGpsEphDoubleParamForEachSV is deprecated since 23.11. You may use
...
{
public:
  inline static const char* const CmdName = "SetGpsEphemerisDoubleParams";
  ...
  inline static const char* const Deprecated =
    "Please note the command SetGpsEphemerisDoubleParams is deprecated since 23.11. You may use SetConstellationParameterForSV.";

  SetGpsEphemerisDoubleParams() : CommandBase(CmdName, TargetId) {}

  SetGpsEphemerisDoubleParams(const std::string& paramName,
  ...
  static SetGpsEphemerisDoubleParamsPtr create(const std::string& paramName,
                                               const std::vector<double>& val,
                                               const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(SetGpsEphemerisDoubleParams);
} // namespace Cmd
} // namespace Sdx
