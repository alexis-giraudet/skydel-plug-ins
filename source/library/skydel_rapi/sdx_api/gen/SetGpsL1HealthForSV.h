...
{
public:
  inline static const char* const CmdName = "SetGpsL1HealthForSV";
  ...
  SetGpsL1HealthForSV() : CommandBase(CmdName, TargetId) {}
...
REGISTER_COMMAND_TO_FACTORY(SetGpsL1HealthForSV);
} // namespace Cmd
} // namespace Sdx
