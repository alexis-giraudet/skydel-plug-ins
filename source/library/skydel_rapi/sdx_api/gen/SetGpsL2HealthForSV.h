...
{
public:
  inline static const char* const CmdName = "SetGpsL2HealthForSV";
  ...
  SetGpsL2HealthForSV() : CommandBase(CmdName, TargetId) {}
...
REGISTER_COMMAND_TO_FACTORY(SetGpsL2HealthForSV);
} // namespace Cmd
} // namespace Sdx
