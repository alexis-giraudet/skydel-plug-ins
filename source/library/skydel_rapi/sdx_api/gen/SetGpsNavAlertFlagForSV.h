...
namespace Sdx
{
  namespace Cmd
  {
    ...
    {
    public:
      inline static const char* const CmdName = "SetGpsNavAlertFlagForSV";
      inline static const char* const Documentation = "Set GPS NAV Alert Flag\n"      "\n"      "Name        Type            Description\n"      "----------- --------------- -------------------------------------------------------------------------------------------\n"      "SvId        int             Satellite's SV ID 1..32, or use 0 to apply new value to all satellites.\n"      "Alert       bool            GPS NAV Alert Flag, false = No Alert, true = Alert\n"      "DataSetName optional string Optional name of the data set to use. If no value is provided, the active data set is used.";
    ...
    REGISTER_COMMAND_TO_FACTORY(SetGpsNavAlertFlagForSV);
  }
}
