...
public:
  ...
  SetGpu() : CommandBase(CmdName, TargetId) {}

  SetGpu(int gpuIdx, int output, const std::string& id) : CommandBase(CmdName, TargetId)
  {
  ...
  static SetGpuPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<SetGpu>(ptr); }
