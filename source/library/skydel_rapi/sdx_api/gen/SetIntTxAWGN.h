...
public:
  ...
  SetIntTxAWGN() : CommandBase(CmdName, TargetId) {}

  SetIntTxAWGN(bool enabled,
               double centralFreq,
               double power,
               double bandwidth,
  ...
  static SetIntTxAWGNPtr create(bool enabled,
                                double centralFreq,
                                double power,
                                double bandwidth,
                                const std::string& transmitterId,
  ...
  static SetIntTxAWGNPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<SetIntTxAWGN>(ptr); }
