...
{
public:
  inline static const char* const CmdName = "SetIntTxBOC";
  ...
  SetIntTxBOC() : CommandBase(CmdName, TargetId) {}

  SetIntTxBOC(bool enabled,
              double centralFreq,
              double power,
              int codeRate,
              int codeLengthMs,
  ...
  static SetIntTxBOCPtr create(bool enabled,
                               double centralFreq,
                               double power,
                               int codeRate,
                               int codeLengthMs,
                               ...
                               const std::optional<int>& group = {})
  {
    return std::make_shared<SetIntTxBOC>(enabled,
                                         centralFreq,
                                         power,
                                         codeRate,
                                         codeLengthMs,
  ...
  static SetIntTxBOCPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<SetIntTxBOC>(ptr); }
...
REGISTER_COMMAND_TO_FACTORY(SetIntTxBOC);
} // namespace Cmd
} // namespace Sdx
