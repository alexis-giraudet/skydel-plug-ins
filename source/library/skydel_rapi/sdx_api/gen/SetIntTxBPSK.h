...
public:
  ...
  SetIntTxBPSK() : CommandBase(CmdName, TargetId) {}

  SetIntTxBPSK(bool enabled,
               double centralFreq,
               double power,
               int codeRate,
               int codeLengthMs,
  ...
  static SetIntTxBPSKPtr create(bool enabled,
                                double centralFreq,
                                double power,
                                int codeRate,
                                int codeLengthMs,
                                ...
                                const std::optional<int>& prn = {})
  {
    return std::make_shared<SetIntTxBPSK>(enabled,
                                          centralFreq,
                                          power,
                                          codeRate,
                                          codeLengthMs,
  ...
  static SetIntTxBPSKPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<SetIntTxBPSK>(ptr); }
