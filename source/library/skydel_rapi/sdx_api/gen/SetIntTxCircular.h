...
{
public:
  inline static const char* const CmdName = "SetIntTxCircular";
  inline static const char* const Documentation = "Set interference transmitter circular trajectory\n"
                                                  "\n"
                                                  "Name        Type            Description\n"
                                                  "----------- --------------- --------------------------------\n"
                                                  "Lat         double          Center latitude (rad)\n"
  ...
  SetIntTxCircular() : CommandBase(CmdName, TargetId) {}

  SetIntTxCircular(double lat,
                   double lon,
                   double alt,
                   double radius,
                   double speed,
  ...
  static SetIntTxCircularPtr create(double lat,
                                    double lon,
                                    double alt,
                                    double radius,
                                    double speed,
...
REGISTER_COMMAND_TO_FACTORY(SetIntTxCircular);
} // namespace Cmd
} // namespace Sdx
