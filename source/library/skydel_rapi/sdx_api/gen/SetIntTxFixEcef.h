...
{
public:
  inline static const char* const CmdName = "SetIntTxFixEcef";
  ...
  SetIntTxFixEcef() : CommandBase(CmdName, TargetId) {}
  ...
  static SetIntTxFixEcefPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<SetIntTxFixEcef>(ptr); }
...
REGISTER_COMMAND_TO_FACTORY(SetIntTxFixEcef);
} // namespace Cmd
} // namespace Sdx
