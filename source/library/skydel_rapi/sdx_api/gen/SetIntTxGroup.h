...
public:
  ...
  SetIntTxGroup() : CommandBase(CmdName, TargetId) {}

  SetIntTxGroup(int group, const std::string& id) : CommandBase(CmdName, TargetId)
  {
  ...
  static SetIntTxGroupPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<SetIntTxGroup>(ptr); }

  virtual bool isValid() const override
  {

    return m_values.IsObject() && parse_json<int>::is_valid(m_values["Group"]) &&
