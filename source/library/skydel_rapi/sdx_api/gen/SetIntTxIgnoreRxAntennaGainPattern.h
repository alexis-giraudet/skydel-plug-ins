...
public:
  ...
  SetIntTxIgnoreRxAntennaGainPattern() : CommandBase(CmdName, TargetId) {}

  SetIntTxIgnoreRxAntennaGainPattern(bool ignore, const std::string& id) : CommandBase(CmdName, TargetId)
  {
