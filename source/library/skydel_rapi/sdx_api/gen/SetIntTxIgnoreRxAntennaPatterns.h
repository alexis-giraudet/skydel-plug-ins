...
public:
  ...
  SetIntTxIgnoreRxAntennaPatterns() : CommandBase(CmdName, TargetId) {}

  SetIntTxIgnoreRxAntennaPatterns(bool ignore, const std::string& id) : CommandBase(CmdName, TargetId)
  {
