...
{
public:
  inline static const char* const CmdName = "SetIntTxPulse";
  ...
  SetIntTxPulse() : CommandBase(CmdName, TargetId) {}

  SetIntTxPulse(bool enabled,
                double centralFreq,
                double power,
                double dutyCycle,
                int pulseRate,
  ...
  static SetIntTxPulsePtr create(bool enabled,
                                 double centralFreq,
                                 double power,
                                 double dutyCycle,
                                 int pulseRate,
                                 ...
                                 const std::optional<int>& group = {})
  {
    return std::make_shared<SetIntTxPulse>(enabled,
                                           centralFreq,
                                           power,
                                           dutyCycle,
                                           pulseRate,
  ...
  static SetIntTxPulsePtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<SetIntTxPulse>(ptr); }
...
REGISTER_COMMAND_TO_FACTORY(SetIntTxPulse);
} // namespace Cmd
} // namespace Sdx
