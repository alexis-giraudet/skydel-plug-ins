...
{
///
/// Set the inter-modulation coefficient for this signal component. The default value is 1 for the signal component and
...
public:
  ...
  SetInterModulation() : CommandBase(CmdName, TargetId) {}
