...
{
///
/// Set Mask flags in the ionospheric grid for a given service provider. The array is zero based, the index 0 in a band
...
public:
  ...
  SetIonoGridMaskAll() : CommandBase(CmdName, TargetId) {}
