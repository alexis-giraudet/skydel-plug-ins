...
public:
  ...
  SetLeapSecond() : CommandBase(CmdName, TargetId) {}

  SetLeapSecond(int leapSecond) : CommandBase(CmdName, TargetId) { setLeapSecond(leapSecond); }

  static SetLeapSecondPtr create(int leapSecond) { return std::make_shared<SetLeapSecond>(leapSecond); }

  static SetLeapSecondPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<SetLeapSecond>(ptr); }
