...
///  Note that changing Merkle Tree parameters will modify its XML representation, and may result in Public Keys and
///  Tree Nodes being regenerated.
///
...
public:
  ...
  SetMerkleTreeParameters() : CommandBase(CmdName, TargetId) {}

  SetMerkleTreeParameters(const std::string& id,
  ...
  static SetMerkleTreeParametersPtr create(const std::string& id,
                                           const std::string& keyType,
                                           const std::string& hashFunction,
                                           const Sdx::DateTime& beginApplicability,
                                           const std::optional<Sdx::DateTime>& endApplicability = {})
