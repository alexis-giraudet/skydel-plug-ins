...
{
public:
  inline static const char* const CmdName = "SetMessageModificationToBeiDouCNav1";
  ...
  SetMessageModificationToBeiDouCNav1() : CommandBase(CmdName, TargetId) {}

  SetMessageModificationToBeiDouCNav1(const std::vector<std::string>& signalArray,
                                      int svId,
                                      int startTime,
                                      int stopTime,
                                      int page,
  ...
  static SetMessageModificationToBeiDouCNav1Ptr create(const std::vector<std::string>& signalArray,
                                                       int svId,
                                                       int startTime,
                                                       int stopTime,
                                                       int page,
                                                       ...
                                                       const std::string& id)
  {
    return std::make_shared<SetMessageModificationToBeiDouCNav1>(signalArray,
                                                                 svId,
                                                                 startTime,
                                                                 stopTime,
                                                                 page,
...
REGISTER_COMMAND_TO_FACTORY(SetMessageModificationToBeiDouCNav1);
} // namespace Cmd
} // namespace Sdx
