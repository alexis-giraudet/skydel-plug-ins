...
{
public:
  inline static const char* const CmdName = "SetMessageModificationToBeiDouCNav2";
  ...
  SetMessageModificationToBeiDouCNav2() : CommandBase(CmdName, TargetId) {}

  SetMessageModificationToBeiDouCNav2(const std::vector<std::string>& signalArray,
                                      int svId,
                                      int startTime,
                                      int stopTime,
                                      int messageType,
  ...
  static SetMessageModificationToBeiDouCNav2Ptr create(const std::vector<std::string>& signalArray,
                                                       int svId,
                                                       int startTime,
                                                       int stopTime,
                                                       int messageType,
                                                       ...
                                                       const std::string& id)
  {
    return std::make_shared<SetMessageModificationToBeiDouCNav2>(signalArray,
                                                                 svId,
                                                                 startTime,
                                                                 stopTime,
                                                                 messageType,
...
REGISTER_COMMAND_TO_FACTORY(SetMessageModificationToBeiDouCNav2);
} // namespace Cmd
} // namespace Sdx
