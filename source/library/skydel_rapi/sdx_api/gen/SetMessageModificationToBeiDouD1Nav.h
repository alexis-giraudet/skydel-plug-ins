...
{
public:
  inline static const char* const CmdName = "SetMessageModificationToBeiDouD1Nav";
  ...
  SetMessageModificationToBeiDouD1Nav() : CommandBase(CmdName, TargetId) {}

  SetMessageModificationToBeiDouD1Nav(const std::vector<std::string>& signalArray,
                                      int svId,
                                      int startTime,
                                      int stopTime,
                                      int subframe,
  ...
  static SetMessageModificationToBeiDouD1NavPtr create(const std::vector<std::string>& signalArray,
                                                       int svId,
                                                       int startTime,
                                                       int stopTime,
                                                       int subframe,
                                                       ...
                                                       const std::string& id)
  {
    return std::make_shared<SetMessageModificationToBeiDouD1Nav>(signalArray,
                                                                 svId,
                                                                 startTime,
                                                                 stopTime,
                                                                 subframe,
...
REGISTER_COMMAND_TO_FACTORY(SetMessageModificationToBeiDouD1Nav);
} // namespace Cmd
} // namespace Sdx
