...
{
public:
  inline static const char* const CmdName = "SetMessageModificationToBeiDouD2Nav";
  ...
  SetMessageModificationToBeiDouD2Nav() : CommandBase(CmdName, TargetId) {}

  SetMessageModificationToBeiDouD2Nav(const std::vector<std::string>& signalArray,
                                      int svId,
                                      int startTime,
                                      int stopTime,
                                      int subframe,
  ...
  static SetMessageModificationToBeiDouD2NavPtr create(const std::vector<std::string>& signalArray,
                                                       int svId,
                                                       int startTime,
                                                       int stopTime,
                                                       int subframe,
                                                       ...
                                                       const std::string& id)
  {
    return std::make_shared<SetMessageModificationToBeiDouD2Nav>(signalArray,
                                                                 svId,
                                                                 startTime,
                                                                 stopTime,
                                                                 subframe,
...
REGISTER_COMMAND_TO_FACTORY(SetMessageModificationToBeiDouD2Nav);
} // namespace Cmd
} // namespace Sdx
