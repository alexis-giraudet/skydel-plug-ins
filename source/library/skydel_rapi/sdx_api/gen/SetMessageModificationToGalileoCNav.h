...
{
public:
  inline static const char* const CmdName = "SetMessageModificationToGalileoCNav";
  ...
  SetMessageModificationToGalileoCNav() : CommandBase(CmdName, TargetId) {}

  SetMessageModificationToGalileoCNav(const std::vector<std::string>& signalArray,
                                      int svId,
                                      int startTime,
                                      int stopTime,
                                      bool updateCRC,
  ...
  static SetMessageModificationToGalileoCNavPtr create(const std::vector<std::string>& signalArray,
                                                       int svId,
                                                       int startTime,
                                                       int stopTime,
                                                       bool updateCRC,
                                                       ...
                                                       const std::string& id)
  {
    return std::make_shared<SetMessageModificationToGalileoCNav>(signalArray,
                                                                 svId,
                                                                 startTime,
                                                                 stopTime,
                                                                 updateCRC,
...
REGISTER_COMMAND_TO_FACTORY(SetMessageModificationToGalileoCNav);
} // namespace Cmd
} // namespace Sdx
