...
{
public:
  inline static const char* const CmdName = "SetMessageModificationToGalileoINav";
  ...
  SetMessageModificationToGalileoINav() : CommandBase(CmdName, TargetId) {}

  SetMessageModificationToGalileoINav(const std::vector<std::string>& signalArray,
                                      int svId,
                                      int startTime,
                                      int stopTime,
                                      int subframe,
  ...
  static SetMessageModificationToGalileoINavPtr create(const std::vector<std::string>& signalArray,
                                                       int svId,
                                                       int startTime,
                                                       int stopTime,
                                                       int subframe,
                                                       ...
                                                       const std::string& id)
  {
    return std::make_shared<SetMessageModificationToGalileoINav>(signalArray,
                                                                 svId,
                                                                 startTime,
                                                                 stopTime,
                                                                 subframe,
...
REGISTER_COMMAND_TO_FACTORY(SetMessageModificationToGalileoINav);
} // namespace Cmd
} // namespace Sdx
