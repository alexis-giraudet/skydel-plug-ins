...
public:
  ...
  SetMessageModificationToGlonassNav() : CommandBase(CmdName, TargetId) {}

  SetMessageModificationToGlonassNav(const std::vector<std::string>& signalArray,
                                     int svId,
                                     int startTime,
                                     int stopTime,
                                     int frame,
  ...
  static SetMessageModificationToGlonassNavPtr create(const std::vector<std::string>& signalArray,
                                                      int svId,
                                                      int startTime,
                                                      int stopTime,
                                                      int frame,
                                                      ...
                                                      const std::string& id)
  {
    return std::make_shared<SetMessageModificationToGlonassNav>(signalArray,
                                                                svId,
                                                                startTime,
                                                                stopTime,
                                                                frame,
