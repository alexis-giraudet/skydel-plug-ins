...
{
public:
  inline static const char* const CmdName = "SetMessageModificationToGpsCNav2";
  ...
  SetMessageModificationToGpsCNav2() : CommandBase(CmdName, TargetId) {}

  SetMessageModificationToGpsCNav2(const std::vector<std::string>& signalArray,
                                   int svId,
                                   int startTime,
                                   int stopTime,
                                   int page,
  ...
  static SetMessageModificationToGpsCNav2Ptr create(const std::vector<std::string>& signalArray,
                                                    int svId,
                                                    int startTime,
                                                    int stopTime,
                                                    int page,
                                                    ...
                                                    const std::string& id)
  {
    return std::make_shared<SetMessageModificationToGpsCNav2>(signalArray,
                                                              svId,
                                                              startTime,
                                                              stopTime,
                                                              page,
...
REGISTER_COMMAND_TO_FACTORY(SetMessageModificationToGpsCNav2);
} // namespace Cmd
} // namespace Sdx
