...
{
public:
  inline static const char* const CmdName = "SetMessageModificationToNavICNav";
  ...
  SetMessageModificationToNavICNav() : CommandBase(CmdName, TargetId) {}

  SetMessageModificationToNavICNav(const std::vector<std::string>& signalArray,
                                   int svId,
                                   int startTime,
                                   int stopTime,
                                   int subframe,
  ...
  static SetMessageModificationToNavICNavPtr create(const std::vector<std::string>& signalArray,
                                                    int svId,
                                                    int startTime,
                                                    int stopTime,
                                                    int subframe,
                                                    ...
                                                    const std::string& id)
  {
    return std::make_shared<SetMessageModificationToNavICNav>(signalArray,
                                                              svId,
                                                              startTime,
                                                              stopTime,
                                                              subframe,
...
REGISTER_COMMAND_TO_FACTORY(SetMessageModificationToNavICNav);
} // namespace Cmd
} // namespace Sdx
