...
{
public:
  inline static const char* const CmdName = "SetMessageModificationToPulsarNav";
  ...
  SetMessageModificationToPulsarNav() : CommandBase(CmdName, TargetId) {}

  SetMessageModificationToPulsarNav(const std::vector<std::string>& signalArray,
                                    int svId,
                                    int startTime,
                                    int stopTime,
  ...
  static SetMessageModificationToPulsarNavPtr create(const std::vector<std::string>& signalArray,
                                                     int svId,
                                                     int startTime,
                                                     int stopTime,
                                                     const std::string& condition,
                                                     ...
                                                     const std::string& id)
  {
    return std::make_shared<SetMessageModificationToPulsarNav>(signalArray,
                                                               svId,
                                                               startTime,
                                                               stopTime,
                                                               condition,
...
REGISTER_COMMAND_TO_FACTORY(SetMessageModificationToPulsarNav);
} // namespace Cmd
} // namespace Sdx
