...
{
public:
  inline static const char* const CmdName = "SetMessageModificationToPulsarX1";
  ...
  SetMessageModificationToPulsarX1() : CommandBase(CmdName, TargetId) {}

  SetMessageModificationToPulsarX1(const std::vector<std::string>& signalArray,
                                   int svId,
                                   int startTime,
                                   int stopTime,
                                   int messageType,
  ...
  static SetMessageModificationToPulsarX1Ptr create(const std::vector<std::string>& signalArray,
                                                    int svId,
                                                    int startTime,
                                                    int stopTime,
                                                    int messageType,
                                                    ...
                                                    const std::string& id)
  {
    return std::make_shared<SetMessageModificationToPulsarX1>(signalArray,
                                                              svId,
                                                              startTime,
                                                              stopTime,
                                                              messageType,
...
REGISTER_COMMAND_TO_FACTORY(SetMessageModificationToPulsarX1);
} // namespace Cmd
} // namespace Sdx
