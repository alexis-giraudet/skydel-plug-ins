...
{
public:
  inline static const char* const CmdName = "SetMessageModificationToPulsarX5";
  ...
  SetMessageModificationToPulsarX5() : CommandBase(CmdName, TargetId) {}

  SetMessageModificationToPulsarX5(const std::vector<std::string>& signalArray,
                                   int svId,
                                   int startTime,
                                   int stopTime,
  ...
  static SetMessageModificationToPulsarX5Ptr create(const std::vector<std::string>& signalArray,
                                                    int svId,
                                                    int startTime,
                                                    int stopTime,
                                                    const std::string& condition,
                                                    ...
                                                    const std::string& id)
  {
    return std::make_shared<SetMessageModificationToPulsarX5>(signalArray,
                                                              svId,
                                                              startTime,
                                                              stopTime,
                                                              condition,
...
REGISTER_COMMAND_TO_FACTORY(SetMessageModificationToPulsarX5);
} // namespace Cmd
} // namespace Sdx
