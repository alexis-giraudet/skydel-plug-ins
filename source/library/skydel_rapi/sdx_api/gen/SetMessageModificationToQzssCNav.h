...
{
public:
  inline static const char* const CmdName = "SetMessageModificationToQzssCNav";
  ...
  SetMessageModificationToQzssCNav() : CommandBase(CmdName, TargetId) {}

  SetMessageModificationToQzssCNav(const std::vector<std::string>& signalArray,
                                   int svId,
                                   int startTime,
                                   int stopTime,
                                   int messageType,
  ...
  static SetMessageModificationToQzssCNavPtr create(const std::vector<std::string>& signalArray,
                                                    int svId,
                                                    int startTime,
                                                    int stopTime,
                                                    int messageType,
                                                    ...
                                                    const std::string& id)
  {
    return std::make_shared<SetMessageModificationToQzssCNav>(signalArray,
                                                              svId,
                                                              startTime,
                                                              stopTime,
                                                              messageType,
...
REGISTER_COMMAND_TO_FACTORY(SetMessageModificationToQzssCNav);
} // namespace Cmd
} // namespace Sdx
