...
{
public:
  inline static const char* const CmdName = "SetMessageModificationToQzssCNav2";
  ...
  SetMessageModificationToQzssCNav2() : CommandBase(CmdName, TargetId) {}

  SetMessageModificationToQzssCNav2(const std::vector<std::string>& signalArray,
                                    int svId,
                                    int startTime,
                                    int stopTime,
                                    int page,
  ...
  static SetMessageModificationToQzssCNav2Ptr create(const std::vector<std::string>& signalArray,
                                                     int svId,
                                                     int startTime,
                                                     int stopTime,
                                                     int page,
                                                     ...
                                                     const std::string& id)
  {
    return std::make_shared<SetMessageModificationToQzssCNav2>(signalArray,
                                                               svId,
                                                               startTime,
                                                               stopTime,
                                                               page,
...
REGISTER_COMMAND_TO_FACTORY(SetMessageModificationToQzssCNav2);
} // namespace Cmd
} // namespace Sdx
