...
{
public:
  inline static const char* const CmdName = "SetMessageModificationToQzssLNav";
  ...
  SetMessageModificationToQzssLNav() : CommandBase(CmdName, TargetId) {}

  SetMessageModificationToQzssLNav(const std::vector<std::string>& signalArray,
                                   int svId,
                                   int startTime,
                                   int stopTime,
                                   int subframe,
  ...
  static SetMessageModificationToQzssLNavPtr create(const std::vector<std::string>& signalArray,
                                                    int svId,
                                                    int startTime,
                                                    int stopTime,
                                                    int subframe,
                                                    ...
                                                    const std::string& id)
  {
    return std::make_shared<SetMessageModificationToQzssLNav>(signalArray,
                                                              svId,
                                                              startTime,
                                                              stopTime,
                                                              subframe,
...
REGISTER_COMMAND_TO_FACTORY(SetMessageModificationToQzssLNav);
} // namespace Cmd
} // namespace Sdx
