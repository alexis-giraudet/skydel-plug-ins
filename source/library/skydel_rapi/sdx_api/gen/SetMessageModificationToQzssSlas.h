...
{
public:
  inline static const char* const CmdName = "SetMessageModificationToQzssSlas";
  ...
  SetMessageModificationToQzssSlas() : CommandBase(CmdName, TargetId) {}

  SetMessageModificationToQzssSlas(const std::vector<std::string>& signalArray,
                                   int svId,
                                   int startTime,
                                   int stopTime,
                                   int messageType,
  ...
  static SetMessageModificationToQzssSlasPtr create(const std::vector<std::string>& signalArray,
                                                    int svId,
                                                    int startTime,
                                                    int stopTime,
                                                    int messageType,
                                                    ...
                                                    const std::string& id)
  {
    return std::make_shared<SetMessageModificationToQzssSlas>(signalArray,
                                                              svId,
                                                              startTime,
                                                              stopTime,
                                                              messageType,
...
REGISTER_COMMAND_TO_FACTORY(SetMessageModificationToQzssSlas);
} // namespace Cmd
} // namespace Sdx
