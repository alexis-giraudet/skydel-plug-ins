...
{
public:
  inline static const char* const CmdName = "SetMessageModificationToSbasNav";
  ...
  SetMessageModificationToSbasNav() : CommandBase(CmdName, TargetId) {}

  SetMessageModificationToSbasNav(const std::vector<std::string>& signalArray,
                                  int svId,
                                  int startTime,
                                  int stopTime,
                                  int messageType,
  ...
  static SetMessageModificationToSbasNavPtr create(const std::vector<std::string>& signalArray,
                                                   int svId,
                                                   int startTime,
                                                   int stopTime,
                                                   int messageType,
                                                   ...
                                                   const std::string& id)
  {
    return std::make_shared<SetMessageModificationToSbasNav>(signalArray,
                                                             svId,
                                                             startTime,
                                                             stopTime,
                                                             messageType,
...
REGISTER_COMMAND_TO_FACTORY(SetMessageModificationToSbasNav);
} // namespace Cmd
} // namespace Sdx
