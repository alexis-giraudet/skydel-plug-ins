...
public:
  ...
  SetNavICEphDoubleParamForEachSV() : CommandBase(CmdName, TargetId) {}

  SetNavICEphDoubleParamForEachSV(const std::string& paramName,
  ...
  static SetNavICEphDoubleParamForEachSVPtr create(const std::string& paramName,
                                                   const std::vector<double>& val,
                                                   const std::optional<std::string>& dataSetName = {})
  {
