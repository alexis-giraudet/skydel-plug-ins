...
{
///
/// Please note the command SetNavICEphemerisDoubleParam is deprecated since 21.3. You may use
/// SetNavICEphDoubleParamForSV.
///
/// Please note the command SetNavICEphDoubleParamForSV is deprecated since 23.11. You may use
...
{
public:
  inline static const char* const CmdName = "SetNavICEphemerisDoubleParam";
  ...
  inline static const char* const Deprecated =
    "Please note the command SetNavICEphemerisDoubleParam is deprecated since 23.11. You may use SetConstellationParameterForSV.";

  SetNavICEphemerisDoubleParam() : CommandBase(CmdName, TargetId) {}

  SetNavICEphemerisDoubleParam(int svId,
  ...
  static SetNavICEphemerisDoubleParamPtr create(int svId,
                                                const std::string& paramName,
                                                double val,
                                                const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(SetNavICEphemerisDoubleParam);
} // namespace Cmd
} // namespace Sdx
