...
{
///
/// Please note the command SetNavICEphemerisDoubleParams is deprecated since 21.3. You may use
/// SetNavICEphDoubleParamForEachSV.
///
/// Please note the command SetNavICEphDoubleParamForEachSV is deprecated since 23.11. You may use
...
/// ----------- ---------------
/// -------------------------------------------------------------------------------------------------- ParamName string
/// Refer to SetNavICEphDoubleParamForSV for accepted names Val         array double    Parameter value for each
...
{
public:
  inline static const char* const CmdName = "SetNavICEphemerisDoubleParams";
  ...
  inline static const char* const Deprecated =
    "Please note the command SetNavICEphemerisDoubleParams is deprecated since 23.11. You may use SetConstellationParameterForSV.";

  SetNavICEphemerisDoubleParams() : CommandBase(CmdName, TargetId) {}

  SetNavICEphemerisDoubleParams(const std::string& paramName,
  ...
  static SetNavICEphemerisDoubleParamsPtr create(const std::string& paramName,
                                                 const std::vector<double>& val,
                                                 const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(SetNavICEphemerisDoubleParams);
} // namespace Cmd
} // namespace Sdx
