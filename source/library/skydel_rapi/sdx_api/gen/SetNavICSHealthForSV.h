...
{
public:
  inline static const char* const CmdName = "SetNavICSHealthForSV";
  ...
  SetNavICSHealthForSV() : CommandBase(CmdName, TargetId) {}
...
REGISTER_COMMAND_TO_FACTORY(SetNavICSHealthForSV);
} // namespace Cmd
} // namespace Sdx
