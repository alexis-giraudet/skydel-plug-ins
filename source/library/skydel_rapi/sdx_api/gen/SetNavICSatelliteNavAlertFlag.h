...
{
///
/// Please note the command SetNavICSatelliteNavAlertFlag is deprecated since 21.3. You may use
...
public:
  ...
  SetNavICSatelliteNavAlertFlag() : CommandBase(CmdName, TargetId) {}
  ...
  static SetNavICSatelliteNavAlertFlagPtr create(int svId,
                                                 bool alert,
