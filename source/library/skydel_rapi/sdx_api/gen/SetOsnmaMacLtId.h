...
public:
  ...
  SetOsnmaMacLtId() : CommandBase(CmdName, TargetId) {}

  SetOsnmaMacLtId(int macLtId) : CommandBase(CmdName, TargetId) { setMacLtId(macLtId); }

  static SetOsnmaMacLtIdPtr create(int macLtId) { return std::make_shared<SetOsnmaMacLtId>(macLtId); }

  static SetOsnmaMacLtIdPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<SetOsnmaMacLtId>(ptr); }
