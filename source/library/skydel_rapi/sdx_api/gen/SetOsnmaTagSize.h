...
public:
  ...
  SetOsnmaTagSize() : CommandBase(CmdName, TargetId) {}

  SetOsnmaTagSize(int tagSize) : CommandBase(CmdName, TargetId) { setTagSize(tagSize); }

  static SetOsnmaTagSizePtr create(int tagSize) { return std::make_shared<SetOsnmaTagSize>(tagSize); }

  static SetOsnmaTagSizePtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<SetOsnmaTagSize>(ptr); }
