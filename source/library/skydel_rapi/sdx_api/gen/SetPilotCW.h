...
public:
  ...
  SetPilotCW() : CommandBase(CmdName, TargetId) {}
  ...
  static SetPilotCWPtr create(bool enabled,
                              int outputIdx,
  ...
  static SetPilotCWPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<SetPilotCW>(ptr); }
  ...
  virtual bool isValid() const override
  {
    ...
    return m_values.IsObject() && parse_json<bool>::is_valid(m_values["Enabled"]) &&
           ...
           parse_json<double>::is_valid(m_values["Power"]) && parse_json<std::string>::is_valid(m_values["PilotId"]);
  }
