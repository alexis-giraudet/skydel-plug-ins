...
{
public:
  inline static const char* const CmdName = "SetPowerOffset";
  ...
  SetPowerOffset() : CommandBase(CmdName, TargetId) {}

  SetPowerOffset(const std::string& signal, double offset) : CommandBase(CmdName, TargetId)
  {
  ...
  static SetPowerOffsetPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<SetPowerOffset>(ptr); }
...
REGISTER_COMMAND_TO_FACTORY(SetPowerOffset);
} // namespace Cmd
} // namespace Sdx
