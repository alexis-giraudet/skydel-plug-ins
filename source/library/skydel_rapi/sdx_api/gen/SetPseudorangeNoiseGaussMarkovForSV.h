...
public:
  ...
  SetPseudorangeNoiseGaussMarkovForSV() : CommandBase(CmdName, TargetId) {}

  SetPseudorangeNoiseGaussMarkovForSV(const std::string& system,
                                      int svId,
                                      int process,
                                      bool enabled,
                                      double sigma,
  ...
  static SetPseudorangeNoiseGaussMarkovForSVPtr
