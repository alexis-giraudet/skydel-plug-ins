...
public:
  ...
  SetPseudorangeNoiseOffsetForEachSV() : CommandBase(CmdName, TargetId) {}

  SetPseudorangeNoiseOffsetForEachSV(const std::string& system,
  ...
  static SetPseudorangeNoiseOffsetForEachSVPtr create(const std::string& system,
                                                      const std::vector<bool>& enabled,
                                                      const std::vector<double>& offset)
  {
