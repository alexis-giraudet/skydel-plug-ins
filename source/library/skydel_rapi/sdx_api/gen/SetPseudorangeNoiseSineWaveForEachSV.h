...
{
public:
  inline static const char* const CmdName = "SetPseudorangeNoiseSineWaveForEachSV";
  ...
  SetPseudorangeNoiseSineWaveForEachSV() : CommandBase(CmdName, TargetId) {}

  SetPseudorangeNoiseSineWaveForEachSV(const std::string& system,
                                       int sineWave,
  ...
  static SetPseudorangeNoiseSineWaveForEachSVPtr create(const std::string& system,
                                                        int sineWave,
                                                        const std::vector<bool>& enabled,
                                                        const std::vector<double>& amplitude,
                                                        const std::vector<int>& period,
...
REGISTER_COMMAND_TO_FACTORY(SetPseudorangeNoiseSineWaveForEachSV);
} // namespace Cmd
} // namespace Sdx
