...
{
public:
  inline static const char* const CmdName = "SetPseudorangeNoiseSineWaveForSV";
  ...
  SetPseudorangeNoiseSineWaveForSV() : CommandBase(CmdName, TargetId) {}

  SetPseudorangeNoiseSineWaveForSV(const std::string& system,
                                   int svId,
                                   int sineWave,
                                   bool enabled,
                                   double amplitude,
...
REGISTER_COMMAND_TO_FACTORY(SetPseudorangeNoiseSineWaveForSV);
} // namespace Cmd
} // namespace Sdx
