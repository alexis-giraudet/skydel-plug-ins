...
{
public:
  inline static const char* const CmdName = "SetPulsarX1AccuracyIntegrityForSV";
  ...
  SetPulsarX1AccuracyIntegrityForSV() : CommandBase(CmdName, TargetId) {}
  ...
  static SetPulsarX1AccuracyIntegrityForSVPtr create(int svId,
                                                     bool health,
...
REGISTER_COMMAND_TO_FACTORY(SetPulsarX1AccuracyIntegrityForSV);
} // namespace Cmd
} // namespace Sdx
