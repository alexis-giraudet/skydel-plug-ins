...
{
public:
  inline static const char* const CmdName = "SetQzssEphBoolParamForEachSV";
  ...
  SetQzssEphBoolParamForEachSV() : CommandBase(CmdName, TargetId) {}

  SetQzssEphBoolParamForEachSV(const std::string& paramName,
  ...
  static SetQzssEphBoolParamForEachSVPtr create(const std::string& paramName,
                                                const std::vector<bool>& val,
                                                const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(SetQzssEphBoolParamForEachSV);
} // namespace Cmd
} // namespace Sdx
