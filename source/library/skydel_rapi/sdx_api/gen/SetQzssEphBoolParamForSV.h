...
{
public:
  inline static const char* const CmdName = "SetQzssEphBoolParamForSV";
  ...
  SetQzssEphBoolParamForSV() : CommandBase(CmdName, TargetId) {}

  SetQzssEphBoolParamForSV(int svId,
  ...
  static SetQzssEphBoolParamForSVPtr create(int svId,
                                            const std::string& paramName,
                                            bool val,
                                            const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(SetQzssEphBoolParamForSV);
} // namespace Cmd
} // namespace Sdx
