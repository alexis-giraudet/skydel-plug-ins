...
public:
  ...
  SetQzssEphDoubleParamForEachSV() : CommandBase(CmdName, TargetId) {}

  SetQzssEphDoubleParamForEachSV(const std::string& paramName,
  ...
  static SetQzssEphDoubleParamForEachSVPtr create(const std::string& paramName,
                                                  const std::vector<double>& val,
                                                  const std::optional<std::string>& dataSetName = {})
  {
