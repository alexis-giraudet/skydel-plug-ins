...
///
/// Please note the command SetQzssEphBoolParamForSV is deprecated since 23.11. You may use
...
{
public:
  inline static const char* const CmdName = "SetQzssEphemerisBoolParam";
  ...
  inline static const char* const Deprecated =
    "Please note the command SetQzssEphemerisBoolParam is deprecated since 23.11. You may use SetConstellationParameterForSV.";

  SetQzssEphemerisBoolParam() : CommandBase(CmdName, TargetId) {}

  SetQzssEphemerisBoolParam(int svId,
  ...
  static SetQzssEphemerisBoolParamPtr create(int svId,
                                             const std::string& paramName,
                                             bool val,
                                             const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(SetQzssEphemerisBoolParam);
} // namespace Cmd
} // namespace Sdx
