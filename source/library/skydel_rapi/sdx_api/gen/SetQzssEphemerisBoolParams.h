...
{
///
/// Please note the command SetQzssEphemerisBoolParams is deprecated since 21.3. You may use
/// SetQzssEphBoolParamForEachSV.
///
/// Please note the command SetQzssEphBoolParamForEachSV is deprecated since 23.11. You may use
...
/// ----------- ---------------
/// -------------------------------------------------------------------------------------------------- ParamName string
/// Refer to SetQzssEphemerisBoolParam for accepted names Val         array bool      Parameter value for each
...
public:
  ...
  inline static const char* const Deprecated =
    "Please note the command SetQzssEphemerisBoolParams is deprecated since 23.11. You may use SetConstellationParameterForSV.";

  SetQzssEphemerisBoolParams() : CommandBase(CmdName, TargetId) {}

  SetQzssEphemerisBoolParams(const std::string& paramName,
  ...
  static SetQzssEphemerisBoolParamsPtr create(const std::string& paramName,
                                              const std::vector<bool>& val,
                                              const std::optional<std::string>& dataSetName = {})
  {
