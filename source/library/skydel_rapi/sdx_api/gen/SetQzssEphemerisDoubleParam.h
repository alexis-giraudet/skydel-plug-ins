...
{
///
/// Please note the command SetQzssEphemerisDoubleParam is deprecated since 21.3. You may use
...
{
public:
  inline static const char* const CmdName = "SetQzssEphemerisDoubleParam";
  ...
  inline static const char* const Deprecated =
    "Please note the command SetQzssEphemerisDoubleParam is deprecated since 23.11. You may use SetConstellationParameterForSV.";

  SetQzssEphemerisDoubleParam() : CommandBase(CmdName, TargetId) {}

  SetQzssEphemerisDoubleParam(int svId,
  ...
  static SetQzssEphemerisDoubleParamPtr create(int svId,
                                               const std::string& paramName,
                                               double val,
                                               const std::optional<std::string>& dataSetName = {})
  {
...
REGISTER_COMMAND_TO_FACTORY(SetQzssEphemerisDoubleParam);
} // namespace Cmd
} // namespace Sdx
