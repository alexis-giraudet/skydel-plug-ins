...
{
public:
  inline static const char* const CmdName = "SetQzssL6HealthForSV";
  ...
  SetQzssL6HealthForSV() : CommandBase(CmdName, TargetId) {}
...
REGISTER_COMMAND_TO_FACTORY(SetQzssL6HealthForSV);
} // namespace Cmd
} // namespace Sdx
