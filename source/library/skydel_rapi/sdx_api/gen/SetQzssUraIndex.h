...
public:
  ...
  SetQzssUraIndex() : CommandBase(CmdName, TargetId) {}
  ...
  static SetQzssUraIndexPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<SetQzssUraIndex>(ptr); }
