...
public:
  ...
  SetSVAntennaGain() : CommandBase(CmdName, TargetId) {}

  SetSVAntennaGain(const std::vector<std::vector<double>>& gain,
  ...
  static SetSVAntennaGainPtr create(const std::vector<std::vector<double>>& gain,
                                    const Sdx::AntennaPatternType& type,
                                    const Sdx::GNSSBand& band,
                                    const std::string& system,
                                    const std::optional<std::string>& name = {})
