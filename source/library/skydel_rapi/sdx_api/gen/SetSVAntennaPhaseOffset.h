...
{
///
/// Set space vehicle phase offset antenna pattern. If no name is specified, the command is aplied to Basic Vehicle
/// Antenna.
///
...
public:
  ...
  SetSVAntennaPhaseOffset() : CommandBase(CmdName, TargetId) {}

  SetSVAntennaPhaseOffset(const std::vector<std::vector<double>>& phaseOffset,
  ...
  static SetSVAntennaPhaseOffsetPtr create(const std::vector<std::vector<double>>& phaseOffset,
                                           const Sdx::AntennaPatternType& type,
                                           const Sdx::GNSSBand& band,
                                           const std::string& system,
                                           const std::optional<std::string>& name = {})
