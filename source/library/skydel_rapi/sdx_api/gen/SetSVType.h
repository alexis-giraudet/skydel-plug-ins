...
public:
  ...
  SetSVType() : CommandBase(CmdName, TargetId) {}

  SetSVType(const std::string& system, int svId, const std::string& svType) : CommandBase(CmdName, TargetId)
  {
  ...
  static SetSVTypePtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<SetSVType>(ptr); }
