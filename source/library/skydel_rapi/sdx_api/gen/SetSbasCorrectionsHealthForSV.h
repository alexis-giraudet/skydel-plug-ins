...
{
public:
  inline static const char* const CmdName = "SetSbasCorrectionsHealthForSV";
  inline static const char* const Documentation = "Apply correction flag for a SBAS satellite\n"
                                                  "\n"
                                                  "Name   Type Description\n"
                                                  "------ ---- -----------------------------\n"
                                                  "SvId   int  The satellite's SV ID\n"
  ...
  SetSbasCorrectionsHealthForSV() : CommandBase(CmdName, TargetId) {}

  SetSbasCorrectionsHealthForSV(int svId, bool health) : CommandBase(CmdName, TargetId)
  {
...
REGISTER_COMMAND_TO_FACTORY(SetSbasCorrectionsHealthForSV);
} // namespace Cmd
} // namespace Sdx
