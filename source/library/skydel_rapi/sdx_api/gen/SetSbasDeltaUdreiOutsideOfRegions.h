...
public:
  ...
  SetSbasDeltaUdreiOutsideOfRegions() : CommandBase(CmdName, TargetId) {}

  SetSbasDeltaUdreiOutsideOfRegions(const std::string& serviceProvider, int deltaUdrei) : CommandBase(CmdName, TargetId)
  {
