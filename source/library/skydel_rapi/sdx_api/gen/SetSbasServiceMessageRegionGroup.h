...
public:
  ...
  SetSbasServiceMessageRegionGroup() : CommandBase(CmdName, TargetId) {}

  SetSbasServiceMessageRegionGroup(const std::string& serviceProvider,
                                   int deltaUdrei,
                                   int priorityCode,
  ...
  static SetSbasServiceMessageRegionGroupPtr create(const std::string& serviceProvider,
                                                    int deltaUdrei,
                                                    int priorityCode,
                                                    const std::vector<Sdx::SbasServiceMessageRegion>& regions,
                                                    const std::string& id)
