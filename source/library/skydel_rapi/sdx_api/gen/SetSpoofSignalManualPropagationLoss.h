...
{
///
/// Set the manual propagation loss for the given spoofer signal. Value is used only if
/// SetSpoofTxUseManualPropagationLoss has been set on the corresponding spoofer. This value is not preserved after
/// simulation end.
///
...
public:
  ...
  SetSpoofSignalManualPropagationLoss() : CommandBase(CmdName, TargetId) {}

  SetSpoofSignalManualPropagationLoss(double propagationLoss,
  ...
  static SetSpoofSignalManualPropagationLossPtr create(double propagationLoss,
                                                       const std::string& transmitterId,
                                                       const std::string& signalId)
  {
