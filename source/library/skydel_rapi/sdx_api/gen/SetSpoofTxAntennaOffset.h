...
{
public:
  inline static const char* const CmdName = "SetSpoofTxAntennaOffset";
  ...
  SetSpoofTxAntennaOffset() : CommandBase(CmdName, TargetId) {}
  ...
  static SetSpoofTxAntennaOffsetPtr
...
REGISTER_COMMAND_TO_FACTORY(SetSpoofTxAntennaOffset);
} // namespace Cmd
} // namespace Sdx
