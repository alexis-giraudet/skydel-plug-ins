...
{
public:
  inline static const char* const CmdName = "SetSpoofTxFix";
  ...
  SetSpoofTxFix() : CommandBase(CmdName, TargetId) {}
  ...
  static SetSpoofTxFixPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<SetSpoofTxFix>(ptr); }
...
REGISTER_COMMAND_TO_FACTORY(SetSpoofTxFix);
} // namespace Cmd
} // namespace Sdx
