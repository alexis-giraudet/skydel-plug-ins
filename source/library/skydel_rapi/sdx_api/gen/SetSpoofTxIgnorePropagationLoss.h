...
public:
  ...
  SetSpoofTxIgnorePropagationLoss() : CommandBase(CmdName, TargetId) {}

  SetSpoofTxIgnorePropagationLoss(bool ignore, const std::string& id) : CommandBase(CmdName, TargetId)
  {
