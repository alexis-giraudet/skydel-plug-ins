...
public:
  ...
  SetSpoofTxIgnoreRxAntennaPatterns() : CommandBase(CmdName, TargetId) {}

  SetSpoofTxIgnoreRxAntennaPatterns(bool ignore, const std::string& id) : CommandBase(CmdName, TargetId)
  {
