...
{
///
/// Sets the mode for how the maximum number of entries in the Status Log is handled. The "Unlimited" mode allows the
/// Status Log to have an infinite amount of entries. The "Custom" mode allows to set a maximum entries count for the
/// Status Log. In that mode, when the maximum count is reached, Skydel will start overwritting the older entries in the
/// Status Log.
///
/// Name Type   Description
/// ---- ------
/// ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
/// Mode string Status Log maximum count mode, accepts "Unlimited" and "Custom". If "Custom" mode is set, use the
/// command SetStatusLogMaxEntriesCount to set the maximum number of entries in the Status Log.
///
...
public:
  ...
  SetStatusLogMaxEntriesCountMode() : CommandBase(CmdName, TargetId) {}

  SetStatusLogMaxEntriesCountMode(const std::string& mode) : CommandBase(CmdName, TargetId) { setMode(mode); }
