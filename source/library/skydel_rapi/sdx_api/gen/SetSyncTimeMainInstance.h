...
public:
  ...
  SetSyncTimeMainInstance() : CommandBase(CmdName, TargetId) {}

  SetSyncTimeMainInstance(double time) : CommandBase(CmdName, TargetId) { setTime(time); }

  static SetSyncTimeMainInstancePtr create(double time) { return std::make_shared<SetSyncTimeMainInstance>(time); }
