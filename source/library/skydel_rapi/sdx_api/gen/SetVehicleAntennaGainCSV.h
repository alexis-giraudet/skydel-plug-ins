...
{
///
/// Set vehicle gain antenna pattern from a CSV file. If no name is specified, the command is aplied to Basic vehicle
/// Antenna.
///
/// Name     Type               Description
/// -------- ------------------
/// ----------------------------------------------------------------------------------------------------------------------
/// FilePath string             File path of the CSV (see user manual for CSV file format details). For Default and None
/// types, leave this field empty Type     AntennaPatternType Pattern type Band     GNSSBand           Frequency band
...
public:
  ...
  SetVehicleAntennaGainCSV() : CommandBase(CmdName, TargetId) {}

  SetVehicleAntennaGainCSV(const std::string& filePath,
  ...
  static SetVehicleAntennaGainCSVPtr create(const std::string& filePath,
                                            const Sdx::AntennaPatternType& type,
                                            const Sdx::GNSSBand& band,
                                            const std::optional<std::string>& name = {})
  {
