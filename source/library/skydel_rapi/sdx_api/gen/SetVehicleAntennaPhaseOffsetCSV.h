...
{
///
/// Set vehicle phase offset antenna pattern from a CSV file. If no name is specified, the command is aplied to Basic
/// vehicle Antenna.
///
...
public:
  ...
  SetVehicleAntennaPhaseOffsetCSV() : CommandBase(CmdName, TargetId) {}

  SetVehicleAntennaPhaseOffsetCSV(const std::string& filePath,
  ...
  static SetVehicleAntennaPhaseOffsetCSVPtr create(const std::string& filePath,
                                                   const Sdx::AntennaPatternFileType& fileFormat,
                                                   const Sdx::AntennaPatternType& type,
                                                   const Sdx::GNSSBand& band,
                                                   const std::optional<std::string>& name = {})
