...
{
public:
  inline static const char* const CmdName = "SetVehicleTrajectoryCircular";
  inline static const char* const Documentation = "Set vehicle circular trajectory\n"
                                                  "\n"
                                                  "Name        Type            Description\n"
                                                  "----------- --------------- --------------------------------\n"
                                                  "Type        string          Trajectory type (\"Circular\")\n"
  ...
  SetVehicleTrajectoryCircular() : CommandBase(CmdName, TargetId) {}

  SetVehicleTrajectoryCircular(const std::string& type,
                               double lat,
                               double lon,
                               double alt,
                               double radius,
  ...
  static SetVehicleTrajectoryCircularPtr create(const std::string& type,
                                                double lat,
                                                double lon,
                                                double alt,
                                                double radius,
...
REGISTER_COMMAND_TO_FACTORY(SetVehicleTrajectoryCircular);
} // namespace Cmd
} // namespace Sdx
