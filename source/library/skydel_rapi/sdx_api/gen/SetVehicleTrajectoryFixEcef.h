...
{
public:
  inline static const char* const CmdName = "SetVehicleTrajectoryFixEcef";
  ...
  SetVehicleTrajectoryFixEcef() : CommandBase(CmdName, TargetId) {}

  SetVehicleTrajectoryFixEcef(const std::string& type,
                              double x,
                              double y,
                              double z,
                              double yaw,
  ...
  static SetVehicleTrajectoryFixEcefPtr
...
REGISTER_COMMAND_TO_FACTORY(SetVehicleTrajectoryFixEcef);
} // namespace Cmd
} // namespace Sdx
