...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      inline static const char* const Documentation = "Please note the command SetWFAntennaElementEnabled is deprecated since 23.11. You may use SetWFElement.\n"      "\n"      "Set WF antenna element enabled or disabled. A disabled antenna element is not simulated at all.\n"      "\n"      "Name    Type Description\n"      "------- ---- -------------------------------------------------\n"      "Element int  One-based index for element in antenna.\n"      "Enabled bool If True, this antenna element will bil simulated.";
      inline static const char* const TargetId = "";

      inline static const char* const Deprecated = "Please note the command SetWFAntennaElementEnabled is deprecated since 23.11. You may use SetWFElement.";
