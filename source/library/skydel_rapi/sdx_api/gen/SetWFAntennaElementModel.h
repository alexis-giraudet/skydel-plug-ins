...
public:
  ...
  SetWFAntennaElementModel() : CommandBase(CmdName, TargetId) {}

  SetWFAntennaElementModel(const std::string& antennaModelName, int element) : CommandBase(CmdName, TargetId)
  {
