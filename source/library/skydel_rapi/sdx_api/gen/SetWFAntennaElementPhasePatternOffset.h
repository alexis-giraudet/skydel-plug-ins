...
{
///
/// Please note the command SetWFAntennaElementPhasePatternOffset is deprecated since 23.11. You may use
...
public:
  ...
  SetWFAntennaElementPhasePatternOffset() : CommandBase(CmdName, TargetId) {}

  SetWFAntennaElementPhasePatternOffset(double phaseOffset, int element) : CommandBase(CmdName, TargetId)
  {
