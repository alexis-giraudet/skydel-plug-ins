...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      inline static const char* const Documentation = "Please note the command SetWFAntennaGain is deprecated since 25.4. You may use SetWFElement.\n"      "\n"      "Set The CRPA LNA gain\n"      "\n"      "Name Type Description\n"      "---- ---- -----------------\n"      "Gain int  The CRPA LNA gain";
      inline static const char* const TargetId = "";

      inline static const char* const Deprecated = "Please note the command SetWFAntennaGain is deprecated since 25.4. You may use SetWFElement.";
