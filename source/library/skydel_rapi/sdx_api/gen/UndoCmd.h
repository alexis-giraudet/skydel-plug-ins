...
public:
  ...
  UndoCmd() : CommandBase(CmdName, TargetId) {}

  static UndoCmdPtr create() { return std::make_shared<UndoCmd>(); }

  static UndoCmdPtr dynamicCast(CommandBasePtr ptr) { return std::dynamic_pointer_cast<UndoCmd>(ptr); }
